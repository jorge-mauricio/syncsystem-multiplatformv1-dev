...
module.exports = class ProductsListing {
  ...
  async build() {
    ...
    try {
      ...
      // Meta title.
      this.metaTitle += SyncSystemNS.FunctionsGeneric.contentMaskRead(gSystemConfig.configSystemClientName, 'config-application') + ' - ' + SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendProductsTitleMain');
  ...
  async cphTitleBuild() {
    ...
    // ----------------------
    try {
      this.cphTitle = SyncSystemNS.FunctionsGeneric.contentMaskRead(gSystemConfig.configSystemClientName, 'config-application') + ' - ' + SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendProductsTitleMain');
  ...
  async cphBodyBuild() {
    ...
    try {
      ...
      if (gSystemConfig.enableProductsBackendPagination == 1) {
        ...
        this._pagingTotalRecords = await SyncSystemNS.FunctionsDB.genericTableGet02(gSystemConfig.configSystemDBTableProducts, arrSearchParameters, gSystemConfig.configProductsSort, '', 'id, id_parent', 3, {});
      ...
      // TODO: move this part to the upper methods.

      // Filters - Type.
      if (gSystemConfig.enableProductsType !== 0) {
        this.resultsProductsTypeListing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
      ...
      if (gSystemConfig.enableProductsStatus !== 0) {
        this.resultsProductsStatusListing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
      ...
      if (gSystemConfig.enableProductsFilterGeneric2 !== 0) {
        this.resultsProductsFiltersGeneric2Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
      ...
      if (gSystemConfig.enableProductsFilterGeneric3 !== 0) {
        this.resultsProductsFiltersGeneric3Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 103;
        });
      }
      if (gSystemConfig.enableProductsFilterGeneric4 !== 0) {
        this.resultsProductsFiltersGeneric4Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 104;
        });
      }
      if (gSystemConfig.enableProductsFilterGeneric5 !== 0) {
        this.resultsProductsFiltersGeneric5Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 105;
        });
      }
      if (gSystemConfig.enableProductsFilterGeneric6 !== 0) {
        this.resultsProductsFiltersGeneric6Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 106;
        });
      }
      if (gSystemConfig.enableProductsFilterGeneric7 !== 0) {
        this.resultsProductsFiltersGeneric7Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 107;
        });
      }
      if (gSystemConfig.enableProductsFilterGeneric8 !== 0) {
        this.resultsProductsFiltersGeneric8Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 108;
        });
      }
      if (gSystemConfig.enableProductsFilterGeneric9 !== 0) {
        this.resultsProductsFiltersGeneric9Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 109;
        });
      }
      if (gSystemConfig.enableProductsFilterGeneric10 !== 0) {
        this.resultsProductsFiltersGeneric10Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 110;
        });
      }
      if (gSystemConfig.enableProductsFilterGeneric11 !== 0) {
        this.resultsProductsFiltersGeneric11Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 111;
        });
      }
      if (gSystemConfig.enableProductsFilterGeneric12 !== 0) {
        this.resultsProductsFiltersGeneric12Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
      ...
      if (gSystemConfig.enableProductsFilterGeneric13 !== 0) {
        this.resultsProductsFiltersGeneric13Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 113;
        });
      }
      if (gSystemConfig.enableProductsFilterGeneric14 !== 0) {
        this.resultsProductsFiltersGeneric14Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 114;
        });
      }
      if (gSystemConfig.enableProductsFilterGeneric15 !== 0) {
        this.resultsProductsFiltersGeneric15Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 115;
        });
      }
      if (gSystemConfig.enableProductsFilterGeneric16 !== 0) {
        this.resultsProductsFiltersGeneric16Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 116;
        });
      }
      if (gSystemConfig.enableProductsFilterGeneric17 !== 0) {
        this.resultsProductsFiltersGeneric17Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 117;
        });
      }
      if (gSystemConfig.enableProductsFilterGeneric18 !== 0) {
        this.resultsProductsFiltersGeneric18Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 118;
        });
      }
      if (gSystemConfig.enableProductsFilterGeneric19 !== 0) {
        this.resultsProductsFiltersGeneric19Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 119;
        });
      }
      if (gSystemConfig.enableProductsFilterGeneric20 !== 0) {
        this.resultsProductsFiltersGeneric20Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 120;
        });
      }
      if (gSystemConfig.enableProductsFilterGeneric21 !== 0) {
        this.resultsProductsFiltersGeneric21Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 121;
        });
      }
      if (gSystemConfig.enableProductsFilterGeneric22 !== 0) {
        this.resultsProductsFiltersGeneric22Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
      ...
      if (gSystemConfig.enableProductsFilterGeneric23 !== 0) {
        this.resultsProductsFiltersGeneric23Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 123;
        });
      }
      if (gSystemConfig.enableProductsFilterGeneric24 !== 0) {
        this.resultsProductsFiltersGeneric24Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 124;
        });
      }
      if (gSystemConfig.enableProductsFilterGeneric25 !== 0) {
        this.resultsProductsFiltersGeneric25Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 125;
        });
      }
      if (gSystemConfig.enableProductsFilterGeneric26 !== 0) {
        this.resultsProductsFiltersGeneric26Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 126;
        });
      }
      if (gSystemConfig.enableProductsFilterGeneric27 !== 0) {
        this.resultsProductsFiltersGeneric27Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 127;
        });
      }
      if (gSystemConfig.enableProductsFilterGeneric28 !== 0) {
        this.resultsProductsFiltersGeneric28Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 128;
        });
      }
      if (gSystemConfig.enableProductsFilterGeneric29 !== 0) {
        this.resultsProductsFiltersGeneric29Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 129;
        });
      }
      if (gSystemConfig.enableProductsFilterGeneric30 !== 0) {
        this.resultsProductsFiltersGeneric30Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
                                ...
                                <tr class="ss-backend-table-bg-light">
                                            ...
                                            ${
                                              gSystemConfig.configImagePopup === 4
                                                ...
                                                <script>
                                                    ...
                                                    let glightboxProductsImageMain = GLightbox(gLightboxBackendConfigOptions);
                                                </script>
                                            `
                                                : ``
                                            }
                                    ...
                                    <td id="formProductsListing_elementActivation${productsRow.id}" style="text-align: center;" class="${productsRow.activation == 1 ? '' : 'ss-backend-table-bg-deactive'}">
                                        <a id="linkActivation${productsRow.id}" class="ss-backend-links01" 
                                            ...
                                            ${productsRow.activation == '1' ? SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation1A') : SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation0A')} 
                                        </a>
                                    </td>
                                    ${
                                      gSystemConfig.enableProductsActivation1 == 1
                                        ...
                                        <td id="formProductsListing_elementActivation1${productsRow.id}" style="text-align: center;" class="${productsRow.activation1 == 1 ? '' : 'ss-backend-table-bg-deactive'}">
                                            <a id="linkActivation1${productsRow.id}" class="ss-backend-links01"
                                                ...
                                                ${productsRow.activation1 == '1' ? SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation1A') : SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation0A')} 
                                            </a>
                                        </td>
                                        `
                                        : ``
                                      ...
                                      gSystemConfig.enableProductsActivation2 == 1
                                        ...
                                        <td id="formProductsListing_elementActivation2${productsRow.id}" style="text-align: center;" class="${productsRow.activation2 == 1 ? '' : 'ss-backend-table-bg-deactive'}">
                                            <a id="linkActivation2${productsRow.id}" class="ss-backend-links01"
                                                ...
                                                ${productsRow.activation2 == '1' ? SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation1A') : SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation0A')} 
                                            </a>
                                        </td>
                                        `
                                        : ``
                                      ...
                                      gSystemConfig.enableProductsActivation3 == 1
                                        ...
                                        <td id="formProductsListing_elementActivation3${productsRow.id}" style="text-align: center;" class="${productsRow.activation3 == 1 ? '' : 'ss-backend-table-bg-deactive'}">
                                            <a id="linkActivation3${productsRow.id}" class="ss-backend-links01"
                                                ...
                                                ${productsRow.activation3 == '1' ? SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation1A') : SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation0A')} 
                                            </a>
                                        </td>
                                        `
                                        : ``
                                      ...
                                      gSystemConfig.enableProductsActivation4 == 1
                                        ...
                                        <td id="formProductsListing_elementActivation4${productsRow.id}" style="text-align: center;" class="${productsRow.activation4 == 1 ? '' : 'ss-backend-table-bg-deactive'}">
                                            <a id="linkActivation4${productsRow.id}" class="ss-backend-links01"
                                                ...
                                                ${productsRow.activation4 == '1' ? SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation1A') : SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation0A')} 
                                            </a>
                                        </td>
                                        `
                                        : ``
                                      ...
                                      gSystemConfig.enableProductsActivation5 == 1
                                        ...
                                        <td id="formProductsListing_elementActivation5${productsRow.id}" style="text-align: center;" class="${productsRow.activation5 == 1 ? '' : 'ss-backend-table-bg-deactive'}">
                                            <a id="linkActivation5${productsRow.id}" class="ss-backend-links01"
                                                ...
                                                ${productsRow.activation5 == '1' ? SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation1A') : SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation0A')} 
                                            </a>
                                        </td>
                                        `
                                        : ``
                                      ...
                                      gSystemConfig.enableProductsRestrictedAccess == 1
                                        ...
                                        <td id="formProductsListing_elementRestrictedAccess${productsRow.id}" style="text-align: center;" class="${productsRow.restricted_access == 0 ? '' : 'ss-backend-table-bg-deactive'}">
                                            <a id="linkRestrictedAccess${productsRow.id}" class="ss-backend-links01"
                                                ...
                                                ${productsRow.restricted_access == '1' ? SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemRestrictedAccess1A') : SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemRestrictedAccess0A')} 
                                            </a>
                                        </td>
                                        `
                                        : ``
                ...
                <div style="position: relative; display: block; overflow: hidden;">
                    <script>
                        ...
                        document.addEventListener('DOMContentLoaded', function() {
                            inputDataReorder([${gSystemConfig.configProductsInputOrder
                              .map((arrayRow) => {
                                return `"${arrayRow}"`;
                              })
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableProductsFilterGeneric1 == 1
                                        ? `
                                        ${resultsProductsFiltersGeneric1Listing
                                          .map((productsFiltersGenericRow) => {
                                            return `
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableProductsFilterGeneric2 == 1
                                        ? `
                                        ${resultsProductsFiltersGeneric2Listing
                                          .map((productsFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableProductsFilterGeneric3 == 1
                                        ? `
                                        ${resultsProductsFiltersGeneric3Listing
                                          .map((productsFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableProductsFilterGeneric4 == 1
                                        ? `
                                        ${resultsProductsFiltersGeneric4Listing
                                          .map((productsFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableProductsFilterGeneric5 == 1
                                        ? `
                                        ${resultsProductsFiltersGeneric5Listing
                                          .map((productsFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableProductsFilterGeneric6 == 1
                                        ? `
                                        ${resultsProductsFiltersGeneric6Listing
                                          .map((productsFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableProductsFilterGeneric7 == 1
                                        ? `
                                        ${resultsProductsFiltersGeneric7Listing
                                          .map((productsFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableProductsFilterGeneric8 == 1
                                        ? `
                                        ${resultsProductsFiltersGeneric8Listing
                                          .map((productsFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableProductsFilterGeneric9 == 1
                                        ? `
                                        ${resultsProductsFiltersGeneric9Listing
                                          .map((productsFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableProductsFilterGeneric10 == 1
                                        ? `
                                        ${resultsProductsFiltersGeneric10Listing
                                          .map((productsFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableProductsFilterGeneric11 == 1
                                        ? `
                                        ${resultsProductsFiltersGeneric11Listing
                                          .map((productsFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableProductsFilterGeneric12 == 1
                                        ? `
                                        ${resultsProductsFiltersGeneric12Listing
                                          .map((productsFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableProductsFilterGeneric13 == 1
                                        ? `
                                        ${resultsProductsFiltersGeneric13Listing
                                          .map((productsFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableProductsFilterGeneric14 == 1
                                        ? `
                                        ${resultsProductsFiltersGeneric14Listing
                                          .map((productsFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableProductsFilterGeneric15 == 1
                                        ? `
                                        ${resultsProductsFiltersGeneric15Listing
                                          .map((productsFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableProductsFilterGeneric16 == 1
                                        ? `
                                        ${resultsProductsFiltersGeneric16Listing
                                          .map((productsFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableProductsFilterGeneric17 == 1
                                        ? `
                                        ${resultsProductsFiltersGeneric17Listing
                                          .map((productsFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableProductsFilterGeneric18 == 1
                                        ? `
                                        ${resultsProductsFiltersGeneric18Listing
                                          .map((productsFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableProductsFilterGeneric19 == 1
                                        ? `
                                        ${resultsProductsFiltersGeneric19Listing
                                          .map((productsFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableProductsFilterGeneric20 == 1
                                        ? `
                                        ${resultsProductsFiltersGeneric20Listing
                                          .map((productsFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableProductsFilterGeneric21 == 1
                                        ? `
                                        ${resultsProductsFiltersGeneric21Listing
                                          .map((productsFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableProductsFilterGeneric22 == 1
                                        ? `
                                        ${resultsProductsFiltersGeneric22Listing
                                          .map((productsFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableProductsFilterGeneric23 == 1
                                        ? `
                                        ${resultsProductsFiltersGeneric23Listing
                                          .map((productsFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableProductsFilterGeneric24 == 1
                                        ? `
                                        ${resultsProductsFiltersGeneric24Listing
                                          .map((productsFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableProductsFilterGeneric25 == 1
                                        ? `
                                        ${resultsProductsFiltersGeneric25Listing
                                          .map((productsFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableProductsFilterGeneric26 == 1
                                        ? `
                                        ${resultsProductsFiltersGeneric26Listing
                                          .map((productsFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableProductsFilterGeneric27 == 1
                                        ? `
                                        ${resultsProductsFiltersGeneric27Listing
                                          .map((productsFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableProductsFilterGeneric28 == 1
                                        ? `
                                        ${resultsProductsFiltersGeneric28Listing
                                          .map((productsFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableProductsFilterGeneric29 == 1
                                        ? `
                                        ${resultsProductsFiltersGeneric29Listing
                                          .map((productsFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableProductsFilterGeneric30 == 1
                                        ? `
                                        ${resultsProductsFiltersGeneric30Listing
                                          .map((productsFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                          ...
                                          gSystemConfig.configBackendDateFormat == 1
                                            ? `
                                                ...
                                                <select id="products_date1_day" name="date1_day" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('d', 1, { dateType: gSystemConfig.configProductsDate1Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                ...
                                                <select id="products_date1_month" name="date1_month" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('mm', 1, { dateType: gSystemConfig.configProductsDate1Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                ...
                                                <select id="products_date1_year" name="date1_year" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('y', 1, { dateType: gSystemConfig.configProductsDate1Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                    ...
                                    ${
                                      gSystemConfig.configProductsDate1Type == 2 || gSystemConfig.configProductsDate1Type == 3 || gSystemConfig.configProductsDate1Type == 55 || gSystemConfig.configProductsDate1Type == 66
                                        ...
                                        <select id="products_date1_hour" name="date1_hour" class="ss-backend-field-dropdown01">
                                            ${SyncSystemNS.FunctionsGeneric.timeTableFill01('h', 1, { dateType: gSystemConfig.configProductsDate1Type })
                                              .map((arrayRow) => {
                                                return `
                                                    <option value="${arrayRow}"
                                        ...
                                        <select id="products_date1_minute" name="date1_minute" class="ss-backend-field-dropdown01">
                                            ${SyncSystemNS.FunctionsGeneric.timeTableFill01('m', 1, { dateType: gSystemConfig.configProductsDate1Type })
                                              .map((arrayRow) => {
                                                return `
                                                    <option value="${arrayRow}"
                                        ...
                                        ${
                                          gSystemConfig.configProductsDate1Type == 2
                                            ...
                                            <select id="products_date1_seconds" name="date1_seconds" class="ss-backend-field-dropdown01">
                                                ${SyncSystemNS.FunctionsGeneric.timeTableFill01('s', 1, { dateType: gSystemConfig.configProductsDate1Type })
                                                  .map((arrayRow) => {
                                                    return `
                                                        <option value="${arrayRow}"
                                          ...
                                          gSystemConfig.configBackendDateFormat == 1
                                            ? `
                                                <select id="products_date2_day" name="date2_day" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('d', 1, { dateType: gSystemConfig.configProductsDate2Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowDay == arrayRow ? ' selected' : ``}
                                                ...
                                                <select id="products_date2_month" name="date2_month" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('mm', 1, { dateType: gSystemConfig.configProductsDate2Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowMonth == arrayRow ? ' selected' : ``}
                                                ...
                                                <select id="products_date2_year" name="date2_year" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('y', 1, { dateType: gSystemConfig.configProductsDate2Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowYear == arrayRow ? ' selected' : ''}
                                    ...
                                    ${
                                      gSystemConfig.configProductsDate2Type == 2 || gSystemConfig.configProductsDate2Type == 3 || gSystemConfig.configProductsDate2Type == 55 || gSystemConfig.configProductsDate2Type == 66
                                        ...
                                        <select id="products_date2_hour" name="date2_hour" class="ss-backend-field-dropdown01">
                                            ${SyncSystemNS.FunctionsGeneric.timeTableFill01('h', 1, { dateType: gSystemConfig.configProductsDate2Type })
                                              .map((arrayRow) => {
                                                return `
                                                    <option value="${arrayRow}"
                                                        ${this.dateNowHour == arrayRow ? ' selected' : ``}
                                        ...
                                        <select id="products_date2_minute" name="date2_minute" class="ss-backend-field-dropdown01">
                                            ${SyncSystemNS.FunctionsGeneric.timeTableFill01('m', 1, { dateType: gSystemConfig.configProductsDate2Type })
                                              .map((arrayRow) => {
                                                return `
                                                    <option value="${arrayRow}"
                                                        ${this.dateNowMinute == arrayRow ? ' selected' : ``}
                                        ...
                                        ${
                                          gSystemConfig.configProductsDate2Type == 2
                                            ...
                                            <select id="products_date2_seconds" name="date2_seconds" class="ss-backend-field-dropdown01">
                                                ${SyncSystemNS.FunctionsGeneric.timeTableFill01('s', 1, { dateType: gSystemConfig.configProductsDate2Type })
                                                  .map((arrayRow) => {
                                                    return `
                                                        <option value="${arrayRow}"
                                                            ${this.dateNowSecond == arrayRow ? ' selected' : ``}
                                          ...
                                          gSystemConfig.configBackendDateFormat == 1
                                            ? `
                                                <select id="products_date3_day" name="date3_day" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('d', 1, { dateType: gSystemConfig.configProductsDate3Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowDay == arrayRow ? ' selected' : ``}
                                                ...
                                                <select id="products_date3_month" name="date3_month" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('mm', 1, { dateType: gSystemConfig.configProductsDate3Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowMonth == arrayRow ? ' selected' : ``}
                                                ...
                                                <select id="products_date3_year" name="date3_year" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('y', 1, { dateType: gSystemConfig.configProductsDate3Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowYear == arrayRow ? ' selected' : ''}
                                    ...
                                    ${
                                      gSystemConfig.configProductsDate3Type == 2 || gSystemConfig.configProductsDate3Type == 3 || gSystemConfig.configProductsDate3Type == 55 || gSystemConfig.configProductsDate3Type == 66
                                        ...
                                        <select id="products_date3_hour" name="date3_hour" class="ss-backend-field-dropdown01">
                                            ${SyncSystemNS.FunctionsGeneric.timeTableFill01('h', 1, { dateType: gSystemConfig.configProductsDate3Type })
                                              .map((arrayRow) => {
                                                return `
                                                    <option value="${arrayRow}"
                                                        ${this.dateNowHour == arrayRow ? ' selected' : ``}
                                        ...
                                        <select id="products_date3_minute" name="date3_minute" class="ss-backend-field-dropdown01">
                                            ${SyncSystemNS.FunctionsGeneric.timeTableFill01('m', 1, { dateType: gSystemConfig.configProductsDate3Type })
                                              .map((arrayRow) => {
                                                return `
                                                    <option value="${arrayRow}"
                                                        ${this.dateNowMinute == arrayRow ? ' selected' : ``}
                                        ...
                                        ${
                                          gSystemConfig.configProductsDate3Type == 2
                                            ...
                                            <select id="products_date3_seconds" name="date3_seconds" class="ss-backend-field-dropdown01">
                                                ${SyncSystemNS.FunctionsGeneric.timeTableFill01('s', 1, { dateType: gSystemConfig.configProductsDate3Type })
                                                  .map((arrayRow) => {
                                                    return `
                                                        <option value="${arrayRow}"
                                                            ${this.dateNowSecond == arrayRow ? ' selected' : ``}
                                          ...
                                          gSystemConfig.configBackendDateFormat == 1
                                            ? `
                                                <select id="products_date4_day" name="date4_day" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('d', 1, { dateType: gSystemConfig.configProductsDate4Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowDay == arrayRow ? ' selected' : ``}
                                                ...
                                                <select id="products_date4_month" name="date4_month" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('mm', 1, { dateType: gSystemConfig.configProductsDate4Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowMonth == arrayRow ? ' selected' : ``}
                                                ...
                                                <select id="products_date4_year" name="date4_year" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('y', 1, { dateType: gSystemConfig.configProductsDate4Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowYear == arrayRow ? ' selected' : ''}
                                    ...
                                    ${
                                      gSystemConfig.configProductsDate4Type == 2 || gSystemConfig.configProductsDate4Type == 3 || gSystemConfig.configProductsDate4Type == 55 || gSystemConfig.configProductsDate4Type == 66
                                        ...
                                        <select id="products_date4_hour" name="date4_hour" class="ss-backend-field-dropdown01">
                                            ${SyncSystemNS.FunctionsGeneric.timeTableFill01('h', 1, { dateType: gSystemConfig.configProductsDate4Type })
                                              .map((arrayRow) => {
                                                return `
                                                    <option value="${arrayRow}"
                                                        ${this.dateNowHour == arrayRow ? ' selected' : ``}
                                        ...
                                        <select id="products_date4_minute" name="date4_minute" class="ss-backend-field-dropdown01">
                                            ${SyncSystemNS.FunctionsGeneric.timeTableFill01('m', 1, { dateType: gSystemConfig.configProductsDate4Type })
                                              .map((arrayRow) => {
                                                return `
                                                    <option value="${arrayRow}"
                                                        ${this.dateNowMinute == arrayRow ? ' selected' : ``}
                                        ...
                                        ${
                                          gSystemConfig.configProductsDate4Type == 2
                                            ...
                                            <select id="products_date4_seconds" name="date4_seconds" class="ss-backend-field-dropdown01">
                                                ${SyncSystemNS.FunctionsGeneric.timeTableFill01('s', 1, { dateType: gSystemConfig.configProductsDate4Type })
                                                  .map((arrayRow) => {
                                                    return `
                                                        <option value="${arrayRow}"
                                                            ${this.dateNowSecond == arrayRow ? ' selected' : ``}
                                          ...
                                          gSystemConfig.configBackendDateFormat == 1
                                            ? `
                                                <select id="products_date5_day" name="date5_day" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('d', 1, { dateType: gSystemConfig.configProductsDate5Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowDay == arrayRow ? ' selected' : ``}
                                                ...
                                                <select id="products_date5_month" name="date5_month" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('mm', 1, { dateType: gSystemConfig.configProductsDate5Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowMonth == arrayRow ? ' selected' : ``}
                                                ...
                                                <select id="products_date5_year" name="date5_year" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('y', 1, { dateType: gSystemConfig.configProductsDate5Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowYear == arrayRow ? ' selected' : ''}
                                    ...
                                    ${
                                      gSystemConfig.configProductsDate5Type == 2 || gSystemConfig.configProductsDate5Type == 3 || gSystemConfig.configProductsDate5Type == 55 || gSystemConfig.configProductsDate5Type == 66
                                        ...
                                        <select id="products_date5_hour" name="date5_hour" class="ss-backend-field-dropdown01">
                                            ${SyncSystemNS.FunctionsGeneric.timeTableFill01('h', 1, { dateType: gSystemConfig.configProductsDate5Type })
                                              .map((arrayRow) => {
                                                return `
                                                    <option value="${arrayRow}"
                                                        ${this.dateNowHour == arrayRow ? ' selected' : ``}
                                        ...
                                        <select id="products_date5_minute" name="date5_minute" class="ss-backend-field-dropdown01">
                                            ${SyncSystemNS.FunctionsGeneric.timeTableFill01('m', 1, { dateType: gSystemConfig.configProductsDate5Type })
                                              .map((arrayRow) => {
                                                return `
                                                    <option value="${arrayRow}"
                                                        ${this.dateNowMinute == arrayRow ? ' selected' : ``}
                                        ...
                                        ${
                                          gSystemConfig.configProductsDate5Type == 2
                                            ...
                                            <select id="products_date5_seconds" name="date5_seconds" class="ss-backend-field-dropdown01">
                                                ${SyncSystemNS.FunctionsGeneric.timeTableFill01('s', 1, { dateType: gSystemConfig.configProductsDate5Type })
                                                  .map((arrayRow) => {
                                                    return `
                                                        <option value="${arrayRow}"
                                                            ${this.dateNowSecond == arrayRow ? ' selected' : ``}
