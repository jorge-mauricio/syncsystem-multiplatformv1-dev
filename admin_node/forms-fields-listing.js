...
module.exports = class FormsFieldsListing {
  ...
  async build() {
    ...
    try {
      ...
      // Meta title.
      this.metaTitle += SyncSystemNS.FunctionsGeneric.contentMaskRead(gSystemConfig.configSystemClientName, 'config-application') + ' - ' + SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendFormsFieldsTitleMain');
  ...
  async cphTitleBuild() {
    ...
    // ----------------------
    try {
      this.cphTitle = SyncSystemNS.FunctionsGeneric.contentMaskRead(gSystemConfig.configSystemClientName, 'config-application') + ' - ' + SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendFormsFieldsTitleMain');
  ...
  async cphBodyBuild() {
    ...
    let arrIdsFormsFields = []; // eslint-disable-line
                ...
                <div style="position: relative; display: block; overflow: hidden;">
                    <table class="ss-backend-table-listing01">
                        ...
                        ${offlRecords.resultsFormsFieldsListing
                          .map((formsFieldsRow) => {
                            // Variables.
                            let arrFormsFieldsOptionsSearchParameters = []; // eslint-disable-line
                            let offolRecords = '';
                            let offolRecordsParameters = {};
                                ...
                                <tr class="ss-backend-table-bg-light">
                                    ...
                                    <td style="text-align: left;">
                                        ...
                                        ${
                                          formsFieldsRow.field_type == 1
                                            ...
                                            <input type="text" id="${formsFieldsRow.field_name_formatted}" name="${formsFieldsRow.field_name_formatted}" value="" 
                                                ...
                                                style="${formsFieldsRow.field_size == 0 ? `width: 100%;` : `width: ${formsFieldsRow.field_size}px;`}" />
                                        `
                                            : ``
                                        }
                                        ...
                                        ${
                                          formsFieldsRow.field_type == 2
                                            ...
                                            style="${formsFieldsRow.field_size == 0 ? `width: 100%;` : `width: ${formsFieldsRow.field_size}px;`}"></textarea>
                                        `
                                            : ``
                                        }
                                      ...
                                      gSystemConfig.enableFormsFieldsRequired === 1
                                        ...
                                        <td id="formFormsFieldsListing_elementRequired${formsFieldsRow.id}" style="text-align: center;" class="${formsFieldsRow.required == 1 ? 'ss-backend-table-bg-deactive' : ''}">
                                            <a id="linkRequired${formsFieldsRow.id}" class="ss-backend-links01" 
                                                ...
                                                ${formsFieldsRow.required == '1' ? SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendFormsFieldsRequired1') : SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendFormsFieldsRequired0')} 
                                            </a>
                                        </td>
                                    `
                                        : ``
                                    ...
                                    <td id="formFormsFieldsListing_elementActivation${formsFieldsRow.id}" style="text-align: center;" class="${formsFieldsRow.activation == 1 ? '' : 'ss-backend-table-bg-deactive'}">
                                        <a id="linkActivation${formsFieldsRow.id}" class="ss-backend-links01" 
                                            ...
                                            ${formsFieldsRow.activation == '1' ? SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation1A') : SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation0A')} 
                                        </a>
                                    </td>
                                    <td style="text-align: center;">
