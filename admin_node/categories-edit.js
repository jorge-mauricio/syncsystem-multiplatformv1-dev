...
module.exports = class CategoriesEdit {
  ...
  async build() {
    ...
    try {
      ...
      if (gSystemConfig.enableCategoriesStatus !== 0) {
        this.resultsCategoriesStatusListing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
      ...
      if (gSystemConfig.enableCategoriesFilterGeneric2 !== 0) {
        this.resultsCategoriesFiltersGeneric2Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 102;
        });
      }
      if (gSystemConfig.enableCategoriesFilterGeneric3 !== 0) {
        this.resultsCategoriesFiltersGeneric3Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 103;
        });
      }
      if (gSystemConfig.enableCategoriesFilterGeneric4 !== 0) {
        this.resultsCategoriesFiltersGeneric4Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 104;
        });
      }
      if (gSystemConfig.enableCategoriesFilterGeneric5 !== 0) {
        this.resultsCategoriesFiltersGeneric5Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 105;
        });
      }
      if (gSystemConfig.enableCategoriesFilterGeneric6 !== 0) {
        this.resultsCategoriesFiltersGeneric6Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 106;
        });
      }
      if (gSystemConfig.enableCategoriesFilterGeneric7 !== 0) {
        this.resultsCategoriesFiltersGeneric7Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 107;
        });
      }
      if (gSystemConfig.enableCategoriesFilterGeneric8 !== 0) {
        this.resultsCategoriesFiltersGeneric8Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 108;
        });
      }
      if (gSystemConfig.enableCategoriesFilterGeneric9 !== 0) {
        this.resultsCategoriesFiltersGeneric9Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 109;
        });
      }
      if (gSystemConfig.enableCategoriesFilterGeneric10 !== 0) {
        this.resultsCategoriesFiltersGeneric10Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
      ...
      if (gSystemConfig.enableCategoriesIdParentEdit == 1) {
        this.objCategoriesIdParent = await SyncSystemNS.FunctionsDB.genericTableGet02(gSystemConfig.configSystemDBTableCategories, [], gSystemConfig.configCategoriesSort, '', 'id, title', 1);
      }
  ...
  async cphTitleBuild() {
    ...
    // ----------------------
    try {
      this.cphTitle = SyncSystemNS.FunctionsGeneric.contentMaskRead(gSystemConfig.configSystemClientName, 'config-application') + ' - ' + SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendCategoriesTitleEdit');
  ...
  async cphBodyBuild() {
    ...
    // Redefine values.
    let ocdRecord = this.ocdRecord; // eslint-disable-line
    let ofglRecords = this.ofglRecords; // eslint-disable-line
    let objCategoriesIdParent = this.objCategoriesIdParent; // eslint-disable-line
