...
module.exports = class QuizzesOptionsListing {
  ...
  async build() {
    ...
    try {
      ...
      // Meta title.
      this.metaTitle += SyncSystemNS.FunctionsGeneric.contentMaskRead(gSystemConfig.configSystemClientName, 'config-application') + ' - ' + SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendQuizzesOptionsTitleMain');
  ...
  async cphTitleBuild() {
    ...
    // ----------------------
    try {
      this.cphTitle = SyncSystemNS.FunctionsGeneric.contentMaskRead(gSystemConfig.configSystemClientName, 'config-application') + ' - ' + SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendQuizzesOptionsTitleMain');
                                ...
                                <tr class="ss-backend-table-bg-light">
                                    ...
                                    <td style="text-align: center;">
                                        <a id="linkIdQuizzesOptionsAnswer${quizzesOptionsRow.id}" class="ss-backend-links01" 
                                            onclick="htmlGenericStyle01('updtProgressGeneric', 'display', 'block');
                                                ...
                                                ${this.objParentTable.tableData[0].id_quizzes_options_answer == quizzesOptionsRow.id ? SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemSelect1') : SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemSelect0')} 
                                        </a>
                                    </td>
                                    ...
                                    <td id="formQuizzesOptionsListing_elementActivation${quizzesOptionsRow.id}" style="text-align: center;" class="${quizzesOptionsRow.activation == 1 ? '' : 'ss-backend-table-bg-deactive'}">
                                        <a id="linkActivation${quizzesOptionsRow.id}" class="ss-backend-links01" 
                                            ...
                                            ${quizzesOptionsRow.activation == '1' ? SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation1A') : SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation0A')} 
                                        </a>
                                    </td>
                                    <td style="text-align: center;">
