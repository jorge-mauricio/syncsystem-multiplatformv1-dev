...
module.exports = class RegistersListing {
  ...
  async build() {
    ...
    try {
      ...
      // Meta title.
      this.metaTitle += SyncSystemNS.FunctionsGeneric.contentMaskRead(gSystemConfig.configSystemClientName, 'config-application') + ' - ' + SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendRegistersTitleMain');
  ...
  async cphTitleBuild() {
    ...
    // ----------------------
    try {
      this.cphTitle = SyncSystemNS.FunctionsGeneric.contentMaskRead(gSystemConfig.configSystemClientName, 'config-application') + ' - ' + SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendRegistersTitleMain');
  ...
  async cphBodyBuild() {
    ...
    let arrFiltersGenericSearchParameters = []; // eslint-disable-line
    ...
    try {
      ...
      if (gSystemConfig.enableRegistersBackendPagination == 1) {
        ...
        this._pagingTotalRecords = await SyncSystemNS.FunctionsDB.genericTableGet02(gSystemConfig.configSystemDBTableRegisters, arrSearchParameters, gSystemConfig.configRegistersSort, '', 'id, id_parent', 3, {});
      ...
      if (gSystemConfig.enableRegistersType !== 0) {
        this.resultsRegistersTypeListing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
      ...
      if (gSystemConfig.enableRegistersStatus !== 0) {
        this.resultsRegistersStatusListing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
      ...
      if (gSystemConfig.enableRegistersFilterGeneric2 !== 0) {
        this.resultsRegistersFiltersGeneric2Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
      ...
      if (gSystemConfig.enableRegistersFilterGeneric3 !== 0) {
        this.resultsRegistersFiltersGeneric3Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 103;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric4 !== 0) {
        this.resultsRegistersFiltersGeneric4Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 104;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric5 !== 0) {
        this.resultsRegistersFiltersGeneric5Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 105;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric6 !== 0) {
        this.resultsRegistersFiltersGeneric6Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 106;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric7 !== 0) {
        this.resultsRegistersFiltersGeneric7Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 107;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric8 !== 0) {
        this.resultsRegistersFiltersGeneric8Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 108;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric9 !== 0) {
        this.resultsRegistersFiltersGeneric9Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 109;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric10 !== 0) {
        this.resultsRegistersFiltersGeneric10Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 110;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric11 !== 0) {
        this.resultsRegistersFiltersGeneric11Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 111;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric12 !== 0) {
        this.resultsRegistersFiltersGeneric12Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
      ...
      if (gSystemConfig.enableRegistersFilterGeneric13 !== 0) {
        this.resultsRegistersFiltersGeneric13Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 113;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric14 !== 0) {
        this.resultsRegistersFiltersGeneric14Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 114;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric15 !== 0) {
        this.resultsRegistersFiltersGeneric15Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 115;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric16 !== 0) {
        this.resultsRegistersFiltersGeneric16Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 116;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric17 !== 0) {
        this.resultsRegistersFiltersGeneric17Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 117;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric18 !== 0) {
        this.resultsRegistersFiltersGeneric18Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 118;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric19 !== 0) {
        this.resultsRegistersFiltersGeneric19Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 119;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric20 !== 0) {
        this.resultsRegistersFiltersGeneric20Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 120;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric21 !== 0) {
        this.resultsRegistersFiltersGeneric21Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 121;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric22 !== 0) {
        this.resultsRegistersFiltersGeneric22Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
      ...
      if (gSystemConfig.enableRegistersFilterGeneric23 !== 0) {
        this.resultsRegistersFiltersGeneric23Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 123;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric24 !== 0) {
        this.resultsRegistersFiltersGeneric24Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 124;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric25 !== 0) {
        this.resultsRegistersFiltersGeneric25Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 125;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric26 !== 0) {
        this.resultsRegistersFiltersGeneric26Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 126;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric27 !== 0) {
        this.resultsRegistersFiltersGeneric27Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 127;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric28 !== 0) {
        this.resultsRegistersFiltersGeneric28Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 128;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric29 !== 0) {
        this.resultsRegistersFiltersGeneric29Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 129;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric30 !== 0) {
        this.resultsRegistersFiltersGeneric30Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 130;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric31 !== 0) {
        this.resultsRegistersFiltersGeneric31Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 131;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric32 !== 0) {
        this.resultsRegistersFiltersGeneric32Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
      ...
      if (gSystemConfig.enableRegistersFilterGeneric33 !== 0) {
        this.resultsRegistersFiltersGeneric33Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 133;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric34 !== 0) {
        this.resultsRegistersFiltersGeneric34Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 134;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric35 !== 0) {
        this.resultsRegistersFiltersGeneric35Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 135;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric36 !== 0) {
        this.resultsRegistersFiltersGeneric36Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 136;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric37 !== 0) {
        this.resultsRegistersFiltersGeneric37Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 137;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric38 !== 0) {
        this.resultsRegistersFiltersGeneric38Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 138;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric39 !== 0) {
        this.resultsRegistersFiltersGeneric39Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 139;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric40 !== 0) {
        this.resultsRegistersFiltersGeneric40Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
      ...
      let resultsRegistersTypeListing = this.resultsRegistersTypeListing; // eslint-disable-line
      let resultsRegistersStatusListing = this.resultsRegistersStatusListing; // eslint-disable-line
                          ...
                          .map((registersRow) => {
                            return `
                                <tr class="ss-backend-table-bg-light">
                                    ...
                                    <td style="text-align: center;">
                                        ${SyncSystemNS.FunctionsGeneric.dateRead01(registersRow.date_creation, gSystemConfig.configBackendDateFormat, 0, 3)}
                                    </td>
                                    ...
                                    <td id="formRegistersListing_elementActivation${registersRow.id}" style="text-align: center;" class="${registersRow.activation == 1 ? '' : 'ss-backend-table-bg-deactive'}">
                                        <a id="linkActivation${registersRow.id}" class="ss-backend-links01" 
                                            ...
                                            ${registersRow.activation == '1' ? SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation1A') : SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation0A')} 
                                        </a>
                                    </td>
                                    ${
                                      gSystemConfig.enableRegistersActivation1 == 1
                                        ...
                                        <td id="formRegistersListing_elementActivation1${registersRow.id}" style="text-align: center;" class="${registersRow.activation1 == 1 ? '' : 'ss-backend-table-bg-deactive'}">
                                            <a id="linkActivation1${registersRow.id}" class="ss-backend-links01"
                                                ...
                                                ${registersRow.activation1 == '1' ? SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation1A') : SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation0A')} 
                                            </a>
                                        </td>
                                        `
                                        : ``
                                      ...
                                      gSystemConfig.enableRegistersActivation2 == 1
                                        ...
                                        <td id="formRegistersListing_elementActivation2${registersRow.id}" style="text-align: center;" class="${registersRow.activation2 == 1 ? '' : 'ss-backend-table-bg-deactive'}">
                                            <a id="linkActivation2${registersRow.id}" class="ss-backend-links01"
                                                ...
                                                ${registersRow.activation2 == '1' ? SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation1A') : SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation0A')} 
                                            </a>
                                        </td>
                                        `
                                        : ``
                                      ...
                                      gSystemConfig.enableRegistersActivation3 == 1
                                        ...
                                        <td id="formRegistersListing_elementActivation3${registersRow.id}" style="text-align: center;" class="${registersRow.activation3 == 1 ? '' : 'ss-backend-table-bg-deactive'}">
                                            <a id="linkActivation3${registersRow.id}" class="ss-backend-links01"
                                                ...
                                                ${registersRow.activation3 == '1' ? SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation1A') : SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation0A')} 
                                            </a>
                                        </td>
                                        `
                                        : ``
                                      ...
                                      gSystemConfig.enableRegistersActivation4 == 1
                                        ...
                                        <td id="formRegistersListing_elementActivation4${registersRow.id}" style="text-align: center;" class="${registersRow.activation4 == 1 ? '' : 'ss-backend-table-bg-deactive'}">
                                            <a id="linkActivation4${registersRow.id}" class="ss-backend-links01"
                                                ...
                                                ${registersRow.activation4 == '1' ? SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation1A') : SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation0A')} 
                                            </a>
                                        </td>
                                        `
                                        : ``
                                      ...
                                      gSystemConfig.enableRegistersActivation5 == 1
                                        ...
                                        <td id="formRegistersListing_elementActivation5${registersRow.id}" style="text-align: center;" class="${registersRow.activation5 == 1 ? '' : 'ss-backend-table-bg-deactive'}">
                                            <a id="linkActivation5${registersRow.id}" class="ss-backend-links01"
                                                ...
                                                ${registersRow.activation5 == '1' ? SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation1A') : SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation0A')} 
                                            </a>
                                        </td>
                                        `
                                        : ``
                                      ...
                                      gSystemConfig.enableRegistersRestrictedAccess == 1
                                        ...
                                        <td id="formRegistersListing_elementRestrictedAccess${registersRow.id}" style="text-align: center;" class="${registersRow.restricted_access == 0 ? '' : 'ss-backend-table-bg-deactive'}">
                                            <a id="linkRestrictedAccess${registersRow.id}" class="ss-backend-links01"
                                                ...
                                                ${registersRow.restricted_access == '1' ? SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemRestrictedAccess1A') : SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemRestrictedAccess0A')} 
                                            </a>
                                        </td>
                                        `
                                        : ``
                        ...
                        ${
                          gSystemConfig.enableRegistersBackendPaginationNumbering == 1
                            ...
                            <div class="ss-backend-paging-number-link-a" style="position: relative; display: block; overflow: hidden;">
                                ${Array(this._pagingTotal)
                                  .fill()
                                  .map((item, pageNumberOutput) => {
                                    return `
                                        ${
                ...
                <div style="position: relative; display: block; overflow: hidden;">
                    <script>
                        ...
                        document.addEventListener('DOMContentLoaded', function() {
                            inputDataReorder([${gSystemConfig.configRegistersInputOrder
                              .map((arrayRow) => {
                                return `"${arrayRow}"`;
                              })
                                          ...
                                          gSystemConfig.configBackendDateFormat == 1
                                            ? `
                                                <select id="registers_date_birth_day" name="date_birth_day" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('d', 1, { dateType: 4 })
                                                      .map((arrayRow) => {
                                                        return `
                                                ...
                                                <select id="registers_date_birth_month" name="date_birth_month" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('mm', 1, { dateType: 4 })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                ...
                                                <select id="registers_date_birth_year" name="date_birth_year" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('y', 1, { dateType: 4 })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableRegistersFilterGeneric1 == 1
                                        ? `
                                        ${resultsRegistersFiltersGeneric1Listing
                                          .map((registersFiltersGenericRow) => {
                                            return `
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableRegistersFilterGeneric2 == 1
                                        ? `
                                        ${resultsRegistersFiltersGeneric2Listing
                                          .map((registersFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableRegistersFilterGeneric3 == 1
                                        ? `
                                        ${resultsRegistersFiltersGeneric3Listing
                                          .map((registersFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableRegistersFilterGeneric4 == 1
                                        ? `
                                        ${resultsRegistersFiltersGeneric4Listing
                                          .map((registersFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableRegistersFilterGeneric5 == 1
                                        ? `
                                        ${resultsRegistersFiltersGeneric5Listing
                                          .map((registersFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableRegistersFilterGeneric6 == 1
                                        ? `
                                        ${resultsRegistersFiltersGeneric6Listing
                                          .map((registersFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableRegistersFilterGeneric7 == 1
                                        ? `
                                        ${resultsRegistersFiltersGeneric7Listing
                                          .map((registersFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableRegistersFilterGeneric8 == 1
                                        ? `
                                        ${resultsRegistersFiltersGeneric8Listing
                                          .map((registersFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableRegistersFilterGeneric9 == 1
                                        ? `
                                        ${resultsRegistersFiltersGeneric9Listing
                                          .map((registersFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableRegistersFilterGeneric10 == 1
                                        ? `
                                        ${resultsRegistersFiltersGeneric10Listing
                                          .map((registersFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableRegistersFilterGeneric11 == 1
                                        ? `
                                        ${resultsRegistersFiltersGeneric11Listing
                                          .map((registersFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableRegistersFilterGeneric12 == 1
                                        ? `
                                        ${resultsRegistersFiltersGeneric12Listing
                                          .map((registersFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableRegistersFilterGeneric13 == 1
                                        ? `
                                        ${resultsRegistersFiltersGeneric13Listing
                                          .map((registersFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableRegistersFilterGeneric14 == 1
                                        ? `
                                        ${resultsRegistersFiltersGeneric14Listing
                                          .map((registersFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableRegistersFilterGeneric15 == 1
                                        ? `
                                        ${resultsRegistersFiltersGeneric15Listing
                                          .map((registersFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableRegistersFilterGeneric16 == 1
                                        ? `
                                        ${resultsRegistersFiltersGeneric16Listing
                                          .map((registersFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableRegistersFilterGeneric17 == 1
                                        ? `
                                        ${resultsRegistersFiltersGeneric17Listing
                                          .map((registersFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableRegistersFilterGeneric18 == 1
                                        ? `
                                        ${resultsRegistersFiltersGeneric18Listing
                                          .map((registersFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableRegistersFilterGeneric19 == 1
                                        ? `
                                        ${resultsRegistersFiltersGeneric19Listing
                                          .map((registersFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableRegistersFilterGeneric20 == 1
                                        ? `
                                        ${resultsRegistersFiltersGeneric20Listing
                                          .map((registersFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableRegistersFilterGeneric21 == 1
                                        ? `
                                        ${resultsRegistersFiltersGeneric21Listing
                                          .map((registersFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableRegistersFilterGeneric22 == 1
                                        ? `
                                        ${resultsRegistersFiltersGeneric22Listing
                                          .map((registersFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableRegistersFilterGeneric23 == 1
                                        ? `
                                        ${resultsRegistersFiltersGeneric23Listing
                                          .map((registersFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableRegistersFilterGeneric24 == 1
                                        ? `
                                        ${resultsRegistersFiltersGeneric24Listing
                                          .map((registersFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableRegistersFilterGeneric25 == 1
                                        ? `
                                        ${resultsRegistersFiltersGeneric25Listing
                                          .map((registersFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableRegistersFilterGeneric26 == 1
                                        ? `
                                        ${resultsRegistersFiltersGeneric26Listing
                                          .map((registersFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableRegistersFilterGeneric27 == 1
                                        ? `
                                        ${resultsRegistersFiltersGeneric27Listing
                                          .map((registersFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableRegistersFilterGeneric28 == 1
                                        ? `
                                        ${resultsRegistersFiltersGeneric28Listing
                                          .map((registersFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableRegistersFilterGeneric29 == 1
                                        ? `
                                        ${resultsRegistersFiltersGeneric29Listing
                                          .map((registersFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableRegistersFilterGeneric30 == 1
                                        ? `
                                        ${resultsRegistersFiltersGeneric30Listing
                                          .map((registersFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableRegistersFilterGeneric31 == 1
                                        ? `
                                        ${resultsRegistersFiltersGeneric31Listing
                                          .map((registersFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableRegistersFilterGeneric32 == 1
                                        ? `
                                        ${resultsRegistersFiltersGeneric32Listing
                                          .map((registersFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableRegistersFilterGeneric33 == 1
                                        ? `
                                        ${resultsRegistersFiltersGeneric33Listing
                                          .map((registersFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableRegistersFilterGeneric34 == 1
                                        ? `
                                        ${resultsRegistersFiltersGeneric34Listing
                                          .map((registersFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableRegistersFilterGeneric35 == 1
                                        ? `
                                        ${resultsRegistersFiltersGeneric35Listing
                                          .map((registersFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableRegistersFilterGeneric36 == 1
                                        ? `
                                        ${resultsRegistersFiltersGeneric36Listing
                                          .map((registersFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableRegistersFilterGeneric37 == 1
                                        ? `
                                        ${resultsRegistersFiltersGeneric37Listing
                                          .map((registersFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableRegistersFilterGeneric38 == 1
                                        ? `
                                        ${resultsRegistersFiltersGeneric38Listing
                                          .map((registersFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableRegistersFilterGeneric39 == 1
                                        ? `
                                        ${resultsRegistersFiltersGeneric39Listing
                                          .map((registersFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableRegistersFilterGeneric40 == 1
                                        ? `
                                        ${resultsRegistersFiltersGeneric40Listing
                                          .map((registersFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                          ...
                                          gSystemConfig.configBackendDateFormat == 1
                                            ? `
                                                ...
                                                <select id="registers_date1_day" name="date1_day" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('d', 1, { dateType: gSystemConfig.configRegistersDate1Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowDay == arrayRow ? ' selected' : ``}
                                                ...
                                                <select id="registers_date1_month" name="date1_month" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('mm', 1, { dateType: gSystemConfig.configRegistersDate1Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowMonth == arrayRow ? ' selected' : ``}
                                                ...
                                                <select id="registers_date1_year" name="date1_year" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('y', 1, { dateType: gSystemConfig.configRegistersDate1Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowYear == arrayRow ? ' selected' : ''}
                                    ...
                                    ${
                                      gSystemConfig.configRegistersDate1Type == 2 || gSystemConfig.configRegistersDate1Type == 3 || gSystemConfig.configRegistersDate1Type == 55 || gSystemConfig.configRegistersDate1Type == 66
                                        ...
                                        <select id="registers_date1_hour" name="date1_hour" class="ss-backend-field-dropdown01">
                                            ${SyncSystemNS.FunctionsGeneric.timeTableFill01('h', 1, { dateType: gSystemConfig.configRegistersDate1Type })
                                              .map((arrayRow) => {
                                                return `
                                                    <option value="${arrayRow}"
                                        ...
                                        <select id="registers_date1_minute" name="date1_minute" class="ss-backend-field-dropdown01">
                                            ${SyncSystemNS.FunctionsGeneric.timeTableFill01('m', 1, { dateType: gSystemConfig.configRegistersDate1Type })
                                              .map((arrayRow) => {
                                                return `
                                                    <option value="${arrayRow}"
                                        ...
                                        ${
                                          gSystemConfig.configRegistersDate1Type == 2
                                            ...
                                            <select id="registers_date1_seconds" name="date1_seconds" class="ss-backend-field-dropdown01">
                                                ${SyncSystemNS.FunctionsGeneric.timeTableFill01('s', 1, { dateType: gSystemConfig.configRegistersDate1Type })
                                                  .map((arrayRow) => {
                                                    return `
                                                        <option value="${arrayRow}"
                                          ...
                                          gSystemConfig.configBackendDateFormat == 1
                                            ? `
                                                <select id="registers_date2_day" name="date2_day" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('d', 1, { dateType: gSystemConfig.configRegistersDate2Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowDay == arrayRow ? ' selected' : ``}
                                                ...
                                                <select id="registers_date2_month" name="date2_month" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('mm', 1, { dateType: gSystemConfig.configRegistersDate2Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowMonth == arrayRow ? ' selected' : ``}
                                                ...
                                                <select id="registers_date2_year" name="date2_year" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('y', 1, { dateType: gSystemConfig.configRegistersDate2Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowYear == arrayRow ? ' selected' : ''}
                                    ...
                                    ${
                                      gSystemConfig.configRegistersDate2Type == 2 || gSystemConfig.configRegistersDate2Type == 3 || gSystemConfig.configRegistersDate2Type == 55 || gSystemConfig.configRegistersDate2Type == 66
                                        ...
                                        <select id="registers_date2_hour" name="date2_hour" class="ss-backend-field-dropdown01">
                                            ${SyncSystemNS.FunctionsGeneric.timeTableFill01('h', 1, { dateType: gSystemConfig.configRegistersDate2Type })
                                              .map((arrayRow) => {
                                                return `
                                                    <option value="${arrayRow}"
                                                        ${this.dateNowHour == arrayRow ? ' selected' : ``}
                                        ...
                                        <select id="registers_date2_minute" name="date2_minute" class="ss-backend-field-dropdown01">
                                            ${SyncSystemNS.FunctionsGeneric.timeTableFill01('m', 1, { dateType: gSystemConfig.configRegistersDate2Type })
                                              .map((arrayRow) => {
                                                return `
                                                    <option value="${arrayRow}"
                                                        ${this.dateNowMinute == arrayRow ? ' selected' : ``}
                                        ...
                                        ${
                                          gSystemConfig.configRegistersDate2Type == 2
                                            ...
                                            <select id="registers_date2_seconds" name="date2_seconds" class="ss-backend-field-dropdown01">
                                                ${SyncSystemNS.FunctionsGeneric.timeTableFill01('s', 1, { dateType: gSystemConfig.configRegistersDate2Type })
                                                  .map((arrayRow) => {
                                                    return `
                                                        <option value="${arrayRow}"
                                                            ${this.dateNowSecond == arrayRow ? ' selected' : ``}
                                          ...
                                          gSystemConfig.configBackendDateFormat == 1
                                            ? `
                                                <select id="registers_date3_day" name="date3_day" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('d', 1, { dateType: gSystemConfig.configRegistersDate3Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowDay == arrayRow ? ' selected' : ``}
                                                ...
                                                <select id="registers_date3_month" name="date3_month" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('mm', 1, { dateType: gSystemConfig.configRegistersDate3Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowMonth == arrayRow ? ' selected' : ``}
                                                ...
                                                <select id="registers_date3_year" name="date3_year" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('y', 1, { dateType: gSystemConfig.configRegistersDate3Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowYear == arrayRow ? ' selected' : ''}
                                    ...
                                    ${
                                      gSystemConfig.configRegistersDate3Type == 2 || gSystemConfig.configRegistersDate3Type == 3 || gSystemConfig.configRegistersDate3Type == 55 || gSystemConfig.configRegistersDate3Type == 66
                                        ...
                                        <select id="registers_date3_hour" name="date3_hour" class="ss-backend-field-dropdown01">
                                            ${SyncSystemNS.FunctionsGeneric.timeTableFill01('h', 1, { dateType: gSystemConfig.configRegistersDate3Type })
                                              .map((arrayRow) => {
                                                return `
                                                    <option value="${arrayRow}"
                                                        ${this.dateNowHour == arrayRow ? ' selected' : ``}
                                        ...
                                        <select id="registers_date3_minute" name="date3_minute" class="ss-backend-field-dropdown01">
                                            ${SyncSystemNS.FunctionsGeneric.timeTableFill01('m', 1, { dateType: gSystemConfig.configRegistersDate3Type })
                                              .map((arrayRow) => {
                                                return `
                                                    <option value="${arrayRow}"
                                                        ${this.dateNowMinute == arrayRow ? ' selected' : ``}
                                        ...
                                        ${
                                          gSystemConfig.configRegistersDate3Type == 2
                                            ...
                                            <select id="registers_date3_seconds" name="date3_seconds" class="ss-backend-field-dropdown01">
                                                ${SyncSystemNS.FunctionsGeneric.timeTableFill01('s', 1, { dateType: gSystemConfig.configRegistersDate3Type })
                                                  .map((arrayRow) => {
                                                    return `
                                                        <option value="${arrayRow}"
                                                            ${this.dateNowSecond == arrayRow ? ' selected' : ``}
                                          ...
                                          gSystemConfig.configBackendDateFormat == 1
                                            ? `
                                                <select id="registers_date4_day" name="date4_day" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('d', 1, { dateType: gSystemConfig.configRegistersDate4Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowDay == arrayRow ? ' selected' : ``}
                                                ...
                                                <select id="registers_date4_month" name="date4_month" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('mm', 1, { dateType: gSystemConfig.configRegistersDate4Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowMonth == arrayRow ? ' selected' : ``}
                                                ...
                                                <select id="registers_date4_year" name="date4_year" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('y', 1, { dateType: gSystemConfig.configRegistersDate4Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowYear == arrayRow ? ' selected' : ''}
                                    ...
                                    ${
                                      gSystemConfig.configRegistersDate4Type == 2 || gSystemConfig.configRegistersDate4Type == 3 || gSystemConfig.configRegistersDate4Type == 55 || gSystemConfig.configRegistersDate4Type == 66
                                        ...
                                        <select id="registers_date4_hour" name="date4_hour" class="ss-backend-field-dropdown01">
                                            ${SyncSystemNS.FunctionsGeneric.timeTableFill01('h', 1, { dateType: gSystemConfig.configRegistersDate4Type })
                                              .map((arrayRow) => {
                                                return `
                                                    <option value="${arrayRow}"
                                                        ${this.dateNowHour == arrayRow ? ' selected' : ``}
                                        ...
                                        <select id="registers_date4_minute" name="date4_minute" class="ss-backend-field-dropdown01">
                                            ${SyncSystemNS.FunctionsGeneric.timeTableFill01('m', 1, { dateType: gSystemConfig.configRegistersDate4Type })
                                              .map((arrayRow) => {
                                                return `
                                                    <option value="${arrayRow}"
                                                        ${this.dateNowMinute == arrayRow ? ' selected' : ``}
                                        ...
                                        ${
                                          gSystemConfig.configRegistersDate4Type == 2
                                            ...
                                            <select id="registers_date4_seconds" name="date4_seconds" class="ss-backend-field-dropdown01">
                                                ${SyncSystemNS.FunctionsGeneric.timeTableFill01('s', 1, { dateType: gSystemConfig.configRegistersDate4Type })
                                                  .map((arrayRow) => {
                                                    return `
                                                        <option value="${arrayRow}"
                                                            ${this.dateNowSecond == arrayRow ? ' selected' : ``}
                                          ...
                                          gSystemConfig.configBackendDateFormat == 1
                                            ? `
                                                <select id="registers_date5_day" name="date5_day" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('d', 1, { dateType: gSystemConfig.configRegistersDate5Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowDay == arrayRow ? ' selected' : ``}
                                                ...
                                                <select id="registers_date5_month" name="date5_month" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('mm', 1, { dateType: gSystemConfig.configRegistersDate5Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowMonth == arrayRow ? ' selected' : ``}
                                                ...
                                                <select id="registers_date5_year" name="date5_year" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('y', 1, { dateType: gSystemConfig.configRegistersDate5Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowYear == arrayRow ? ' selected' : ''}
                                    ...
                                    ${
                                      gSystemConfig.configRegistersDate5Type == 2 || gSystemConfig.configRegistersDate5Type == 3 || gSystemConfig.configRegistersDate5Type == 55 || gSystemConfig.configRegistersDate5Type == 66
                                        ...
                                        <select id="registers_date5_hour" name="date5_hour" class="ss-backend-field-dropdown01">
                                            ${SyncSystemNS.FunctionsGeneric.timeTableFill01('h', 1, { dateType: gSystemConfig.configRegistersDate5Type })
                                              .map((arrayRow) => {
                                                return `
                                                    <option value="${arrayRow}"
                                                        ${this.dateNowHour == arrayRow ? ' selected' : ``}
                                        ...
                                        <select id="registers_date5_minute" name="date5_minute" class="ss-backend-field-dropdown01">
                                            ${SyncSystemNS.FunctionsGeneric.timeTableFill01('m', 1, { dateType: gSystemConfig.configRegistersDate5Type })
                                              .map((arrayRow) => {
                                                return `
                                                    <option value="${arrayRow}"
                                                        ${this.dateNowMinute == arrayRow ? ' selected' : ``}
                                        ...
                                        ${
                                          gSystemConfig.configRegistersDate5Type == 2
                                            ...
                                            <select id="registers_date5_seconds" name="date5_seconds" class="ss-backend-field-dropdown01">
                                                ${SyncSystemNS.FunctionsGeneric.timeTableFill01('s', 1, { dateType: gSystemConfig.configRegistersDate5Type })
                                                  .map((arrayRow) => {
                                                    return `
                                                        <option value="${arrayRow}"
                                                            ${this.dateNowSecond == arrayRow ? ' selected' : ``}
                                          ...
                                          gSystemConfig.configBackendDateFormat == 1
                                            ? `
                                                <select id="registers_date6_day" name="date6_day" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('d', 1, { dateType: gSystemConfig.configRegistersDate6Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowDay == arrayRow ? ' selected' : ``}
                                                ...
                                                <select id="registers_date6_month" name="date6_month" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('mm', 1, { dateType: gSystemConfig.configRegistersDate6Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowMonth == arrayRow ? ' selected' : ``}
                                                ...
                                                <select id="registers_date6_year" name="date6_year" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('y', 1, { dateType: gSystemConfig.configRegistersDate6Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowYear == arrayRow ? ' selected' : ''}
                                    ...
                                    ${
                                      gSystemConfig.configRegistersDate6Type == 2 || gSystemConfig.configRegistersDate6Type == 3 || gSystemConfig.configRegistersDate6Type == 55 || gSystemConfig.configRegistersDate6Type == 66
                                        ...
                                        <select id="registers_date6_hour" name="date6_hour" class="ss-backend-field-dropdown01">
                                            ${SyncSystemNS.FunctionsGeneric.timeTableFill01('h', 1, { dateType: gSystemConfig.configRegistersDate6Type })
                                              .map((arrayRow) => {
                                                return `
                                                    <option value="${arrayRow}"
                                                        ${this.dateNowHour == arrayRow ? ' selected' : ``}
                                        ...
                                        <select id="registers_date6_minute" name="date6_minute" class="ss-backend-field-dropdown01">
                                            ${SyncSystemNS.FunctionsGeneric.timeTableFill01('m', 1, { dateType: gSystemConfig.configRegistersDate6Type })
                                              .map((arrayRow) => {
                                                return `
                                                    <option value="${arrayRow}"
                                                        ${this.dateNowMinute == arrayRow ? ' selected' : ``}
                                        ...
                                        ${
                                          gSystemConfig.configRegistersDate6Type == 2
                                            ...
                                            <select id="registers_date6_seconds" name="date6_seconds" class="ss-backend-field-dropdown01">
                                                ${SyncSystemNS.FunctionsGeneric.timeTableFill01('s', 1, { dateType: gSystemConfig.configRegistersDate6Type })
                                                  .map((arrayRow) => {
                                                    return `
                                                        <option value="${arrayRow}"
                                                            ${this.dateNowSecond == arrayRow ? ' selected' : ``}
                                          ...
                                          gSystemConfig.configBackendDateFormat == 1
                                            ? `
                                                <select id="registers_date7_day" name="date7_day" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('d', 1, { dateType: gSystemConfig.configRegistersDate7Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowDay == arrayRow ? ' selected' : ``}
                                                ...
                                                <select id="registers_date7_month" name="date7_month" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('mm', 1, { dateType: gSystemConfig.configRegistersDate7Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowMonth == arrayRow ? ' selected' : ``}
                                                ...
                                                <select id="registers_date7_year" name="date7_year" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('y', 1, { dateType: gSystemConfig.configRegistersDate7Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowYear == arrayRow ? ' selected' : ''}
                                    ...
                                    ${
                                      gSystemConfig.configRegistersDate7Type == 2 || gSystemConfig.configRegistersDate7Type == 3 || gSystemConfig.configRegistersDate7Type == 55 || gSystemConfig.configRegistersDate7Type == 66
                                        ...
                                        <select id="registers_date7_hour" name="date7_hour" class="ss-backend-field-dropdown01">
                                            ${SyncSystemNS.FunctionsGeneric.timeTableFill01('h', 1, { dateType: gSystemConfig.configRegistersDate7Type })
                                              .map((arrayRow) => {
                                                return `
                                                    <option value="${arrayRow}"
                                                        ${this.dateNowHour == arrayRow ? ' selected' : ``}
                                        ...
                                        <select id="registers_date7_minute" name="date7_minute" class="ss-backend-field-dropdown01">
                                            ${SyncSystemNS.FunctionsGeneric.timeTableFill01('m', 1, { dateType: gSystemConfig.configRegistersDate7Type })
                                              .map((arrayRow) => {
                                                return `
                                                    <option value="${arrayRow}"
                                                        ${this.dateNowMinute == arrayRow ? ' selected' : ``}
                                        ...
                                        ${
                                          gSystemConfig.configRegistersDate7Type == 2
                                            ...
                                            <select id="registers_date7_seconds" name="date7_seconds" class="ss-backend-field-dropdown01">
                                                ${SyncSystemNS.FunctionsGeneric.timeTableFill01('s', 1, { dateType: gSystemConfig.configRegistersDate7Type })
                                                  .map((arrayRow) => {
                                                    return `
                                                        <option value="${arrayRow}"
                                                            ${this.dateNowSecond == arrayRow ? ' selected' : ``}
                                          ...
                                          gSystemConfig.configBackendDateFormat == 1
                                            ? `
                                                <select id="registers_date8_day" name="date8_day" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('d', 1, { dateType: gSystemConfig.configRegistersDate8Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowDay == arrayRow ? ' selected' : ``}
                                                ...
                                                <select id="registers_date8_month" name="date8_month" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('mm', 1, { dateType: gSystemConfig.configRegistersDate8Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowMonth == arrayRow ? ' selected' : ``}
                                                ...
                                                <select id="registers_date8_year" name="date8_year" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('y', 1, { dateType: gSystemConfig.configRegistersDate8Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowYear == arrayRow ? ' selected' : ''}
                                    ...
                                    ${
                                      gSystemConfig.configRegistersDate8Type == 2 || gSystemConfig.configRegistersDate8Type == 3 || gSystemConfig.configRegistersDate8Type == 55 || gSystemConfig.configRegistersDate8Type == 66
                                        ...
                                        <select id="registers_date8_hour" name="date8_hour" class="ss-backend-field-dropdown01">
                                            ${SyncSystemNS.FunctionsGeneric.timeTableFill01('h', 1, { dateType: gSystemConfig.configRegistersDate8Type })
                                              .map((arrayRow) => {
                                                return `
                                                    <option value="${arrayRow}"
                                                        ${this.dateNowHour == arrayRow ? ' selected' : ``}
                                        ...
                                        <select id="registers_date8_minute" name="date8_minute" class="ss-backend-field-dropdown01">
                                            ${SyncSystemNS.FunctionsGeneric.timeTableFill01('m', 1, { dateType: gSystemConfig.configRegistersDate8Type })
                                              .map((arrayRow) => {
                                                return `
                                                    <option value="${arrayRow}"
                                                        ${this.dateNowMinute == arrayRow ? ' selected' : ``}
                                        ...
                                        ${
                                          gSystemConfig.configRegistersDate8Type == 2
                                            ...
                                            <select id="registers_date8_seconds" name="date8_seconds" class="ss-backend-field-dropdown01">
                                                ${SyncSystemNS.FunctionsGeneric.timeTableFill01('s', 1, { dateType: gSystemConfig.configRegistersDate8Type })
                                                  .map((arrayRow) => {
                                                    return `
                                                        <option value="${arrayRow}"
                                                            ${this.dateNowSecond == arrayRow ? ' selected' : ``}
                                          ...
                                          gSystemConfig.configBackendDateFormat == 1
                                            ? `
                                                <select id="registers_date9_day" name="date9_day" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('d', 1, { dateType: gSystemConfig.configRegistersDate9Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowDay == arrayRow ? ' selected' : ``}
                                                ...
                                                <select id="registers_date9_month" name="date9_month" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('mm', 1, { dateType: gSystemConfig.configRegistersDate9Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowMonth == arrayRow ? ' selected' : ``}
                                                ...
                                                <select id="registers_date9_year" name="date9_year" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('y', 1, { dateType: gSystemConfig.configRegistersDate9Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowYear == arrayRow ? ' selected' : ''}
                                    ...
                                    ${
                                      gSystemConfig.configRegistersDate9Type == 2 || gSystemConfig.configRegistersDate9Type == 3 || gSystemConfig.configRegistersDate9Type == 55 || gSystemConfig.configRegistersDate9Type == 66
                                        ...
                                        <select id="registers_date9_hour" name="date9_hour" class="ss-backend-field-dropdown01">
                                            ${SyncSystemNS.FunctionsGeneric.timeTableFill01('h', 1, { dateType: gSystemConfig.configRegistersDate9Type })
                                              .map((arrayRow) => {
                                                return `
                                                    <option value="${arrayRow}"
                                                        ${this.dateNowHour == arrayRow ? ' selected' : ``}
                                        ...
                                        <select id="registers_date9_minute" name="date9_minute" class="ss-backend-field-dropdown01">
                                            ${SyncSystemNS.FunctionsGeneric.timeTableFill01('m', 1, { dateType: gSystemConfig.configRegistersDate9Type })
                                              .map((arrayRow) => {
                                                return `
                                                    <option value="${arrayRow}"
                                                        ${this.dateNowMinute == arrayRow ? ' selected' : ``}
                                        ...
                                        ${
                                          gSystemConfig.configRegistersDate9Type == 2
                                            ...
                                            <select id="registers_date9_seconds" name="date9_seconds" class="ss-backend-field-dropdown01">
                                                ${SyncSystemNS.FunctionsGeneric.timeTableFill01('s', 1, { dateType: gSystemConfig.configRegistersDate9Type })
                                                  .map((arrayRow) => {
                                                    return `
                                                        <option value="${arrayRow}"
                                                            ${this.dateNowSecond == arrayRow ? ' selected' : ``}
                                          ...
                                          gSystemConfig.configBackendDateFormat == 1
                                            ? `
                                                <select id="registers_date10_day" name="date10_day" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('d', 1, { dateType: gSystemConfig.configRegistersDate10Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowDay == arrayRow ? ' selected' : ``}
                                                ...
                                                <select id="registers_date10_month" name="date10_month" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('mm', 1, { dateType: gSystemConfig.configRegistersDate10Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowMonth == arrayRow ? ' selected' : ``}
                                                ...
                                                <select id="registers_date10_year" name="date10_year" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('y', 1, { dateType: gSystemConfig.configRegistersDate10Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowYear == arrayRow ? ' selected' : ''}
                                    ...
                                    ${
                                      gSystemConfig.configRegistersDate10Type == 2 || gSystemConfig.configRegistersDate10Type == 3 || gSystemConfig.configRegistersDate10Type == 55 || gSystemConfig.configRegistersDate10Type == 66
                                        ...
                                        <select id="registers_date10_hour" name="date10_hour" class="ss-backend-field-dropdown01">
                                            ${SyncSystemNS.FunctionsGeneric.timeTableFill01('h', 1, { dateType: gSystemConfig.configRegistersDate10Type })
                                              .map((arrayRow) => {
                                                return `
                                                    <option value="${arrayRow}"
                                                        ${this.dateNowHour == arrayRow ? ' selected' : ``}
                                        ...
                                        <select id="registers_date10_minute" name="date10_minute" class="ss-backend-field-dropdown01">
                                            ${SyncSystemNS.FunctionsGeneric.timeTableFill01('m', 1, { dateType: gSystemConfig.configRegistersDate10Type })
                                              .map((arrayRow) => {
                                                return `
                                                    <option value="${arrayRow}"
                                                        ${this.dateNowMinute == arrayRow ? ' selected' : ``}
                                        ...
                                        ${
                                          gSystemConfig.configRegistersDate10Type == 2
                                            ...
                                            <select id="registers_date10_seconds" name="date10_seconds" class="ss-backend-field-dropdown01">
                                                ${SyncSystemNS.FunctionsGeneric.timeTableFill01('s', 1, { dateType: gSystemConfig.configRegistersDate10Type })
                                                  .map((arrayRow) => {
                                                    return `
                                                        <option value="${arrayRow}"
                                                            ${this.dateNowSecond == arrayRow ? ' selected' : ``}
