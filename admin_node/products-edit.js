...
module.exports = class ProductsEdit {
  ...
  async build() {
    ...
    try {
      ...
      if (gSystemConfig.enableProductsType !== 0) {
        this.resultsProductsTypeListing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
      ...
      if (gSystemConfig.enableProductsStatus !== 0) {
        this.resultsProductsStatusListing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
      ...
      if (gSystemConfig.enableProductsFilterGeneric2 !== 0) {
        this.resultsProductsFiltersGeneric2Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 102;
        });
      }
      if (gSystemConfig.enableProductsFilterGeneric3 !== 0) {
        this.resultsProductsFiltersGeneric3Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 103;
        });
      }
      if (gSystemConfig.enableProductsFilterGeneric4 !== 0) {
        this.resultsProductsFiltersGeneric4Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 104;
        });
      }
      if (gSystemConfig.enableProductsFilterGeneric5 !== 0) {
        this.resultsProductsFiltersGeneric5Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 105;
        });
      }
      if (gSystemConfig.enableProductsFilterGeneric6 !== 0) {
        this.resultsProductsFiltersGeneric6Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 106;
        });
      }
      if (gSystemConfig.enableProductsFilterGeneric7 !== 0) {
        this.resultsProductsFiltersGeneric7Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 107;
        });
      }
      if (gSystemConfig.enableProductsFilterGeneric8 !== 0) {
        this.resultsProductsFiltersGeneric8Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 108;
        });
      }
      if (gSystemConfig.enableProductsFilterGeneric9 !== 0) {
        this.resultsProductsFiltersGeneric9Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 109;
        });
      }
      if (gSystemConfig.enableProductsFilterGeneric10 !== 0) {
        this.resultsProductsFiltersGeneric10Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 110;
        });
      }
      if (gSystemConfig.enableProductsFilterGeneric11 !== 0) {
        this.resultsProductsFiltersGeneric11Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 111;
        });
      }
      if (gSystemConfig.enableProductsFilterGeneric12 !== 0) {
        this.resultsProductsFiltersGeneric12Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 112;
        });
      }
      if (gSystemConfig.enableProductsFilterGeneric13 !== 0) {
        this.resultsProductsFiltersGeneric13Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 113;
        });
      }
      if (gSystemConfig.enableProductsFilterGeneric14 !== 0) {
        this.resultsProductsFiltersGeneric14Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 114;
        });
      }
      if (gSystemConfig.enableProductsFilterGeneric15 !== 0) {
        this.resultsProductsFiltersGeneric15Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 115;
        });
      }
      if (gSystemConfig.enableProductsFilterGeneric16 !== 0) {
        this.resultsProductsFiltersGeneric16Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 116;
        });
      }
      if (gSystemConfig.enableProductsFilterGeneric17 !== 0) {
        this.resultsProductsFiltersGeneric17Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 117;
        });
      }
      if (gSystemConfig.enableProductsFilterGeneric18 !== 0) {
        this.resultsProductsFiltersGeneric18Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 118;
        });
      }
      if (gSystemConfig.enableProductsFilterGeneric19 !== 0) {
        this.resultsProductsFiltersGeneric19Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 119;
        });
      }
      if (gSystemConfig.enableProductsFilterGeneric20 !== 0) {
        this.resultsProductsFiltersGeneric20Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 120;
        });
      }
      if (gSystemConfig.enableProductsFilterGeneric21 !== 0) {
        this.resultsProductsFiltersGeneric21Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 121;
        });
      }
      if (gSystemConfig.enableProductsFilterGeneric22 !== 0) {
        this.resultsProductsFiltersGeneric22Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 122;
        });
      }
      if (gSystemConfig.enableProductsFilterGeneric23 !== 0) {
        this.resultsProductsFiltersGeneric23Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 123;
        });
      }
      if (gSystemConfig.enableProductsFilterGeneric24 !== 0) {
        this.resultsProductsFiltersGeneric24Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 124;
        });
      }
      if (gSystemConfig.enableProductsFilterGeneric25 !== 0) {
        this.resultsProductsFiltersGeneric25Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 125;
        });
      }
      if (gSystemConfig.enableProductsFilterGeneric26 !== 0) {
        this.resultsProductsFiltersGeneric26Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 126;
        });
      }
      if (gSystemConfig.enableProductsFilterGeneric27 !== 0) {
        this.resultsProductsFiltersGeneric27Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 127;
        });
      }
      if (gSystemConfig.enableProductsFilterGeneric28 !== 0) {
        this.resultsProductsFiltersGeneric28Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 128;
        });
      }
      if (gSystemConfig.enableProductsFilterGeneric29 !== 0) {
        this.resultsProductsFiltersGeneric29Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 129;
        });
      }
      if (gSystemConfig.enableProductsFilterGeneric30 !== 0) {
        this.resultsProductsFiltersGeneric30Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
      ...
      if (gSystemConfig.enableProductsIdParentEdit == 1) {
        ...
        if (this.objParentTableLevel1.tableName == gSystemConfig.configSystemDBTableCategories) {
          this.objParentTable = await SyncSystemNS.FunctionsDB.genericTableGet02(gSystemConfig.configSystemDBTableCategories, ['category_type;2;i'], gSystemConfig.configCategoriesSort, '', 'id, title', 1);
        }
      ...
      // Meta title.
      this.metaTitle += SyncSystemNS.FunctionsGeneric.contentMaskRead(gSystemConfig.configSystemClientName, 'config-application') + ' - ' + SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendProductsTitleEdit');
  ...
  async cphTitleBuild() {
    ...
    // ----------------------
    try {
      this.cphTitle = SyncSystemNS.FunctionsGeneric.contentMaskRead(gSystemConfig.configSystemClientName, 'config-application') + ' - ' + SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendProductsTitleEdit');
  ...
  async cphBodyBuild() {
    ...
    // Redefine values.
    let opdRecord = this.opdRecord; // eslint-disable-line
                                    ...
                                    ${
                                      gSystemConfig.enableProductsFilterGeneri20 == 3
                                        ...
                                        <select id="idsProductsFiltersGeneri20" name="idsProductsFiltersGeneri20" class="ss-backend-field-dropdown01">
                                            <option value="0" selected>${SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemDropDownSelectNone')}</option>
                                            ${resultsProductsFiltersGeneri20Listing
                                              .map((productsFiltersGenericRow) => {
                                                return `
