...
module.exports = class PublicationsEdit {
  ...
  async build() {
    ...
    try {
      ...
      if (gSystemConfig.enablePublicationsStatus !== 0) {
        this.resultsPublicationsStatusListing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
      ...
      if (gSystemConfig.enablePublicationsFilterGeneric2 !== 0) {
        this.resultsPublicationsFiltersGeneric2Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 102;
        });
      }
      if (gSystemConfig.enablePublicationsFilterGeneric3 !== 0) {
        this.resultsPublicationsFiltersGeneric3Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 103;
        });
      }
      if (gSystemConfig.enablePublicationsFilterGeneric4 !== 0) {
        this.resultsPublicationsFiltersGeneric4Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 104;
        });
      }
      if (gSystemConfig.enablePublicationsFilterGeneric5 !== 0) {
        this.resultsPublicationsFiltersGeneric5Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 105;
        });
      }
      if (gSystemConfig.enablePublicationsFilterGeneric6 !== 0) {
        this.resultsPublicationsFiltersGeneric6Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 106;
        });
      }
      if (gSystemConfig.enablePublicationsFilterGeneric7 !== 0) {
        this.resultsPublicationsFiltersGeneric7Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 107;
        });
      }
      if (gSystemConfig.enablePublicationsFilterGeneric8 !== 0) {
        this.resultsPublicationsFiltersGeneric8Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 108;
        });
      }
      if (gSystemConfig.enablePublicationsFilterGeneric9 !== 0) {
        this.resultsPublicationsFiltersGeneric9Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 109;
        });
      }
      if (gSystemConfig.enablePublicationsFilterGeneric10 !== 0) {
        this.resultsPublicationsFiltersGeneric10Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
      ...
      // Meta title.
      this.metaTitle += SyncSystemNS.FunctionsGeneric.contentMaskRead(gSystemConfig.configSystemClientName, 'config-application') + ' - ' + SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendPublicationsTitleEdit');
  ...
  async cphTitleBuild() {
    ...
    // ----------------------
    try {
      this.cphTitle = SyncSystemNS.FunctionsGeneric.contentMaskRead(gSystemConfig.configSystemClientName, 'config-application') + ' - ' + SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendPublicationsTitleEdit');
