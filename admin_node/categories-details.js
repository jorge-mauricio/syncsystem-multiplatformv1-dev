...
module.exports = class CategoriesDetails {
  ...
  async cphTitleBuild() {
    ...
    // ----------------------
    try {
      this.cphTitle = SyncSystemNS.FunctionsGeneric.contentMaskRead(gSystemConfig.configSystemClientName, 'config-application') + ' - ' + SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendCategoriesTitleDetails');
                              ...
                              ${
                                gSystemConfig.enableCategoriesFilterGeneric1 == 1
                                  ...
                                  <ul class="ss-backend-list-v01">
                                      ${ocdRecord.objCategoriesFiltersGeneric1Binding_print
                          ...
                          <td>
                              ${
                                gSystemConfig.enableCategoriesFilterGeneric2 == 1
                                  ? `
                                  <ul class="ss-backend-list-v01">
                                      ${ocdRecord.objCategoriesFiltersGeneric2Binding_print
                                        .map((categoriesFiltersGenericRow) => {
                                          return `
                                              <li class="ss-backend-list-item-v01">
                                                  ${SyncSystemNS.FunctionsGeneric.contentMaskRead(categoriesFiltersGenericRow.title, 'db')}
                          ...
                          <td>
                              ${
                                gSystemConfig.enableCategoriesFilterGeneric3 == 1
                                  ? `
                                  <ul class="ss-backend-list-v01">
                                      ${ocdRecord.objCategoriesFiltersGeneric3Binding_print
                                        .map((categoriesFiltersGenericRow) => {
                                          return `
                                              <li class="ss-backend-list-item-v01">
                                                  ${SyncSystemNS.FunctionsGeneric.contentMaskRead(categoriesFiltersGenericRow.title, 'db')}
                          ...
                          <td>
                              ${
                                gSystemConfig.enableCategoriesFilterGeneric4 == 1
                                  ? `
                                  <ul class="ss-backend-list-v01">
                                      ${ocdRecord.objCategoriesFiltersGeneric4Binding_print
                                        .map((categoriesFiltersGenericRow) => {
                                          return `
                                              <li class="ss-backend-list-item-v01">
                                                  ${SyncSystemNS.FunctionsGeneric.contentMaskRead(categoriesFiltersGenericRow.title, 'db')}
                          ...
                          <td>
                              ${
                                gSystemConfig.enableCategoriesFilterGeneric5 == 1
                                  ? `
                                  <ul class="ss-backend-list-v01">
                                      ${ocdRecord.objCategoriesFiltersGeneric5Binding_print
                                        .map((categoriesFiltersGenericRow) => {
                                          return `
                                              <li class="ss-backend-list-item-v01">
                                                  ${SyncSystemNS.FunctionsGeneric.contentMaskRead(categoriesFiltersGenericRow.title, 'db')}
                          ...
                          <td>
                              ${
                                gSystemConfig.enableCategoriesFilterGeneric6 == 1
                                  ? `
                                  <ul class="ss-backend-list-v01">
                                      ${ocdRecord.objCategoriesFiltersGeneric6Binding_print
                                        .map((categoriesFiltersGenericRow) => {
                                          return `
                                              <li class="ss-backend-list-item-v01">
                                                  ${SyncSystemNS.FunctionsGeneric.contentMaskRead(categoriesFiltersGenericRow.title, 'db')}
                          ...
                          <td>
                              ${
                                gSystemConfig.enableCategoriesFilterGeneric7 == 1
                                  ? `
                                  <ul class="ss-backend-list-v01">
                                      ${ocdRecord.objCategoriesFiltersGeneric7Binding_print
                                        .map((categoriesFiltersGenericRow) => {
                                          return `
                                              <li class="ss-backend-list-item-v01">
                                                  ${SyncSystemNS.FunctionsGeneric.contentMaskRead(categoriesFiltersGenericRow.title, 'db')}
                          ...
                          <td>
                              ${
                                gSystemConfig.enableCategoriesFilterGeneric8 == 1
                                  ? `
                                  <ul class="ss-backend-list-v01">
                                      ${ocdRecord.objCategoriesFiltersGeneric8Binding_print
                                        .map((categoriesFiltersGenericRow) => {
                                          return `
                                              <li class="ss-backend-list-item-v01">
                                                  ${SyncSystemNS.FunctionsGeneric.contentMaskRead(categoriesFiltersGenericRow.title, 'db')}
                          ...
                          <td>
                              ${
                                gSystemConfig.enableCategoriesFilterGeneric9 == 1
                                  ? `
                                  <ul class="ss-backend-list-v01">
                                      ${ocdRecord.objCategoriesFiltersGeneric9Binding_print
                                        .map((categoriesFiltersGenericRow) => {
                                          return `
                                              <li class="ss-backend-list-item-v01">
                                                  ${SyncSystemNS.FunctionsGeneric.contentMaskRead(categoriesFiltersGenericRow.title, 'db')}
                          ...
                          <td>
                              ${
                                gSystemConfig.enableCategoriesFilterGeneric10 == 1
                                  ? `
                                  <ul class="ss-backend-list-v01">
                                      ${ocdRecord.objCategoriesFiltersGeneric10Binding_print
                                        .map((categoriesFiltersGenericRow) => {
                                          return `
                                              <li class="ss-backend-list-item-v01">
                                                  ${SyncSystemNS.FunctionsGeneric.contentMaskRead(categoriesFiltersGenericRow.title, 'db')}
