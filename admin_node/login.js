...
module.exports = class Login {
  ...
  async cphTitleBuild() {
    ...
    // ----------------------
    try {
      this.cphTitle = SyncSystemNS.FunctionsGeneric.contentMaskRead(gSystemConfig.configSystemClientName, 'config-application') + ' - ' + SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendLoginTitleMain');
          ...
          <div style="position: absolute; 
            ...
            background-repeat: repeat-x, repeat-x;">
              ...
              <header class="ss-backend-title01" style="position: absolute; display: block; right: 10px; top: 30px; text-align: right; font-size: 24px;">
                  ${SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'layoutSystemName')}
              </header>
              ...
              <footer class="ss-backend-copyright" style="position: absolute; 
                                                          ...
                                                          left: 0px; 
                                                          text-align: center;">
                  ${SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'layoutCopyright') + ' ® ' + SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'layoutDevName') + ' ' + SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'layoutCopyright1') + '.'} 
              </footer>
