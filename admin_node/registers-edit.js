...
module.exports = class RegistersEdit {
  ...
  async build() {
    ...
    try {
      ...
      if (gSystemConfig.enableRegistersType !== 0) {
        this.resultsRegistersTypeListing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
      ...
      if (gSystemConfig.enableRegistersStatus !== 0) {
        this.resultsRegistersStatusListing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
      ...
      if (gSystemConfig.enableRegistersFilterGeneric1 !== 0) {
        this.resultsRegistersFiltersGeneric1Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 101;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric2 !== 0) {
        this.resultsRegistersFiltersGeneric2Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 102;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric3 !== 0) {
        this.resultsRegistersFiltersGeneric3Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 103;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric4 !== 0) {
        this.resultsRegistersFiltersGeneric4Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 104;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric5 !== 0) {
        this.resultsRegistersFiltersGeneric5Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 105;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric6 !== 0) {
        this.resultsRegistersFiltersGeneric6Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 106;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric7 !== 0) {
        this.resultsRegistersFiltersGeneric7Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 107;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric8 !== 0) {
        this.resultsRegistersFiltersGeneric8Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 108;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric9 !== 0) {
        this.resultsRegistersFiltersGeneric9Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 109;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric10 !== 0) {
        this.resultsRegistersFiltersGeneric10Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 110;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric11 !== 0) {
        this.resultsRegistersFiltersGeneric11Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 111;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric12 !== 0) {
        this.resultsRegistersFiltersGeneric12Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 112;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric13 !== 0) {
        this.resultsRegistersFiltersGeneric13Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 113;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric14 !== 0) {
        this.resultsRegistersFiltersGeneric14Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 114;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric15 !== 0) {
        this.resultsRegistersFiltersGeneric15Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 115;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric16 !== 0) {
        this.resultsRegistersFiltersGeneric16Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 116;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric17 !== 0) {
        this.resultsRegistersFiltersGeneric17Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 117;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric18 !== 0) {
        this.resultsRegistersFiltersGeneric18Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 118;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric19 !== 0) {
        this.resultsRegistersFiltersGeneric19Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 119;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric20 !== 0) {
        this.resultsRegistersFiltersGeneric20Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 120;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric21 !== 0) {
        this.resultsRegistersFiltersGeneric21Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 121;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric22 !== 0) {
        this.resultsRegistersFiltersGeneric22Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 122;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric23 !== 0) {
        this.resultsRegistersFiltersGeneric23Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 123;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric24 !== 0) {
        this.resultsRegistersFiltersGeneric24Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 124;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric25 !== 0) {
        this.resultsRegistersFiltersGeneric25Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 125;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric26 !== 0) {
        this.resultsRegistersFiltersGeneric26Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 126;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric27 !== 0) {
        this.resultsRegistersFiltersGeneric27Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 127;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric28 !== 0) {
        this.resultsRegistersFiltersGeneric28Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 128;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric29 !== 0) {
        this.resultsRegistersFiltersGeneric29Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 129;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric30 !== 0) {
        this.resultsRegistersFiltersGeneric30Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 130;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric31 !== 0) {
        this.resultsRegistersFiltersGeneric31Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 131;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric32 !== 0) {
        this.resultsRegistersFiltersGeneric32Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 132;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric33 !== 0) {
        this.resultsRegistersFiltersGeneric33Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 133;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric34 !== 0) {
        this.resultsRegistersFiltersGeneric34Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 134;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric35 !== 0) {
        this.resultsRegistersFiltersGeneric35Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 135;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric36 !== 0) {
        this.resultsRegistersFiltersGeneric36Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 136;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric37 !== 0) {
        this.resultsRegistersFiltersGeneric37Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 137;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric38 !== 0) {
        this.resultsRegistersFiltersGeneric38Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 138;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric39 !== 0) {
        this.resultsRegistersFiltersGeneric39Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 139;
        });
      }
      if (gSystemConfig.enableRegistersFilterGeneric40 !== 0) {
        this.resultsRegistersFiltersGeneric40Listing = this.ofglRecords.resultsFiltersGenericListing.filter((obj) => {
      ...
      if (gSystemConfig.enableRegistersIdParentEdit == 1) {
        ...
        if (this.objParentTableLevel1.tableName == gSystemConfig.configSystemDBTableCategories) {
          this.objParentTable = await SyncSystemNS.FunctionsDB.genericTableGet02(gSystemConfig.configSystemDBTableCategories, ['category_type;13;i'], gSystemConfig.configCategoriesSort, '', 'id, title', 1);
        }
      ...
      // Meta title.
      this.metaTitle += SyncSystemNS.FunctionsGeneric.contentMaskRead(gSystemConfig.configSystemClientName, 'config-application') + ' - ' + SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendRegistersTitleEdit');
  ...
  async cphTitleBuild() {
    ...
    // ----------------------
    try {
      this.cphTitle = SyncSystemNS.FunctionsGeneric.contentMaskRead(gSystemConfig.configSystemClientName, 'config-application') + ' - ' + SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendRegistersTitleEdit');
  ...
  async cphBodyBuild() {
    ...
    // Redefine values.
    let ordRecord = this.ordRecord; // eslint-disable-line
    let objParentTableLevel1 = this.objParentTableLevel1; // eslint-disable-line
                                    ...
                                    ${
                                      gSystemConfig.enableRegistersFilterGeneri20 == 3
                                        ...
                                        <select id="idsRegistersFiltersGeneri20" name="idsRegistersFiltersGeneri20" class="ss-backend-field-dropdown01">
                                            <option value="0" selected>${SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemDropDownSelectNone')}</option>
                                            ${resultsRegistersFiltersGeneri20Listing
                                              .map((registersFiltersGenericRow) => {
                                                return `
