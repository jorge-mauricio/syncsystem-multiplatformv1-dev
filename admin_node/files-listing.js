...
module.exports = class FilesListing {
  ...
  async build() {
    ...
    try {
      ...
      if (this._idParent !== 0) {
        let tblCurrent = await SyncSystemNS.FunctionsDB.tableFindGet(this._idParent); // eslint-disable-line

        if (tblCurrent.returnStatus === true) {
      ...
      // Meta title.
      this.metaTitle += SyncSystemNS.FunctionsGeneric.contentMaskRead(gSystemConfig.configSystemClientName, 'config-application') + ' - ' + SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendFilesTitleMain');
  ...
  async cphTitleBuild() {
    ...
    // ----------------------
    try {
      this.cphTitle = SyncSystemNS.FunctionsGeneric.contentMaskRead(gSystemConfig.configSystemClientName, 'config-application') + ' - ' + SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendFilesTitleMain');
      // TODO: Check file type and show the equivalent tile name.
      if (this.titleCurrent) {
  ...
  async cphBodyBuild() {
    ...
    if (gSystemConfig.enableFilesBackendPagination == 1) {
      ...
      this._pagingTotalRecords = await SyncSystemNS.FunctionsDB.genericTableGet02(gSystemConfig.configSystemDBTableFiles, arrSearchParameters, gSystemConfig.configFilesSort, '', 'id, id_parent', 3, {});
                        ...
                        <div style="position: relative; display: block; overflow: hidden; margin-top: 2px;">
                            <script>
                                ...
                                document.addEventListener('DOMContentLoaded', () => {
                                  inputDataReorder([${gSystemConfig.configFilesInputOrder
                                    .map((arrayRow) => {
                                      return `"${arrayRow}"`;
                                    })
                                                  ...
                                                  gSystemConfig.configBackendDateFormat == 1
                                                    ? `
                                                        ...
                                                        <select id="files_date1_day" name="date1_day" class="ss-backend-field-dropdown01">
                                                            ${SyncSystemNS.FunctionsGeneric.timeTableFill01('d', 1, { dateType: gSystemConfig.configFilesDate1Type })
                                                              .map((arrayRow) => {
                                                                return `
                                                        ...
                                                        <select id="files_date1_month" name="date1_month" class="ss-backend-field-dropdown01">
                                                            ${SyncSystemNS.FunctionsGeneric.timeTableFill01('mm', 1, { dateType: gSystemConfig.configFilesDate1Type })
                                                              .map((arrayRow) => {
                                                                return `
                                                                    <option value="${arrayRow}"
                                                        ...
                                                        <select id="files_date1_year" name="date1_year" class="ss-backend-field-dropdown01">
                                                            ${SyncSystemNS.FunctionsGeneric.timeTableFill01('y', 1, { dateType: gSystemConfig.configFilesDate1Type })
                                                              .map((arrayRow) => {
                                                                return `
                                                                    <option value="${arrayRow}"
                                            ...
                                            ${
                                              gSystemConfig.configFilesDate1Type == 2 || gSystemConfig.configFilesDate1Type == 3 || gSystemConfig.configFilesDate1Type == 55 || gSystemConfig.configFilesDate1Type == 66
                                                ...
                                                <select id="files_date1_hour" name="date1_hour" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('h', 1, { dateType: gSystemConfig.configFilesDate1Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                ...
                                                <select id="files_date1_minute" name="date1_minute" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('m', 1, { dateType: gSystemConfig.configFilesDate1Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                ...
                                                ${
                                                  gSystemConfig.configFilesDate1Type == 2
                                                    ...
                                                    <select id="files_date1_seconds" name="date1_seconds" class="ss-backend-field-dropdown01">
                                                        ${SyncSystemNS.FunctionsGeneric.timeTableFill01('s', 1, { dateType: gSystemConfig.configFilesDate1Type })
                                                          .map((arrayRow) => {
                                                            return `
                                                                <option value="${arrayRow}"
                                                  ...
                                                  gSystemConfig.configBackendDateFormat == 1
                                                    ? `
                                                        <select id="files_date2_day" name="date2_day" class="ss-backend-field-dropdown01">
                                                            ${SyncSystemNS.FunctionsGeneric.timeTableFill01('d', 1, { dateType: gSystemConfig.configFilesDate2Type })
                                                              .map((arrayRow) => {
                                                                return `
                                                                    <option value="${arrayRow}"
                                                                        ${this.dateNowDay == arrayRow ? ' selected' : ``}
                                                        ...
                                                        <select id="files_date2_month" name="date2_month" class="ss-backend-field-dropdown01">
                                                            ${SyncSystemNS.FunctionsGeneric.timeTableFill01('mm', 1, { dateType: gSystemConfig.configFilesDate2Type })
                                                              .map((arrayRow) => {
                                                                return `
                                                                    <option value="${arrayRow}"
                                                                        ${this.dateNowMonth == arrayRow ? ' selected' : ``}
                                                        ...
                                                        <select id="files_date2_year" name="date2_year" class="ss-backend-field-dropdown01">
                                                            ${SyncSystemNS.FunctionsGeneric.timeTableFill01('y', 1, { dateType: gSystemConfig.configFilesDate2Type })
                                                              .map((arrayRow) => {
                                                                return `
                                                                    <option value="${arrayRow}"
                                                                        ${this.dateNowYear == arrayRow ? ' selected' : ''}
                                            ...
                                            ${
                                              gSystemConfig.configFilesDate2Type == 2 || gSystemConfig.configFilesDate2Type == 3 || gSystemConfig.configFilesDate2Type == 55 || gSystemConfig.configFilesDate2Type == 66
                                                ...
                                                <select id="files_date2_hour" name="date2_hour" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('h', 1, { dateType: gSystemConfig.configFilesDate2Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowHour == arrayRow ? ' selected' : ``}
                                                ...
                                                <select id="files_date2_minute" name="date2_minute" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('m', 1, { dateType: gSystemConfig.configFilesDate2Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowMinute == arrayRow ? ' selected' : ``}
                                                ...
                                                ${
                                                  gSystemConfig.configFilesDate2Type == 2
                                                    ...
                                                    <select id="files_date2_seconds" name="date2_seconds" class="ss-backend-field-dropdown01">
                                                        ${SyncSystemNS.FunctionsGeneric.timeTableFill01('s', 1, { dateType: gSystemConfig.configFilesDate2Type })
                                                          .map((arrayRow) => {
                                                            return `
                                                                <option value="${arrayRow}"
                                                                    ${this.dateNowSecond == arrayRow ? ' selected' : ``}
                                                  ...
                                                  gSystemConfig.configBackendDateFormat == 1
                                                    ? `
                                                        <select id="files_date3_day" name="date3_day" class="ss-backend-field-dropdown01">
                                                            ${SyncSystemNS.FunctionsGeneric.timeTableFill01('d', 1, { dateType: gSystemConfig.configFilesDate3Type })
                                                              .map((arrayRow) => {
                                                                return `
                                                                    <option value="${arrayRow}"
                                                                        ${this.dateNowDay == arrayRow ? ' selected' : ``}
                                                        ...
                                                        <select id="files_date3_month" name="date3_month" class="ss-backend-field-dropdown01">
                                                            ${SyncSystemNS.FunctionsGeneric.timeTableFill01('mm', 1, { dateType: gSystemConfig.configFilesDate3Type })
                                                              .map((arrayRow) => {
                                                                return `
                                                                    <option value="${arrayRow}"
                                                                        ${this.dateNowMonth == arrayRow ? ' selected' : ``}
                                                        ...
                                                        <select id="files_date3_year" name="date3_year" class="ss-backend-field-dropdown01">
                                                            ${SyncSystemNS.FunctionsGeneric.timeTableFill01('y', 1, { dateType: gSystemConfig.configFilesDate3Type })
                                                              .map((arrayRow) => {
                                                                return `
                                                                    <option value="${arrayRow}"
                                                                        ${this.dateNowYear == arrayRow ? ' selected' : ''}
                                            ...
                                            ${
                                              gSystemConfig.configFilesDate3Type == 2 || gSystemConfig.configFilesDate3Type == 3 || gSystemConfig.configFilesDate3Type == 55 || gSystemConfig.configFilesDate3Type == 66
                                                ...
                                                <select id="files_date3_hour" name="date3_hour" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('h', 1, { dateType: gSystemConfig.configFilesDate3Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowHour == arrayRow ? ' selected' : ``}
                                                ...
                                                <select id="files_date3_minute" name="date3_minute" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('m', 1, { dateType: gSystemConfig.configFilesDate3Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowMinute == arrayRow ? ' selected' : ``}
                                                ...
                                                ${
                                                  gSystemConfig.configFilesDate3Type == 2
                                                    ...
                                                    <select id="files_date3_seconds" name="date3_seconds" class="ss-backend-field-dropdown01">
                                                        ${SyncSystemNS.FunctionsGeneric.timeTableFill01('s', 1, { dateType: gSystemConfig.configFilesDate3Type })
                                                          .map((arrayRow) => {
                                                            return `
                                                                <option value="${arrayRow}"
                                                                    ${this.dateNowSecond == arrayRow ? ' selected' : ``}
                                                  ...
                                                  gSystemConfig.configBackendDateFormat == 1
                                                    ? `
                                                        <select id="files_date4_day" name="date4_day" class="ss-backend-field-dropdown01">
                                                            ${SyncSystemNS.FunctionsGeneric.timeTableFill01('d', 1, { dateType: gSystemConfig.configFilesDate4Type })
                                                              .map((arrayRow) => {
                                                                return `
                                                                    <option value="${arrayRow}"
                                                                        ${this.dateNowDay == arrayRow ? ' selected' : ``}
                                                        ...
                                                        <select id="files_date4_month" name="date4_month" class="ss-backend-field-dropdown01">
                                                            ${SyncSystemNS.FunctionsGeneric.timeTableFill01('mm', 1, { dateType: gSystemConfig.configFilesDate4Type })
                                                              .map((arrayRow) => {
                                                                return `
                                                                    <option value="${arrayRow}"
                                                                        ${this.dateNowMonth == arrayRow ? ' selected' : ``}
                                                        ...
                                                        <select id="files_date4_year" name="date4_year" class="ss-backend-field-dropdown01">
                                                            ${SyncSystemNS.FunctionsGeneric.timeTableFill01('y', 1, { dateType: gSystemConfig.configFilesDate4Type })
                                                              .map((arrayRow) => {
                                                                return `
                                                                    <option value="${arrayRow}"
                                                                        ${this.dateNowYear == arrayRow ? ' selected' : ''}
                                            ...
                                            ${
                                              gSystemConfig.configFilesDate4Type == 2 || gSystemConfig.configFilesDate4Type == 3 || gSystemConfig.configFilesDate4Type == 55 || gSystemConfig.configFilesDate4Type == 66
                                                ...
                                                <select id="files_date4_hour" name="date4_hour" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('h', 1, { dateType: gSystemConfig.configFilesDate4Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowHour == arrayRow ? ' selected' : ``}
                                                ...
                                                <select id="files_date4_minute" name="date4_minute" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('m', 1, { dateType: gSystemConfig.configFilesDate4Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowMinute == arrayRow ? ' selected' : ``}
                                                ...
                                                ${
                                                  gSystemConfig.configFilesDate4Type == 2
                                                    ...
                                                    <select id="files_date4_seconds" name="date4_seconds" class="ss-backend-field-dropdown01">
                                                        ${SyncSystemNS.FunctionsGeneric.timeTableFill01('s', 1, { dateType: gSystemConfig.configFilesDate4Type })
                                                          .map((arrayRow) => {
                                                            return `
                                                                <option value="${arrayRow}"
                                                                    ${this.dateNowSecond == arrayRow ? ' selected' : ``}
                                                  ...
                                                  gSystemConfig.configBackendDateFormat == 1
                                                    ? `
                                                        <select id="files_date5_day" name="date5_day" class="ss-backend-field-dropdown01">
                                                            ${SyncSystemNS.FunctionsGeneric.timeTableFill01('d', 1, { dateType: gSystemConfig.configFilesDate5Type })
                                                              .map((arrayRow) => {
                                                                return `
                                                                    <option value="${arrayRow}"
                                                                        ${this.dateNowDay == arrayRow ? ' selected' : ``}
                                                        ...
                                                        <select id="files_date5_month" name="date5_month" class="ss-backend-field-dropdown01">
                                                            ${SyncSystemNS.FunctionsGeneric.timeTableFill01('mm', 1, { dateType: gSystemConfig.configFilesDate5Type })
                                                              .map((arrayRow) => {
                                                                return `
                                                                    <option value="${arrayRow}"
                                                                        ${this.dateNowMonth == arrayRow ? ' selected' : ``}
                                                        ...
                                                        <select id="files_date5_year" name="date5_year" class="ss-backend-field-dropdown01">
                                                            ${SyncSystemNS.FunctionsGeneric.timeTableFill01('y', 1, { dateType: gSystemConfig.configFilesDate5Type })
                                                              .map((arrayRow) => {
                                                                return `
                                                                    <option value="${arrayRow}"
                                                                        ${this.dateNowYear == arrayRow ? ' selected' : ''}
                                            ...
                                            ${
                                              gSystemConfig.configFilesDate5Type == 2 || gSystemConfig.configFilesDate5Type == 3 || gSystemConfig.configFilesDate5Type == 55 || gSystemConfig.configFilesDate5Type == 66
                                                ...
                                                <select id="files_date5_hour" name="date5_hour" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('h', 1, { dateType: gSystemConfig.configFilesDate5Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowHour == arrayRow ? ' selected' : ``}
                                                ...
                                                <select id="files_date5_minute" name="date5_minute" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('m', 1, { dateType: gSystemConfig.configFilesDate5Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowMinute == arrayRow ? ' selected' : ``}
                                                ...
                                                ${
                                                  gSystemConfig.configFilesDate5Type == 2
                                                    ...
                                                    <select id="files_date5_seconds" name="date5_seconds" class="ss-backend-field-dropdown01">
                                                        ${SyncSystemNS.FunctionsGeneric.timeTableFill01('s', 1, { dateType: gSystemConfig.configFilesDate5Type })
                                                          .map((arrayRow) => {
                                                            return `
                                                                <option value="${arrayRow}"
                                                                    ${this.dateNowSecond == arrayRow ? ' selected' : ``}
                                            ...
                                            <tr class="ss-backend-table-bg-light">
                                                ...
                                                <td id="formCategoririesListing_elementActivation${filesRow.id}" style="text-align: center;" class="${filesRow.activation == 1 ? '' : 'ss-backend-table-bg-deactive'}">
                                                    <a id="linkActivation${filesRow.id}" class="ss-backend-links01" 
                                                        ...
                                                        ${filesRow.activation == '1' ? SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation1A') : SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation0A')} 
                                                    </a>
                                                </td>
                                                ${
                                                  gSystemConfig.enableFilesActivation1 == 1
                                                    ...
                                                    <td id="formCategoririesListing_elementActivation1${filesRow.id}" style="text-align: center;" class="${filesRow.activation1 == 1 ? '' : 'ss-backend-table-bg-deactive'}">
                                                        <a id="linkActivation1${filesRow.id}" class="ss-backend-links01"
                                                            ...
                                                            ${filesRow.activation1 == '1' ? SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation1A') : SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation0A')} 
                                                        </a>
                                                    </td>
                                                    `
                                                    : ``
                                                  ...
                                                  gSystemConfig.enableFilesActivation2 == 1
                                                    ...
                                                    <td id="formCategoririesListing_elementActivation2${filesRow.id}" style="text-align: center;" class="${filesRow.activation2 == 1 ? '' : 'ss-backend-table-bg-deactive'}">
                                                        <a id="linkActivation2${filesRow.id}" class="ss-backend-links01"
                                                            ...
                                                            ${filesRow.activation2 == '1' ? SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation1A') : SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation0A')} 
                                                        </a>
                                                    </td>
                                                    `
                                                    : ``
                                                  ...
                                                  gSystemConfig.enableFilesActivation3 == 1
                                                    ...
                                                    <td id="formCategoririesListing_elementActivation3${filesRow.id}" style="text-align: center;" class="${filesRow.activation3 == 1 ? '' : 'ss-backend-table-bg-deactive'}">
                                                        <a id="linkActivation3${filesRow.id}" class="ss-backend-links01"
                                                            ...
                                                            ${filesRow.activation3 == '1' ? SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation1A') : SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation0A')} 
                                                        </a>
                                                    </td>
                                                    `
                                                    : ``
                                                  ...
                                                  gSystemConfig.enableFilesActivation4 == 1
                                                    ...
                                                    <td id="formCategoririesListing_elementActivation4${filesRow.id}" style="text-align: center;" class="${filesRow.activation4 == 1 ? '' : 'ss-backend-table-bg-deactive'}">
                                                        <a id="linkActivation4${filesRow.id}" class="ss-backend-links01"
                                                            ...
                                                            ${filesRow.activation4 == '1' ? SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation1A') : SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation0A')} 
                                                        </a>
                                                    </td>
                                                    `
                                                    : ``
                                                  ...
                                                  gSystemConfig.enableFilesActivation5 == 1
                                                    ...
                                                    <td id="formCategoririesListing_elementActivation5${filesRow.id}" style="text-align: center;" class="${filesRow.activation5 == 1 ? '' : 'ss-backend-table-bg-deactive'}">
                                                        <a id="linkActivation5${filesRow.id}" class="ss-backend-links01"
                                                            ...
                                                            ${filesRow.activation5 == '1' ? SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation1A') : SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation0A')} 
                                                        </a>
                                                    </td>
                                                    `
                                                    : ``
