...
module.exports = class CategoriesListing {
  ...
  async build() {
    ...
    try {
      ...
      if (this._idParent !== 0) {
        ...
        let tblCategoryCurrent = await SyncSystemNS.FunctionsDB.genericTableGet02(gSystemConfig.configSystemDBTableCategories, ['id;' + this._idParent + ';i'], '', '1', 'id, title, activation', 1, { returnType: 3 });

        if (tblCategoryCurrent.length !== 0) {
          // check for empty (not working)
  ...
  async cphTitleBuild() {
    ...
    // ----------------------
    try {
      this.cphTitle = SyncSystemNS.FunctionsGeneric.contentMaskRead(gSystemConfig.configSystemClientName, 'config-application') + ' - ' + SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendCategoriesTitleMain');
  ...
  async cphBodyBuild() {
    ...
    let ofglRecords = ''; // eslint-disable-line
    ...
    try {
      ...
      if (gSystemConfig.enableCategoriesBackendPagination == 1) {
        ...
        this._pagingTotalRecords = await SyncSystemNS.FunctionsDB.genericTableGet02(gSystemConfig.configSystemDBTableCategories, arrSearchParameters, gSystemConfig.configCategoriesSort, '', 'id, id_parent', 3, {});
      ...
      // Object build.
      // TODO: reorganize where this is going to run.
      ...
      if (gSystemConfig.enableCategoriesStatus !== 0) {
        this.resultsCategoriesStatusListing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
      ...
      if (gSystemConfig.enableCategoriesFilterGeneric2 !== 0) {
        this.resultsCategoriesFiltersGeneric2Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
      ...
      if (gSystemConfig.enableCategoriesFilterGeneric3 !== 0) {
        this.resultsCategoriesFiltersGeneric3Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 103;
        });
      }
      if (gSystemConfig.enableCategoriesFilterGeneric4 !== 0) {
        this.resultsCategoriesFiltersGeneric4Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 104;
        });
      }
      if (gSystemConfig.enableCategoriesFilterGeneric5 !== 0) {
        this.resultsCategoriesFiltersGeneric5Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 105;
        });
      }
      if (gSystemConfig.enableCategoriesFilterGeneric6 !== 0) {
        this.resultsCategoriesFiltersGeneric6Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 106;
        });
      }
      if (gSystemConfig.enableCategoriesFilterGeneric7 !== 0) {
        this.resultsCategoriesFiltersGeneric7Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 107;
        });
      }
      if (gSystemConfig.enableCategoriesFilterGeneric8 !== 0) {
        this.resultsCategoriesFiltersGeneric8Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 108;
        });
      }
      if (gSystemConfig.enableCategoriesFilterGeneric9 !== 0) {
        this.resultsCategoriesFiltersGeneric9Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
          return obj.filter_index == 109;
        });
      }
      if (gSystemConfig.enableCategoriesFilterGeneric10 !== 0) {
        this.resultsCategoriesFiltersGeneric10Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
      ...
      let resultsCategoriesStatusListing = this.resultsCategoriesStatusListing; // eslint-disable-line
                                ...
                                <tr class="ss-backend-table-bg-light">
                                          ...
                                          gSystemConfig.enableCategoriesDate1 == 1
                                            ? `
                                                <div>
                                                    ...
                                                    ${SyncSystemNS.FunctionsGeneric.dateRead01(categoriesRow.date1, gSystemConfig.configBackendDateFormat, 0, gSystemConfig.configCategoriesDate1Type)}
                                                </div>
                                            `
                                            : ``
                                        }
                                          ...
                                          gSystemConfig.enableCategoriesDate2 == 1
                                            ? `
                                                <div>
                                                    ...
                                                    ${SyncSystemNS.FunctionsGeneric.dateRead01(categoriesRow.date2, gSystemConfig.configBackendDateFormat, 0, gSystemConfig.configCategoriesDate2Type)}
                                                </div>
                                            `
                                            : ``
                                        }
                                          ...
                                          gSystemConfig.enableCategoriesDate3 == 1
                                            ? `
                                                <div>
                                                    ...
                                                    ${SyncSystemNS.FunctionsGeneric.dateRead01(categoriesRow.date3, gSystemConfig.configBackendDateFormat, 0, gSystemConfig.configCategoriesDate3Type)}
                                                </div>
                                            `
                                            : ``
                                        }
                                          ...
                                          gSystemConfig.enableCategoriesDate4 == 1
                                            ? `
                                                <div>
                                                    ...
                                                    ${SyncSystemNS.FunctionsGeneric.dateRead01(categoriesRow.date4, gSystemConfig.configBackendDateFormat, 0, gSystemConfig.configCategoriesDate4Type)}
                                                </div>
                                            `
                                            : ``
                                        }
                                          ...
                                          gSystemConfig.enableCategoriesDate5 == 1
                                            ? `
                                                <div>
                                                    ...
                                                    ${SyncSystemNS.FunctionsGeneric.dateRead01(categoriesRow.date5, gSystemConfig.configBackendDateFormat, 0, gSystemConfig.configCategoriesDate5Type)}
                                                </div>
                                            `
                                            : ``
                                        }
                                    ...
                                    <td id="formCategoriesListing_elementActivation${categoriesRow.id}" style="text-align: center;" class="${categoriesRow.activation == 1 ? '' : 'ss-backend-table-bg-deactive'}">
                                        <a id="linkActivation${categoriesRow.id}" class="ss-backend-links01" 
                                            ...
                                            ${categoriesRow.activation == '1' ? SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation1A') : SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation0A')} 
                                        </a>
                                    </td>
                                    ${
                                      gSystemConfig.enableCategoriesActivation1 == 1
                                        ...
                                        <td id="formCategoriesListing_elementActivation1${categoriesRow.id}" style="text-align: center;" class="${categoriesRow.activation1 == 1 ? '' : 'ss-backend-table-bg-deactive'}">
                                            <a id="linkActivation1${categoriesRow.id}" class="ss-backend-links01"
                                                ...
                                                ${categoriesRow.activation1 == '1' ? SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation1A') : SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation0A')} 
                                            </a>
                                        </td>
                                        `
                                        : ``
                                      ...
                                      gSystemConfig.enableCategoriesActivation2 == 1
                                        ...
                                        <td id="formCategoriesListing_elementActivation2${categoriesRow.id}" style="text-align: center;" class="${categoriesRow.activation2 == 1 ? '' : 'ss-backend-table-bg-deactive'}">
                                            <a id="linkActivation2${categoriesRow.id}" class="ss-backend-links01"
                                                ...
                                                ${categoriesRow.activation2 == '1' ? SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation1A') : SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation0A')} 
                                            </a>
                                        </td>
                                        `
                                        : ``
                                      ...
                                      gSystemConfig.enableCategoriesActivation3 == 1
                                        ...
                                        <td id="formCategoriesListing_elementActivation3${categoriesRow.id}" style="text-align: center;" class="${categoriesRow.activation3 == 1 ? '' : 'ss-backend-table-bg-deactive'}">
                                            <a id="linkActivation3${categoriesRow.id}" class="ss-backend-links01"
                                                ...
                                                ${categoriesRow.activation3 == '1' ? SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation1A') : SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation0A')} 
                                            </a>
                                        </td>
                                        `
                                        : ``
                                      ...
                                      gSystemConfig.enableCategoriesActivation4 == 1
                                        ...
                                        <td id="formCategoriesListing_elementActivation4${categoriesRow.id}" style="text-align: center;" class="${categoriesRow.activation4 == 1 ? '' : 'ss-backend-table-bg-deactive'}">
                                            <a id="linkActivation4${categoriesRow.id}" class="ss-backend-links01"
                                                ...
                                                ${categoriesRow.activation4 == '1' ? SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation1A') : SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation0A')} 
                                            </a>
                                        </td>
                                        `
                                        : ``
                                      ...
                                      gSystemConfig.enableCategoriesActivation5 == 1
                                        ...
                                        <td id="formCategoriesListing_elementActivation5${categoriesRow.id}" style="text-align: center;" class="${categoriesRow.activation5 == 1 ? '' : 'ss-backend-table-bg-deactive'}">
                                            <a id="linkActivation5${categoriesRow.id}" class="ss-backend-links01"
                                                ...
                                                ${categoriesRow.activation5 == '1' ? SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation1A') : SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation0A')} 
                                            </a>
                                        </td>
                                        `
                                        : ``
                                      ...
                                      gSystemConfig.enableCategoriesRestrictedAccess == 1
                                        ...
                                        <td id="formCategoriesListing_elementRestrictedAccess${categoriesRow.id}" style="text-align: center;" class="${categoriesRow.restricted_access == 0 ? '' : 'ss-backend-table-bg-deactive'}">
                                            <a id="linkRestrictedAccess${categoriesRow.id}" class="ss-backend-links01"
                                                ...
                                                ${categoriesRow.restricted_access == '1' ? SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemRestrictedAccess1A') : SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemRestrictedAccess0A')} 
                                            </a>
                                        </td>
                                        `
                                        : ``
                                    ...
                                    ${
                                      gSystemConfig.enableCategoriesFilterGeneric1 == 1
                                        ...
                                        ${resultsCategoriesFiltersGeneric1Listing
                                          .map((categoriesFiltersGenericRow) => {
                                            return `
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableCategoriesFilterGeneric2 == 1
                                        ? `
                                        ${resultsCategoriesFiltersGeneric2Listing
                                          .map((categoriesFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableCategoriesFilterGeneric3 == 1
                                        ? `
                                        ${resultsCategoriesFiltersGeneric3Listing
                                          .map((categoriesFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableCategoriesFilterGeneric4 == 1
                                        ? `
                                        ${resultsCategoriesFiltersGeneric4Listing
                                          .map((categoriesFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableCategoriesFilterGeneric5 == 1
                                        ? `
                                        ${resultsCategoriesFiltersGeneric5Listing
                                          .map((categoriesFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableCategoriesFilterGeneric6 == 1
                                        ? `
                                        ${resultsCategoriesFiltersGeneric6Listing
                                          .map((categoriesFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableCategoriesFilterGeneric7 == 1
                                        ? `
                                        ${resultsCategoriesFiltersGeneric7Listing
                                          .map((categoriesFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableCategoriesFilterGeneric8 == 1
                                        ? `
                                        ${resultsCategoriesFiltersGeneric8Listing
                                          .map((categoriesFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableCategoriesFilterGeneric9 == 1
                                        ? `
                                        ${resultsCategoriesFiltersGeneric9Listing
                                          .map((categoriesFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.enableCategoriesFilterGeneric10 == 1
                                        ? `
                                        ${resultsCategoriesFiltersGeneric10Listing
                                          .map((categoriesFiltersGenericRow) => {
                                            return `
                                                <label class="ss-backend-field-checkbox-label">
                                ...
                                <td>
                                    ...
                                    ${
                                      gSystemConfig.configCategoriesNumber1FieldType == 2 || gSystemConfig.configCategoriesNumber1FieldType == 4
                                        ...
                                        <script>
                                            // let  selector = document.getElementById("categories_number1");
                                          ...
                                          gSystemConfig.configBackendDateFormat == 1
                                            ? `
                                                ...
                                                <select id="categories_date1_day" name="date1_day" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('d', 1, { dateType: gSystemConfig.configCategoriesDate1Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                ...
                                                <select id="categories_date1_month" name="date1_month" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('mm', 1, { dateType: gSystemConfig.configCategoriesDate1Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                ...
                                                <select id="categories_date1_year" name="date1_year" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('y', 1, { dateType: gSystemConfig.configCategoriesDate1Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                    ...
                                    ${
                                      gSystemConfig.configCategoriesDate1Type == 2 || gSystemConfig.configCategoriesDate1Type == 3 || gSystemConfig.configCategoriesDate1Type == 55 || gSystemConfig.configCategoriesDate1Type == 66
                                        ...
                                        <select id="categories_date1_hour" name="date1_hour" class="ss-backend-field-dropdown01">
                                            ${SyncSystemNS.FunctionsGeneric.timeTableFill01('h', 1, { dateType: gSystemConfig.configCategoriesDate1Type })
                                              .map((arrayRow) => {
                                                return `
                                                    <option value="${arrayRow}"
                                        ...
                                        <select id="categories_date1_minute" name="date1_minute" class="ss-backend-field-dropdown01">
                                            ${SyncSystemNS.FunctionsGeneric.timeTableFill01('m', 1, { dateType: gSystemConfig.configCategoriesDate1Type })
                                              .map((arrayRow) => {
                                                return `
                                                    <option value="${arrayRow}"
                                        ...
                                        ${
                                          gSystemConfig.configCategoriesDate1Type == 2
                                            ...
                                            <select id="categories_date1_seconds" name="date1_seconds" class="ss-backend-field-dropdown01">
                                                ${SyncSystemNS.FunctionsGeneric.timeTableFill01('s', 1, { dateType: gSystemConfig.configCategoriesDate1Type })
                                                  .map((arrayRow) => {
                                                    return `
                                                        <option value="${arrayRow}"
                                          ...
                                          gSystemConfig.configBackendDateFormat == 1
                                            ? `
                                                <select id="categories_date2_day" name="date2_day" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('d', 1, { dateType: gSystemConfig.configCategoriesDate2Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowDay == arrayRow ? ' selected' : ``}
                                                ...
                                                <select id="categories_date2_month" name="date2_month" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('mm', 1, { dateType: gSystemConfig.configCategoriesDate2Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowMonth == arrayRow ? ' selected' : ``}
                                                ...
                                                <select id="categories_date2_year" name="date2_year" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('y', 1, { dateType: gSystemConfig.configCategoriesDate2Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowYear == arrayRow ? ' selected' : ''}
                                    ...
                                    ${
                                      gSystemConfig.configCategoriesDate2Type == 2 || gSystemConfig.configCategoriesDate2Type == 3 || gSystemConfig.configCategoriesDate2Type == 55 || gSystemConfig.configCategoriesDate2Type == 66
                                        ...
                                        <select id="categories_date2_hour" name="date2_hour" class="ss-backend-field-dropdown01">
                                            ${SyncSystemNS.FunctionsGeneric.timeTableFill01('h', 1, { dateType: gSystemConfig.configCategoriesDate2Type })
                                              .map((arrayRow) => {
                                                return `
                                                    <option value="${arrayRow}"
                                                        ${this.dateNowHour == arrayRow ? ' selected' : ``}
                                        ...
                                        <select id="categories_date2_minute" name="date2_minute" class="ss-backend-field-dropdown01">
                                            ${SyncSystemNS.FunctionsGeneric.timeTableFill01('m', 1, { dateType: gSystemConfig.configCategoriesDate2Type })
                                              .map((arrayRow) => {
                                                return `
                                                    <option value="${arrayRow}"
                                                        ${this.dateNowMinute == arrayRow ? ' selected' : ``}
                                        ...
                                        ${
                                          gSystemConfig.configCategoriesDate2Type == 2
                                            ...
                                            <select id="categories_date2_seconds" name="date2_seconds" class="ss-backend-field-dropdown01">
                                                ${SyncSystemNS.FunctionsGeneric.timeTableFill01('s', 1, { dateType: gSystemConfig.configCategoriesDate2Type })
                                                  .map((arrayRow) => {
                                                    return `
                                                        <option value="${arrayRow}"
                                                            ${this.dateNowSecond == arrayRow ? ' selected' : ``}
                                          ...
                                          gSystemConfig.configBackendDateFormat == 1
                                            ? `
                                                <select id="categories_date3_day" name="date3_day" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('d', 1, { dateType: gSystemConfig.configCategoriesDate3Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowDay == arrayRow ? ' selected' : ``}
                                                ...
                                                <select id="categories_date3_month" name="date3_month" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('mm', 1, { dateType: gSystemConfig.configCategoriesDate3Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowMonth == arrayRow ? ' selected' : ``}
                                                ...
                                                <select id="categories_date3_year" name="date3_year" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('y', 1, { dateType: gSystemConfig.configCategoriesDate3Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowYear == arrayRow ? ' selected' : ''}
                                    ...
                                    ${
                                      gSystemConfig.configCategoriesDate3Type == 2 || gSystemConfig.configCategoriesDate3Type == 3 || gSystemConfig.configCategoriesDate3Type == 55 || gSystemConfig.configCategoriesDate3Type == 66
                                        ...
                                        <select id="categories_date3_hour" name="date3_hour" class="ss-backend-field-dropdown01">
                                            ${SyncSystemNS.FunctionsGeneric.timeTableFill01('h', 1, { dateType: gSystemConfig.configCategoriesDate3Type })
                                              .map((arrayRow) => {
                                                return `
                                                    <option value="${arrayRow}"
                                                        ${this.dateNowHour == arrayRow ? ' selected' : ``}
                                        ...
                                        <select id="categories_date3_minute" name="date3_minute" class="ss-backend-field-dropdown01">
                                            ${SyncSystemNS.FunctionsGeneric.timeTableFill01('m', 1, { dateType: gSystemConfig.configCategoriesDate3Type })
                                              .map((arrayRow) => {
                                                return `
                                                    <option value="${arrayRow}"
                                                        ${this.dateNowMinute == arrayRow ? ' selected' : ``}
                                        ...
                                        ${
                                          gSystemConfig.configCategoriesDate3Type == 2
                                            ...
                                            <select id="categories_date3_seconds" name="date3_seconds" class="ss-backend-field-dropdown01">
                                                ${SyncSystemNS.FunctionsGeneric.timeTableFill01('s', 1, { dateType: gSystemConfig.configCategoriesDate3Type })
                                                  .map((arrayRow) => {
                                                    return `
                                                        <option value="${arrayRow}"
                                                            ${this.dateNowSecond == arrayRow ? ' selected' : ``}
                                          ...
                                          gSystemConfig.configBackendDateFormat == 1
                                            ? `
                                                <select id="categories_date4_day" name="date4_day" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('d', 1, { dateType: gSystemConfig.configCategoriesDate4Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowDay == arrayRow ? ' selected' : ``}
                                                ...
                                                <select id="categories_date4_month" name="date4_month" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('mm', 1, { dateType: gSystemConfig.configCategoriesDate4Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowMonth == arrayRow ? ' selected' : ``}
                                                ...
                                                <select id="categories_date4_year" name="date4_year" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('y', 1, { dateType: gSystemConfig.configCategoriesDate4Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowYear == arrayRow ? ' selected' : ''}
                                    ...
                                    ${
                                      gSystemConfig.configCategoriesDate4Type == 2 || gSystemConfig.configCategoriesDate4Type == 3 || gSystemConfig.configCategoriesDate4Type == 55 || gSystemConfig.configCategoriesDate4Type == 66
                                        ...
                                        <select id="categories_date4_hour" name="date4_hour" class="ss-backend-field-dropdown01">
                                            ${SyncSystemNS.FunctionsGeneric.timeTableFill01('h', 1, { dateType: gSystemConfig.configCategoriesDate4Type })
                                              .map((arrayRow) => {
                                                return `
                                                    <option value="${arrayRow}"
                                                        ${this.dateNowHour == arrayRow ? ' selected' : ``}
                                        ...
                                        <select id="categories_date4_minute" name="date4_minute" class="ss-backend-field-dropdown01">
                                            ${SyncSystemNS.FunctionsGeneric.timeTableFill01('m', 1, { dateType: gSystemConfig.configCategoriesDate4Type })
                                              .map((arrayRow) => {
                                                return `
                                                    <option value="${arrayRow}"
                                                        ${this.dateNowMinute == arrayRow ? ' selected' : ``}
                                        ...
                                        ${
                                          gSystemConfig.configCategoriesDate4Type == 2
                                            ...
                                            <select id="categories_date4_seconds" name="date4_seconds" class="ss-backend-field-dropdown01">
                                                ${SyncSystemNS.FunctionsGeneric.timeTableFill01('s', 1, { dateType: gSystemConfig.configCategoriesDate4Type })
                                                  .map((arrayRow) => {
                                                    return `
                                                        <option value="${arrayRow}"
                                                            ${this.dateNowSecond == arrayRow ? ' selected' : ``}
                                          ...
                                          gSystemConfig.configBackendDateFormat == 1
                                            ? `
                                                <select id="categories_date5_day" name="date5_day" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('d', 1, { dateType: gSystemConfig.configCategoriesDate5Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowDay == arrayRow ? ' selected' : ``}
                                                ...
                                                <select id="categories_date5_month" name="date5_month" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('mm', 1, { dateType: gSystemConfig.configCategoriesDate5Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowMonth == arrayRow ? ' selected' : ``}
                                                ...
                                                <select id="categories_date5_year" name="date5_year" class="ss-backend-field-dropdown01">
                                                    ${SyncSystemNS.FunctionsGeneric.timeTableFill01('y', 1, { dateType: gSystemConfig.configCategoriesDate5Type })
                                                      .map((arrayRow) => {
                                                        return `
                                                            <option value="${arrayRow}"
                                                                ${this.dateNowYear == arrayRow ? ' selected' : ''}
                                    ...
                                    ${
                                      gSystemConfig.configCategoriesDate5Type == 2 || gSystemConfig.configCategoriesDate5Type == 3 || gSystemConfig.configCategoriesDate5Type == 55 || gSystemConfig.configCategoriesDate5Type == 66
                                        ...
                                        <select id="categories_date5_hour" name="date5_hour" class="ss-backend-field-dropdown01">
                                            ${SyncSystemNS.FunctionsGeneric.timeTableFill01('h', 1, { dateType: gSystemConfig.configCategoriesDate5Type })
                                              .map((arrayRow) => {
                                                return `
                                                    <option value="${arrayRow}"
                                                        ${this.dateNowHour == arrayRow ? ' selected' : ``}
                                        ...
                                        <select id="categories_date5_minute" name="date5_minute" class="ss-backend-field-dropdown01">
                                            ${SyncSystemNS.FunctionsGeneric.timeTableFill01('m', 1, { dateType: gSystemConfig.configCategoriesDate5Type })
                                              .map((arrayRow) => {
                                                return `
                                                    <option value="${arrayRow}"
                                                        ${this.dateNowMinute == arrayRow ? ' selected' : ``}
                                        ...
                                        ${
                                          gSystemConfig.configCategoriesDate5Type == 2
                                            ...
                                            <select id="categories_date5_seconds" name="date5_seconds" class="ss-backend-field-dropdown01">
                                                ${SyncSystemNS.FunctionsGeneric.timeTableFill01('s', 1, { dateType: gSystemConfig.configCategoriesDate5Type })
                                                  .map((arrayRow) => {
                                                    return `
                                                        <option value="${arrayRow}"
                                                            ${this.dateNowSecond == arrayRow ? ' selected' : ``}
