...
module.exports = class ContentListing {
  ...
  async build() {
    ...
    try {
      ...
      // Meta title.
      this.metaTitle += SyncSystemNS.FunctionsGeneric.contentMaskRead(gSystemConfig.configSystemClientName, 'config-application') + ' - ' + SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendContentTitleMain');
  ...
  async cphTitleBuild() {
    ...
    // ----------------------
    try {
      this.cphTitle = SyncSystemNS.FunctionsGeneric.contentMaskRead(gSystemConfig.configSystemClientName, 'config-application') + ' - ' + SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendContentTitleMain');
  ...
  async cphBodyBuild() {
    ...
    let backendHTML = ''; // eslint-disable-line
                                ...
                                <tr class="ss-backend-table-bg-light">
                                                                ...
                                                                ${
                                                                  contentRow.content_url != ''
                                                                    ...
                                                                    <a href="${SyncSystemNS.FunctionsGeneric.contentMaskRead(contentRow.content_url, 'url')}" target="_blank">
                                                                        <img src="${contentRow.content_type == 9 ? gSystemConfig.configSystemURLImages + gSystemConfig.configDirectoryFilesSD + '/o' + contentRow.file + '?v=' + this.cacheClear : gSystemConfig.configSystemURLImages + gSystemConfig.configDirectoryFilesSD + '/r' + contentRow.file + '?v=' + this.cacheClear}" 
                                    ...
                                    <td id="formContentListing_elementActivation${contentRow.id}" style="text-align: center;" class="${contentRow.activation == 1 ? '' : 'ss-backend-table-bg-deactive'}">
                                        <a id="linkActivation${contentRow.id}" class="ss-backend-links01" 
                                            ...
                                            ${contentRow.activation == '1' ? SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation1A') : SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation0A')} 
                                        </a>
                                    </td>
                                    <td style="text-align: center;">
