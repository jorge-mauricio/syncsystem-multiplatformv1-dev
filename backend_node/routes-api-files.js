...
router.get('/' + gSystemConfig.configRouteAPI + '/' + gSystemConfig.configRouteAPIFiles + '/:idParentFiles?', (req, res) => {
...
router.get('/' + gSystemConfig.configRouteAPI + '/' + gSystemConfig.configRouteAPIFiles + '/' + gSystemConfig.configRouteAPIDetails + '/:idTbFiles?', (req, res) => {
  // working, with the async block
  // Variables.
  // ----------------------
  let objReturn = { returnStatus: false }; // eslint-disable-line
