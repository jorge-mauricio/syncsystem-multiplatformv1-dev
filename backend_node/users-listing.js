...
module.exports = class UsersListing {
  ...
  async build() {
    ...
    try {
      ...
      // Meta title.
      this.metaTitle += SyncSystemNS.FunctionsGeneric.contentMaskRead(gSystemConfig.configSystemClientName, 'config-application') + ' - ' + SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendUsersTitleMain');
  ...
  async cphTitleBuild() {
    ...
    // ----------------------
    try {
      this.cphTitle = SyncSystemNS.FunctionsGeneric.contentMaskRead(gSystemConfig.configSystemClientName, 'config-application') + ' - ' + SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendUsersTitleMain');
  ...
  async cphBodyBuild() {
    ...
    try {
      ...
      if (gSystemConfig.enableUsersBackendPagination == 1) {
        ...
        this._pagingTotalRecords = await SyncSystemNS.FunctionsDB.genericTableGet02(gSystemConfig.configSystemDBTableUsers, arrSearchParameters, gSystemConfig.configUsersSort, '', 'id, id_parent', 3, {});
                                ...
                                <tr class="ss-backend-table-bg-light">
                                    ...
                                    <td id="formUsersListing_elementActivation${usersRow.id}" style="text-align: center;" class="${usersRow.activation == 1 ? '' : 'ss-backend-table-bg-deactive'}">
                                        <a id="linkActivation${usersRow.id}" class="ss-backend-links01" 
                                            ...
                                            ${usersRow.activation == '1' ? SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation1A') : SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation0A')} 
                                        </a>
                                    </td>
                                    ${
                                      gSystemConfig.enableUsersActivation1 == 1
                                        ...
                                        <td id="formUsersListing_elementActivation1${usersRow.id}" style="text-align: center;" class="${usersRow.activation1 == 1 ? '' : 'ss-backend-table-bg-deactive'}">
                                            <a id="linkActivation1${usersRow.id}" class="ss-backend-links01"
                                                ...
                                                ${usersRow.activation1 == '1' ? SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation1A') : SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation0A')} 
                                            </a>
                                        </td>
                                        `
                                        : ``
                                      ...
                                      gSystemConfig.enableUsersActivation2 == 1
                                        ...
                                        <td id="formUsersListing_elementActivation2${usersRow.id}" style="text-align: center;" class="${usersRow.activation2 == 1 ? '' : 'ss-backend-table-bg-deactive'}">
                                            <a id="linkActivation2${usersRow.id}" class="ss-backend-links01"
                                                ...
                                                ${usersRow.activation2 == '1' ? SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation1A') : SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation0A')} 
                                            </a>
                                        </td>
                                        `
                                        : ``
                                      ...
                                      gSystemConfig.enableUsersActivation3 == 1
                                        ...
                                        <td id="formUsersListing_elementActivation3${usersRow.id}" style="text-align: center;" class="${usersRow.activation3 == 1 ? '' : 'ss-backend-table-bg-deactive'}">
                                            <a id="linkActivation3${usersRow.id}" class="ss-backend-links01"
                                                ...
                                                ${usersRow.activation3 == '1' ? SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation1A') : SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation0A')} 
                                            </a>
                                        </td>
                                        `
                                        : ``
                                      ...
                                      gSystemConfig.enableUsersActivation4 == 1
                                        ...
                                        <td id="formUsersListing_elementActivation4${usersRow.id}" style="text-align: center;" class="${usersRow.activation4 == 1 ? '' : 'ss-backend-table-bg-deactive'}">
                                            <a id="linkActivation4${usersRow.id}" class="ss-backend-links01"
                                                ...
                                                ${usersRow.activation4 == '1' ? SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation1A') : SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation0A')} 
                                            </a>
                                        </td>
                                        `
                                        : ``
                                      ...
                                      gSystemConfig.enableUsersActivation5 == 1
                                        ...
                                        <td id="formUsersListing_elementActivation5${usersRow.id}" style="text-align: center;" class="${usersRow.activation5 == 1 ? '' : 'ss-backend-table-bg-deactive'}">
                                            <a id="linkActivation5${usersRow.id}" class="ss-backend-links01"
                                                ...
                                                ${usersRow.activation5 == '1' ? SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation1A') : SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation0A')} 
                                            </a>
                                        </td>
                                        `
                                        : ``
                ...
                <div style="position: relative; display: block; overflow: hidden;">
                    <script>
                        ...
                        document.addEventListener('DOMContentLoaded', function() {
                            inputDataReorder([${gSystemConfig.configUsersInputOrder
                              .map((arrayRow) => {
                                return `"${arrayRow}"`;
                              })
