...
const FormsFieldsOptionsListing = require('../' + gSystemConfig.configDirectoryAdmin + '/forms-fields-options-listing.js');
const FormsFieldsOptionsEdit = require('../' + gSystemConfig.configDirectoryAdmin + '/forms-fields-options-edit.js');
// ----------------------
...
router.get('/' + gSystemConfig.configRouteBackend + '/' + gSystemConfig.configRouteBackendFormsFieldsOptions + '/:idFormsFields?', [SyncSystemNS.FunctionsAuthentication.authenticationVerification_middleware('user_backend')], (req, res, next) => {
...
router.get('/' + gSystemConfig.configRouteBackend + '/' + gSystemConfig.configRouteBackendFormsFieldsOptions + '/' + gSystemConfig.configRouteBackendActionEdit + '/:idTbFormsFieldsOptions?', [SyncSystemNS.FunctionsAuthentication.authenticationVerification_middleware('user_backend')], (req, res, next) => {
  // working, with the async block
  // Import objects.
  // ----------------------
...
router.put('/' + gSystemConfig.configRouteBackend + '/' + gSystemConfig.configRouteBackendFormsFieldsOptions + '/' + gSystemConfig.configRouteBackendActionEdit, [SyncSystemNS.FunctionsAuthentication.authenticationVerification_middleware('user_backend')], (req, res, next) => {
  // working, with the async block
  // Variables
  // ----------------------
  let tblFormsFieldsOptionsID = '';
