...
const PublicationsListing = require('../' + gSystemConfig.configDirectoryAdmin + '/publications-listing.js');
const PublicationsEdit = require('../' + gSystemConfig.configDirectoryAdmin + '/publications-edit.js');
// ----------------------

// Backend - Publications - listing - GET.
// **************************************************************************************
router.get('/' + gSystemConfig.configRouteBackend + '/' + gSystemConfig.configRouteBackendPublications + '/:idParent?', [SyncSystemNS.FunctionsAuthentication.authenticationVerification_middleware('user_backend')], (req, res, next) => {
...
router.post('/' + gSystemConfig.configRouteBackend + '/' + gSystemConfig.configRouteBackendPublications, [SyncSystemNS.FunctionsAuthentication.authenticationVerification_middleware('user_backend')], (req, res, next) => {
  ...
  let tblPublicationsDateStart = '',
    tblPublicationsDateStartHour = '',
    tblPublicationsDateStartMinute = '',
    tblPublicationsDateStartSeconds = '',
    tblPublicationsDateStartDay = '',
    tblPublicationsDateStartMonth = '',
    tblPublicationsDateStartYear = '';
  let tblPublicationsDateEnd = '',
    tblPublicationsDateEndHour = '',
    tblPublicationsDateEndMinute = '',
    tblPublicationsDateEndSeconds = '',
    tblPublicationsDateEndDay = '',
    tblPublicationsDateEndMonth = '',
    tblPublicationsDateEndYear = '';
  ...
  let tblPublicationsDate1 = '',
    tblPublicationsDate1Hour = '',
    tblPublicationsDate1Minute = '',
    tblPublicationsDate1Seconds = '',
    tblPublicationsDate1Day = '',
    tblPublicationsDate1Month = '',
    tblPublicationsDate1Year = '';
  let tblPublicationsDate2 = '',
    tblPublicationsDate2Hour = '',
    tblPublicationsDate2Minute = '',
    tblPublicationsDate2Seconds = '',
    tblPublicationsDate2Day = '',
    tblPublicationsDate2Month = '',
    tblPublicationsDate2Year = '';
  let tblPublicationsDate3 = '',
    tblPublicationsDate3Hour = '',
    tblPublicationsDate3Minute = '',
    tblPublicationsDate3Seconds = '',
    tblPublicationsDate3Day = '',
    tblPublicationsDate3Month = '',
    tblPublicationsDate3Year = '';
  let tblPublicationsDate4 = '',
    tblPublicationsDate4Hour = '',
    tblPublicationsDate4Minute = '',
    tblPublicationsDate4Seconds = '',
    tblPublicationsDate4Day = '',
    tblPublicationsDate4Month = '',
    tblPublicationsDate4Year = '';
  let tblPublicationsDate5 = '',
    tblPublicationsDate5Hour = '',
    tblPublicationsDate5Minute = '',
    tblPublicationsDate5Seconds = '',
    tblPublicationsDate5Day = '',
    tblPublicationsDate5Month = '',
    tblPublicationsDate5Year = '';
      ...
      let formParseResults = await new Promise((resolve, reject) => {
        ...
        if (gSystemConfig.configUploadComponent === 1) {
          ...
          form.on('end', async function (fields, files) {
            ...
            /*
                        // let resultsFunctionsFiles = await SyncSystemNS.FunctionsFiles.filesUpload(tblPublicationsID, 
            ...
            resultsFunctionsFiles = await new Promise((resolve, reject) => {
              // SyncSystemNS.FunctionsFiles.filesUploadMultiple(tblPublicationsID, this.openedFiles, gSystemConfig.configDirectoryFilesUpload, '', formfileFieldsReference).then(function (results) {
              // eslint-disable-next-line
              SyncSystemNS.FunctionsFiles.filesUploadMultiple(tblPublicationsID, 
                this.openedFiles, gSystemConfig.configDirectoryFilesUpload, 
                '', 
...
// **************************************************************************************
router.get('/' + gSystemConfig.configRouteBackend + '/' + gSystemConfig.configRouteBackendPublications + '/' + gSystemConfig.configRouteBackendActionEdit + '/:idTbPublications?', [SyncSystemNS.FunctionsAuthentication.authenticationVerification_middleware('user_backend')], (req, res, next) => {
  // working, with the async block
...
// **************************************************************************************
router.put('/' + gSystemConfig.configRouteBackend + '/' + gSystemConfig.configRouteBackendPublications + '/' + gSystemConfig.configRouteBackendActionEdit, [SyncSystemNS.FunctionsAuthentication.authenticationVerification_middleware('user_backend')], (req, res, next) => {
  // working, with the async block
  // Variables
  // ----------------------
  let tblPublicationsID = '';
