...
router.get('/' + gSystemConfig.configRouteBackend + '/' + gSystemConfig.configRouteBackendCategories + '/:idParent?', [SyncSystemNS.FunctionsAuthentication.authenticationVerification_middleware('user_backend')], (req, res, next) => {
...
router.get('/' + gSystemConfig.configRouteBackend + '/' + gSystemConfig.configRouteBackendCategories + '/' + gSystemConfig.configRouteBackendActionEdit + '/:idTbCategories?', [SyncSystemNS.FunctionsAuthentication.authenticationVerification_middleware('user_backend')], (req, res, next) => {
  // working, with the async block
...
router.post('/' + gSystemConfig.configRouteBackend + '/' + gSystemConfig.configRouteBackendCategories, [SyncSystemNS.FunctionsAuthentication.authenticationVerification_middleware('user_backend')], (req, res, next) => {
  ...
  */
  ...
  let tblCategoriesDate1 = '',
    tblCategoriesDate1Hour = '',
    tblCategoriesDate1Minute = '',
    tblCategoriesDate1Seconds = '',
  ...
  */
  let tblCategoriesDate2 = '',
    ...
    tblCategoriesDate2Seconds = '',
    tblCategoriesDate2Day = '',
    tblCategoriesDate2Month = '',
    tblCategoriesDate2Year = '';
  let tblCategoriesDate3 = '',
    tblCategoriesDate3Hour = '',
    tblCategoriesDate3Minute = '',
    tblCategoriesDate3Seconds = '',
    tblCategoriesDate3Day = '',
    tblCategoriesDate3Month = '',
    tblCategoriesDate3Year = '';
  let tblCategoriesDate4 = '',
    tblCategoriesDate4Hour = '',
    tblCategoriesDate4Minute = '',
    tblCategoriesDate4Seconds = '',
    tblCategoriesDate4Day = '',
    tblCategoriesDate4Month = '',
    tblCategoriesDate4Year = '';
  let tblCategoriesDate5 = '',
    tblCategoriesDate5Hour = '',
    tblCategoriesDate5Minute = '',
    tblCategoriesDate5Seconds = '',
    tblCategoriesDate5Day = '',
    tblCategoriesDate5Month = '',
    tblCategoriesDate5Year = '';
  ...
  (async () => {
    ...
    try {
      ...
      /*
            let formParseResultsS3 = await new Promise(function(resolve, reject){

                resolve();   
            });
            */

      // let formParseResults = await new Promise(async function(resolve, reject){
      ...
      let formParseResults = await new Promise((resolve, reject) => {
        ...
        if (gSystemConfig.configUploadComponent === 1) {
          ...
          // let formPart = await new Promise(function(resolve, reject){
          // Part.
          // ----------------------
          /*
          form.onPart = (part) => {
          ...
          // form.on('end', async (fields, files) => {
            ...
            /*
                        // let resultsFunctionsFiles = await SyncSystemNS.FunctionsFiles.filesUpload(tblCategoriesID, 
            ...
            resultsFunctionsFiles = await new Promise((resolve, reject) => {
              ...
              SyncSystemNS.FunctionsFiles.filesUpload(tblCategoriesID, 
                                                                    ...
                                                                    gSystemConfig.configDirectoryFilesUpload, 
                                                                    "")*/
              // SyncSystemNS.FunctionsFiles.filesUploadMultiple(tblCategoriesID, this.openedFiles, gSystemConfig.configDirectoryFilesUpload, '', formfileFieldsReference).then(function (results) {
              // eslint-disable-next-line
