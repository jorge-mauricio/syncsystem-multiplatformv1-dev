...
router.get('/' + gSystemConfig.configRouteAPI + '/' + gSystemConfig.configRouteAPIForms + '/' + gSystemConfig.configRouteAPIDetails + '/:idTbForms?', (req, res, next) => {
...
router.post('/' + gSystemConfig.configRouteAPI + '/' + gSystemConfig.configRouteAPIForms + '/' + gSystemConfig.configRouteAPIActionSend + '/', (req, res, next) => {
  // working, with the async block
  // Variables
  // ----------------------
  let objReturn = { returnStatus: false }; // eslint-disable-line
  ...
  let idTbForms = '';
  let masterPageSelect = ''; // eslint-disable-line
  let returnURL = '';
  ...
  (async () => {
    ...
    try {
      ...
      // Build content.
      objEmailBody = await SyncSystemNS.FunctionsEmail.formsContent(
        idTbForms,
        {
