...
router.get('/' + gSystemConfig.configRouteBackend + '/' + gSystemConfig.configRouteBackendProducts + '/:idParent?', [SyncSystemNS.FunctionsAuthentication.authenticationVerification_middleware('user_backend')], (req, res, next) => {
...
router.post('/' + gSystemConfig.configRouteBackend + '/' + gSystemConfig.configRouteBackendProducts, [SyncSystemNS.FunctionsAuthentication.authenticationVerification_middleware('user_backend')], (req, res, next) => {
  ...
  let tblProductsDate1 = '',
    tblProductsDate1Hour = '',
    tblProductsDate1Minute = '',
    tblProductsDate1Seconds = '',
    tblProductsDate1Day = '',
    tblProductsDate1Month = '',
    tblProductsDate1Year = '';
  let tblProductsDate2 = '',
    tblProductsDate2Hour = '',
    tblProductsDate2Minute = '',
    tblProductsDate2Seconds = '',
    tblProductsDate2Day = '',
    tblProductsDate2Month = '',
    tblProductsDate2Year = '';
  let tblProductsDate3 = '',
    tblProductsDate3Hour = '',
    tblProductsDate3Minute = '',
    tblProductsDate3Seconds = '',
    tblProductsDate3Day = '',
    tblProductsDate3Month = '',
    tblProductsDate3Year = '';
  let tblProductsDate4 = '',
    tblProductsDate4Hour = '',
    tblProductsDate4Minute = '',
    tblProductsDate4Seconds = '',
    tblProductsDate4Day = '',
    tblProductsDate4Month = '',
    tblProductsDate4Year = '';
  let tblProductsDate5 = '',
    tblProductsDate5Hour = '',
    tblProductsDate5Minute = '',
    tblProductsDate5Seconds = '',
    tblProductsDate5Day = '',
    tblProductsDate5Month = '',
    tblProductsDate5Year = '';
      ...
      let formParseResults = await new Promise((resolve, reject) => {
        ...
        if (gSystemConfig.configUploadComponent === 1) {
          ...
          form.on('end', async function (fields, files) {
            ...
            /*
                        // let resultsFunctionsFiles = await SyncSystemNS.FunctionsFiles.filesUpload(tblProductsID, 
            ...
            resultsFunctionsFiles = await new Promise((resolve, reject) => {
              // SyncSystemNS.FunctionsFiles.filesUploadMultiple(tblProductsID, this.openedFiles, gSystemConfig.configDirectoryFilesUpload, '', formfileFieldsReference).then(function (results) {
              // eslint-disable-next-line
...
router.get('/' + gSystemConfig.configRouteBackend + '/' + gSystemConfig.configRouteBackendProducts + '/' + gSystemConfig.configRouteBackendActionEdit + '/:idTbProducts?', [SyncSystemNS.FunctionsAuthentication.authenticationVerification_middleware('user_backend')], (req, res, next) => {
  // working, with the async block
...
router.put('/' + gSystemConfig.configRouteBackend + '/' + gSystemConfig.configRouteBackendProducts + '/' + gSystemConfig.configRouteBackendActionEdit, [SyncSystemNS.FunctionsAuthentication.authenticationVerification_middleware('user_backend')], (req, res, next) => {
  // working, with the async block
  // Variables
  // ----------------------
  let tblProductsID = '';
