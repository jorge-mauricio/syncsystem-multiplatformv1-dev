...
module.exports = class QuizzesListing {
  ...
  async build() {
    ...
    try {
      ...
      // Meta title.
      this.metaTitle += SyncSystemNS.FunctionsGeneric.contentMaskRead(gSystemConfig.configSystemClientName, 'config-application') + ' - ' + SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendQuizzesTitleMain');
  ...
  async cphTitleBuild() {
    ...
    // ----------------------
    try {
      this.cphTitle = SyncSystemNS.FunctionsGeneric.contentMaskRead(gSystemConfig.configSystemClientName, 'config-application') + ' - ' + SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendQuizzesTitleMain');
  ...
  async cphBodyBuild() {
    ...
    try {
      ...
      if (gSystemConfig.enableQuizzesBackendPagination == 1) {
        ...
        this._pagingTotalRecords = await SyncSystemNS.FunctionsDB.genericTableGet02(gSystemConfig.configSystemDBTableQuizzes, arrSearchParameters, gSystemConfig.configQuizzesSort, '', 'id, id_parent', 3, {});
      ...
      /*
            ...
            {
                let resultsQuizzesTypeListing = ofglRecords.resultsFiltersGenericListing.filter(function(obj){
                          ...
                          .map((quizzesRow) => {
                            return `
                                <tr class="ss-backend-table-bg-light">
                                    ...
                                    <td style="text-align: center;">
                                        ${SyncSystemNS.FunctionsGeneric.dateRead01(quizzesRow.date_creation, gSystemConfig.configBackendDateFormat, 0, 3)}
                                    </td>
                                            ...
                                            ${
                                              gSystemConfig.configImagePopup == 4
                                                ...
                                                <script>
                                                    ...
                                                    let glightboxQuizzesImageMain = GLightbox(gLightboxBackendConfigOptions);
                                                </script>
                                            `
                                                : ``
                                            }
                                    ...
                                    <td id="formQuizzesListing_elementActivation${quizzesRow.id}" style="text-align: center;" class="${quizzesRow.activation == 1 ? '' : 'ss-backend-table-bg-deactive'}">
                                        <a id="linkActivation${quizzesRow.id}" class="ss-backend-links01" 
                                            ...
                                            ${quizzesRow.activation == '1' ? SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation1A') : SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation0A')} 
                                        </a>
                                    </td>
                                    ${
                                      gSystemConfig.enableQuizzesActivation1 == 1
                                        ...
                                        <td id="formQuizzesListing_elementActivation1${quizzesRow.id}" style="text-align: center;" class="${quizzesRow.activation1 == 1 ? '' : 'ss-backend-table-bg-deactive'}">
                                            <a id="linkActivation1${quizzesRow.id}" class="ss-backend-links01"
                                                ...
                                                ${quizzesRow.activation1 == '1' ? SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation1A') : SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation0A')} 
                                            </a>
                                        </td>
                                        `
                                        : ``
                                      ...
                                      gSystemConfig.enableQuizzesActivation2 == 1
                                        ...
                                        <td id="formQuizzesListing_elementActivation2${quizzesRow.id}" style="text-align: center;" class="${quizzesRow.activation2 == 1 ? '' : 'ss-backend-table-bg-deactive'}">
                                            <a id="linkActivation2${quizzesRow.id}" class="ss-backend-links01"
                                                ...
                                                ${quizzesRow.activation2 == '1' ? SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation1A') : SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation0A')} 
                                            </a>
                                        </td>
                                        `
                                        : ``
                                      ...
                                      gSystemConfig.enableQuizzesActivation3 == 1
                                        ...
                                        <td id="formQuizzesListing_elementActivation3${quizzesRow.id}" style="text-align: center;" class="${quizzesRow.activation3 == 1 ? '' : 'ss-backend-table-bg-deactive'}">
                                            <a id="linkActivation3${quizzesRow.id}" class="ss-backend-links01"
                                                ...
                                                ${quizzesRow.activation3 == '1' ? SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation1A') : SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation0A')} 
                                            </a>
                                        </td>
                                        `
                                        : ``
                                      ...
                                      gSystemConfig.enableQuizzesActivation4 == 1
                                        ...
                                        <td id="formQuizzesListing_elementActivation4${quizzesRow.id}" style="text-align: center;" class="${quizzesRow.activation4 == 1 ? '' : 'ss-backend-table-bg-deactive'}">
                                            <a id="linkActivation4${quizzesRow.id}" class="ss-backend-links01"
                                                ...
                                                ${quizzesRow.activation4 == '1' ? SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation1A') : SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation0A')} 
                                            </a>
                                        </td>
                                        `
                                        : ``
                                      ...
                                      gSystemConfig.enableQuizzesActivation5 == 1
                                        ...
                                        <td id="formQuizzesListing_elementActivation5${quizzesRow.id}" style="text-align: center;" class="${quizzesRow.activation5 == 1 ? '' : 'ss-backend-table-bg-deactive'}">
                                            <a id="linkActivation5${quizzesRow.id}" class="ss-backend-links01"
                                                ...
                                                ${quizzesRow.activation5 == '1' ? SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation1A') : SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation0A')} 
                                            </a>
                                        </td>
                                        `
                                        : ``
                ...
                <div style="position: relative; display: block; overflow: hidden;">
                    <script>
                        ...
                        document.addEventListener('DOMContentLoaded', function() {
                            inputDataReorder([${gSystemConfig.configQuizzesInputOrder
                              .map((arrayRow) => {
                                return `"${arrayRow}"`;
                              })
