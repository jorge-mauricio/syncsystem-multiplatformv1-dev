...
const LoginUsers = require('../' + gSystemConfig.configDirectoryAdmin + '/login-users.js');
// ----------------------
...
router.get('/' + gSystemConfig.configRouteBackend + '/' + gSystemConfig.configRouteBackendUsers + '/', (req, res, next) => {
  ...
  (async () => {
    ...
    try {
      ...
      if (loginVerification == true) {
        ...
        res.cookie(gSystemConfig.configCookiePrefix + '_' + gSystemConfig.configCookiePrefixUserRoot, tblUsersIDCrypt, cookieOptions);
