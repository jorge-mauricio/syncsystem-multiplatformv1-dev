...
module.exports = class FormsListing {
  ...
  async cphTitleBuild() {
    ...
    // ----------------------
    try {
      this.cphTitle = SyncSystemNS.FunctionsGeneric.contentMaskRead(gSystemConfig.configSystemClientName, 'config-application') + ' - ' + SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendFormsTitleMain');
                                ...
                                <tr class="ss-backend-table-bg-light">
                                    ...
                                    <td id="formFormsListing_elementActivation${formsRow.id}" style="text-align: center;" class="${formsRow.activation == 1 ? '' : 'ss-backend-table-bg-deactive'}">
                                        <a id="linkActivation${formsRow.id}" class="ss-backend-links01" 
                                            ...
                                            ${formsRow.activation == '1' ? SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation1A') : SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation0A')} 
                                        </a>
                                    </td>
                                    <td style="text-align: center;">
