...
router.get('/' + gSystemConfig.configRouteAPI + '/' + gSystemConfig.configRouteAPIProducts + '/:idParentProducts?', (req, res) => {
...
router.get('/' + gSystemConfig.configRouteAPI + '/' + gSystemConfig.configRouteAPIProducts + '/' + gSystemConfig.configRouteAPIDetails + '/:idTbProducts?', (req, res) => {
  // working, with the async block
  // Variables.
  // ----------------------
  let objReturn = { returnStatus: false }; // eslint-disable-line
