    ...
    async cphHeadBuild()
    {
        ...
        try
        {
            this.cphHead += `
                ...
                <meta property="og:image" content="${ gSystemConfig.configSystemURL + "/" +  gSystemConfig.configDirectoryFilesLayoutSD + "/" + "TODO: logo" }" /> ${ /*The recommended resolution for the OG image is 1200x627 pixels, the size up to 5MB. //120x120px, up to 1MB JPG ou PNG, lower than 300k and minimum dimension 300x200 pixels.*/'' }
    ...
    async cphBodyBuild()
    {
        ...
        try
        {
            ...
            <section class="ss-backend-layout-section-form01">
                <form id="formCategories" name="formCategories" method="POST" action="/${ gSystemConfig.configRouteBackend + "/" + gSystemConfig.configRouteBackendCategories }/edit" enctype="multipart/form-data">
                            ...
                            <tbody class="ss-backend-table-listing-text01">
                                ...
                                <tr id="inputRowCategories_number1" class="ss-backend-table-bg-light">
                                    ...
                                    <td>
                                        ...
                                        `
                                            <input type="text" id="categories_number1" name="number1" class="ss-backend-field-numeric02" value="${ ocdRecord.tblCategoriesNumber1 }" maxlength="34" />
                                            <script>
                                        ...
                                        `
                                            ...
                                            <input type="text" id="categories_number1" name="number1" class="ss-backend-field-currency01" value="${ ocdRecord.tblCategoriesNumber1 }" maxlength="45" />
                                ...
                                <tr id="inputRowCategories_number2" class="ss-backend-table-bg-light">
                                    ...
                                    <td>
                                        ...
                                        `
                                            <input type="text" id="categories_number2" name="number2" class="ss-backend-field-numeric02" value="${ ocdRecord.tblCategoriesNumber2 }" maxlength="34" />
                                            <script>
                                        ...
                                        `
                                            ${ gSystemConfig.configSystemCurrency }
                                            <input type="text" id="categories_number2" name="number2" class="ss-backend-field-currency01" value="${ ocdRecord.tblCategoriesNumber2 }" maxlength="45" />
                                ...
                                <tr id="inputRowCategories_number3" class="ss-backend-table-bg-light">
                                    ...
                                    <td>
                                        ...
                                        `
                                            <input type="text" id="categories_number3" name="number3" class="ss-backend-field-numeric02" value="${ ocdRecord.tblCategoriesNumber3 }" maxlength="34" />
                                            <script>
                                        ...
                                        `
                                            ${ gSystemConfig.configSystemCurrency }
                                            <input type="text" id="categories_number3" name="number3" class="ss-backend-field-currency01" value="${ ocdRecord.tblCategoriesNumber3 }" maxlength="45" />
                                ...
                                <tr id="inputRowCategories_number4" class="ss-backend-table-bg-light">
                                    ...
                                    <td>
                                        ...
                                        `
                                            <input type="text" id="categories_number4" name="number4" class="ss-backend-field-numeric02" value="${ ocdRecord.tblCategoriesNumber4 }" maxlength="34" />
                                            <script>
                                        ...
                                        `
                                            ${ gSystemConfig.configSystemCurrency }
                                            <input type="text" id="categories_number4" name="number4" class="ss-backend-field-currency01" value="${ ocdRecord.tblCategoriesNumber4 }" maxlength="45" />
                                ...
                                <tr id="inputRowCategories_number5" class="ss-backend-table-bg-light">
                                    ...
                                    <td>
                                        ...
                                        `
                                            <input type="text" id="categories_number5" name="number5" class="ss-backend-field-numeric02" value="${ ocdRecord.tblCategoriesNumber5 }" maxlength="34" />
                                            <script>
                                        ...
                                        `
                                            ${ gSystemConfig.configSystemCurrency }
                                            <input type="text" id="categories_number5" name="number5" class="ss-backend-field-currency01" value="${ ocdRecord.tblCategoriesNumber5 }" maxlength="45" />
                                ...
                                <tr id="inputRowCategories_number_small1" class="ss-backend-table-bg-light">
                                    ...
                                    <td>
                                        ...
                                        `
                                            <input type="text" id="categories_number_small1" name="number_small1" class="ss-backend-field-numeric01" value="${ ocdRecord.tblCategoriesNumberSmall1 }" maxlength="9" />
                                            <script>
                                        ...
                                        `
                                            ${ gSystemConfig.configSystemCurrency }
                                            <input type="text" id="categories_number_small1" name="number_small1" class="ss-backend-field-currency01" value="${ ocdRecord.tblCategoriesNumberSmall1 }" maxlength="9" />
                                            <script>
                                ...
                                <tr id="inputRowCategories_number_small2" class="ss-backend-table-bg-light">
                                    ...
                                    <td>
                                        ...
                                        `
                                            <input type="text" id="categories_number_small2" name="number_small2" class="ss-backend-field-numeric01" value="${ ocdRecord.tblCategoriesNumberSmall2 }" maxlength="9" />
                                            <script>
                                        ...
                                        `
                                            ${ gSystemConfig.configSystemCurrency }
                                            <input type="text" id="categories_number_small2" name="number_small2" class="ss-backend-field-currency01" value="${ ocdRecord.tblCategoriesNumberSmall2 }" maxlength="9" />
                                            <script>
                                ...
                                <tr id="inputRowCategories_number_small3" class="ss-backend-table-bg-light">
                                    ...
                                    <td>
                                        ...
                                        `
                                            <input type="text" id="categories_number_small3" name="number_small3" class="ss-backend-field-numeric01" value="${ ocdRecord.tblCategoriesNumberSmall3 }" maxlength="9" />
                                            <script>
                                        ...
                                        `
                                            ${ gSystemConfig.configSystemCurrency }
                                            <input type="text" id="categories_number_small3" name="number_small3" class="ss-backend-field-currency01" value="${ ocdRecord.tblCategoriesNumberSmall3 }" maxlength="9" />
                                            <script>
                                ...
                                <tr id="inputRowCategories_number_small4" class="ss-backend-table-bg-light">
                                    ...
                                    <td>
                                        ...
                                        `
                                            <input type="text" id="categories_number_small4" name="number_small4" class="ss-backend-field-numeric01" value="${ ocdRecord.tblCategoriesNumberSmall4 }" maxlength="9" />
                                            <script>
                                        ...
                                        `
                                            ${ gSystemConfig.configSystemCurrency }
                                            <input type="text" id="categories_number_small4" name="number_small4" class="ss-backend-field-currency01" value="${ ocdRecord.tblCategoriesNumberSmall4 }" maxlength="9" />
                                            <script>
                                ...
                                <tr id="inputRowCategories_number_small5" class="ss-backend-table-bg-light">
                                    ...
                                    <td>
                                        ...
                                        `
                                            <input type="text" id="categories_number_small5" name="number_small5" class="ss-backend-field-numeric01" value="${ ocdRecord.tblCategoriesNumberSmall5 }" maxlength="9" />
                                            <script>
                                        ...
                                        `
                                            ${ gSystemConfig.configSystemCurrency }
                                            <input type="text" id="categories_number_small5" name="number_small5" class="ss-backend-field-currency01" value="${ ocdRecord.tblCategoriesNumberSmall5 }" maxlength="9" />
                                            <script>
                                        ...
                                        <td>
                                            <select id="categories_id_status" name="id_status" class="ss-backend-field-dropdown01">
                                                ...
                                                ${resultsCategoriesStatusListing.map((statusRow)=>{
                                                    return `
                                                        <option value="${ statusRow.id }"${ ocdRecord.tblCategoriesIdStatus == statusRow.category_type ? ` selected` : `` }>${ SyncSystemNS.FunctionsGeneric.contentMaskRead(statusRow.title, "db") }</option>
                                                    `;
                                                }).join("") }
                                            </select>
                                        </td>
