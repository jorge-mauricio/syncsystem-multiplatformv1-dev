    ...
    async build()
    {
        ...
        try
        {
            ...
            if(this.objParentTable.tableName == gSystemConfig.configSystemDBTableCategories)
            {
                ...
                //Meta description.
                if(gSystemConfig.enableFilesDescription == 1)
                {
                            ...
                            <thead class="ss-backend-table-bg-dark ss-backend-table-header-text01">
                                <tr>
                                    ...
                                    <td style="text-align: left;">
                                        ${ SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, "backendContentContent") }  
                                    </td>
                                                            ...
                                                            <picture>
                                                                ...
                                                                `
                                                                    <img src="${ 
                                                                                    ...
                                                                                    gSystemConfig.configSystemURLImages + gSystemConfig.configDirectoryFilesSD + "/o" + contentRow.file 
                                                                                    :
                                                                                    gSystemConfig.configSystemURLImages + gSystemConfig.configDirectoryFilesSD + "/" + contentRow.file 
                                                                                }" 
                                                                        alt="${ SyncSystemNS.FunctionsGeneric.contentMaskRead(contentRow.caption, "db") }" 
                                                                        class="ss-backend-content-images" 
                                                                    />
                    ...
                    <div style="position: relative; display: block; overflow: hidden;">
                        ...
                        <table id="inputTableContentImage" class="ss-backend-table-input01">
                            ...
                            <tbody class="ss-backend-table-listing-text01">
                                ...
                                `
                                <tr id="inputRowContentImage_file_thumbnail" class="ss-backend-table-bg-light">
                                    <td class="ss-backend-table-bg-medium">
                                        ${ SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, "backendContentFileThumbnail") }: 
                                    </td>
                                    <td>
                                        <input type="file" id="content_image_file_thumbnail" name="file_thumbnail" class="ss-backend-field-file-upload" />
                                    </td>
                                </tr>
                                ` : ``
                                }
                    ...
                    <div style="position: relative; display: block; overflow: hidden;">
                        ...
                        <table id="inputTableContentVideo" class="ss-backend-table-input01">
                            ...
                            <tbody class="ss-backend-table-listing-text01">
                                ...
                                <tr id="inputRowContentVideo_content_type" class="ss-backend-table-bg-light">
                                    <td class="ss-backend-table-bg-medium">
                                        ${ SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, "backendContentType") }: 
                                    </td>
                                    <td>
                                ...
                                ${ gSystemConfig.enableContentImageNoResize == 1 ? 
                                `
                                <tr id="inputRowContentVideo_content_type_x" class="ss-backend-table-bg-light">
                                    <td class="ss-backend-table-bg-medium">
                                        ${ SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, "backendContentImageNoResize") }: 
                                    </td>
                                    <td>
                                        <label class="ss-backend-field-radio-label-horizontal">
                                            <input type="radio" name="content_type_x" value="9" class="ss-backend-field-radio" />
                                            ${ SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, "backendContentImageNoResizeYes") }
                                        </label>
                                        <label class="ss-backend-field-radio-label-horizontal">
                                            <input type="radio" name="content_type_x" value="5" checked class="ss-backend-field-radio" />
                                            ${ SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, "backendContentImageNoResizeNo") }
                                        </label>
                                    </td>
                                </tr>
                                ...
                                ${ gSystemConfig.enableContentURL == 1 ? 
                                `
                                <tr id="inputRowContentVideo_content_url" class="ss-backend-table-bg-light">
                                    <td class="ss-backend-table-bg-medium">
                                        ${ SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, "backendContentURL") }: 
                                    </td>
                                    <td>
                                        <input type="text" id="content_video_content_url" name="content_url" class="ss-backend-field-text-area-url" maxlength="255" value="" />
                                    </td>
                                </tr>
                                ` : ``
                                }
                    ...
                    <div style="position: relative; display: block; overflow: hidden;">
                        ...
                        <table id="inputTableContentFile" class="ss-backend-table-input01">
                            ...
                            <tbody class="ss-backend-table-listing-text01">
                                ...
                                <!--tr id="inputRowContentFile_id_parent" class="ss-backend-table-bg-light">
                                    <td class="ss-backend-table-bg-medium">
                                        ${ SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, "backendItemParentLink") }: 
                                    </td>
                                    <td>
                                ...
                                <tr id="inputRowContentFile_content_type" class="ss-backend-table-bg-light">
                                    <td class="ss-backend-table-bg-medium">
                                        ${ SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, "backendContentType") }: 
                                    </td>
                                    <td>
                                ...
                                ${ gSystemConfig.enableContentImageNoResize == 1 ? 
                                `
                                <tr id="inputRowContentFile_content_type_x" class="ss-backend-table-bg-light">
                                    <td class="ss-backend-table-bg-medium">
                                        ${ SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, "backendContentImageNoResize") }: 
                                    </td>
                                    <td>
                                ...
                                ${ gSystemConfig.enableContentURL == 1 ? 
                                `
                                <tr id="inputRowContentFile_content_url" class="ss-backend-table-bg-light">
                                    <td class="ss-backend-table-bg-medium">
                                        ${ SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, "backendContentURL") }: 
                                    </td>
                                    <td>
                                        <input type="text" id="content_file_content_url" name="content_url" class="ss-backend-field-text-area-url" maxlength="255" value="" />
                                    </td>
                                </tr>
                                ` : ``
                                }

                                <tr id="inputRowContentFile_caption" class="ss-backend-table-bg-light">
                                    <td class="ss-backend-table-bg-medium">
                                        ${ SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, "backendContentCaption") }: 
                                    </td>
                                    <td>
                                        <input type="text" id="content_file_caption" name="caption" class="ss-backend-field-text01" maxlength="255" value="" />
                                    </td>
                                </tr>
