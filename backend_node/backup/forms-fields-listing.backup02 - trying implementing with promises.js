...
module.exports = class FormsFieldsListing
{
    ...
    async cphBodyBuild()
    {
        ...
        try
        {
            ...
            /* */
            //backendHTML = await `
            backendHTML = await new Promise((resolve, reject)=>{ let results = `
                ...
                <form id="formFormsFieldsListing" name="formFormsFieldsListing" method="POST" action="" enctype="application/x-www-form-urlencoded">
                    ...
                    <div style="position: relative; display: block; overflow: hidden;">
                        <table class="ss-backend-table-listing01">
                            ...
                            ${ offlRecords.resultsFormsFieldsListing.map(async (formsFieldsRow)=>{
                                ...
                                //offolRecords.recordsListingGet(0, 3).then({});
                                //offolRecords.recordsListingGet(0, 3).then(()=>{
                                //offolRecords.recordsListingGet(0, 3).then((offolRecords.resultsFormsFieldsOptionsListing)=>{
                                //offolRecords.recordsListingGet(0, 3).then((offolRecords)=>{});
                                
                                //Debug.
                                //console.log("offolRecords=",offolRecords);
                                //return await Promise.resolve(`
                                return await new Promise((resolve, reject)=>{ let results = `
                                    <tr class="ss-backend-table-bg-light">
                                        ...
                                        <td style="text-align: left;">
                                            ...
                                            `
                                                <input type="text" id="${ formsFieldsRow.field_name_formatted }" name="${ formsFieldsRow.field_name_formatted }" value="" size="${ formsFieldsRow.field_size }" class="ss-backend-field-text01" style="width: auto;" />
                                            ` : ``
                                            }
                                            ...
                                            `
                                                <textarea id="${ formsFieldsRow.field_name_formatted }" name="${ formsFieldsRow.field_name_formatted }" cols="${ formsFieldsRow.field_size }" rows="${ formsFieldsRow.field_size }" class="ss-backend-field-text-area-content" style="width: auto;"></textarea>
                                            ` : ``
                                            }
                                            ...
                                            `
                                                <label class="ss-backend-field-checkbox-label">
                                                    <input type="checkbox" id="field123" name="field123" value="option_name" class="ss-backend-field-checkbox" />
                                                </label>
                                            ...
                                            `
                                                <label class="ss-backend-field-radio-label">
                                                    <input type="radio" id="field1235" name="field1235" value="option_name" class="ss-backend-field-radio" />
                                                </label>
                                            ...
                                            `
                                                <select id="${ formsFieldsRow.field_name_formatted }" name="${ formsFieldsRow.field_name_formatted }" class="ss-backend-field-dropdown01" style="width: auto;">
            ...
            /*.then((results)=>{
                if(results === undefined)
                {
                    ...
                    reject(new Error("backendHTML not buit."));
                }else{
                    //Success.
            ...
            //(async () => {
                ...
                await Promise.all(backendHTML);
                //Promise.all(backendHTML);
                this.cphBody = backendHTML;
                //this.cphBody = await backendHTML;
            //})();
