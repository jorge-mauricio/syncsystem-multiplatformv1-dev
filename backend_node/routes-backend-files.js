...
router.get('/' + gSystemConfig.configRouteBackend + '/' + gSystemConfig.configRouteBackendFiles + '/:idParent?', [SyncSystemNS.FunctionsAuthentication.authenticationVerification_middleware('user_backend')], (req, res, next) => {
...
router.get('/' + gSystemConfig.configRouteBackend + '/' + gSystemConfig.configRouteBackendFiles + '/' + gSystemConfig.configRouteBackendDetails + '/:idTbFiles?', [SyncSystemNS.FunctionsAuthentication.authenticationVerification_middleware('user_backend')], (req, res, next) => {
  // working, with the async block
...
router.post('/' + gSystemConfig.configRouteBackend + '/' + gSystemConfig.configRouteBackendFiles, [SyncSystemNS.FunctionsAuthentication.authenticationVerification_middleware('user_backend')], (req, res, next) => {
  ...
  let tblFilesFileDuration = ''; // eslint-disable-line
  let tblFilesFileDimensions = ''; // eslint-disable-line
          ...
          // form.on('end', async (fields, files) => {
            ...
            resultsFunctionsFiles = await new Promise((resolve, reject) => {
              /*SyncSystemNS.FunctionsFiles.filesUpload(tblCategoriesID, 
                                                                    ...
                                                                    "")*/
              // SyncSystemNS.FunctionsFiles.filesUploadMultiple(tblFilesID, this.openedFiles, gSystemConfig.configDirectoryFilesUpload, '', formfileFieldsReference).then(function (results) {
...
router.get('/' + gSystemConfig.configRouteBackend + '/' + gSystemConfig.configRouteBackendFiles + '/' + gSystemConfig.configRouteBackendActionEdit + '/:idTbFiles?', [SyncSystemNS.FunctionsAuthentication.authenticationVerification_middleware('user_backend')], (req, res, next) => {
  // working, with the async block
...
router.put('/' + gSystemConfig.configRouteBackend + '/' + gSystemConfig.configRouteBackendFiles + '/' + gSystemConfig.configRouteBackendActionEdit, [SyncSystemNS.FunctionsAuthentication.authenticationVerification_middleware('user_backend')], (req, res, next) => {
  // working, with the async block
  // Variables
  // ----------------------
  let tblFilesID = '';
