...
router.get('/' + gSystemConfig.configRouteBackend + '/' + gSystemConfig.configRouteBackendRegisters + '/:idParent?', [SyncSystemNS.FunctionsAuthentication.authenticationVerification_middleware('user_backend')], (req, res, next) => {
...
router.post('/' + gSystemConfig.configRouteBackend + '/' + gSystemConfig.configRouteBackendRegisters, [SyncSystemNS.FunctionsAuthentication.authenticationVerification_middleware('user_backend')], (req, res, next) => {
  ...
  let tblRegistersMetaInfo = ''; // eslint-disable-line

  let tblRegistersDateBirth = '',
    tblRegistersDateBirthHour = '',
    tblRegistersDateBirthMinute = '',
    tblRegistersDateBirthSeconds = '',
    tblRegistersDateBirthDay = '',
    tblRegistersDateBirthMonth = '',
    tblRegistersDateBirthYear = '';
  ...
  let tblRegistersDate1 = '',
    tblRegistersDate1Hour = '',
    tblRegistersDate1Minute = '',
    tblRegistersDate1Seconds = '',
    tblRegistersDate1Day = '',
    tblRegistersDate1Month = '',
    tblRegistersDate1Year = '';
  let tblRegistersDate2 = '',
    tblRegistersDate2Hour = '',
    tblRegistersDate2Minute = '',
    tblRegistersDate2Seconds = '',
    tblRegistersDate2Day = '',
    tblRegistersDate2Month = '',
    tblRegistersDate2Year = '';
  let tblRegistersDate3 = '',
    tblRegistersDate3Hour = '',
    tblRegistersDate3Minute = '',
    tblRegistersDate3Seconds = '',
    tblRegistersDate3Day = '',
    tblRegistersDate3Month = '',
    tblRegistersDate3Year = '';
  let tblRegistersDate4 = '',
    tblRegistersDate4Hour = '',
    tblRegistersDate4Minute = '',
    tblRegistersDate4Seconds = '',
    tblRegistersDate4Day = '',
    tblRegistersDate4Month = '',
    tblRegistersDate4Year = '';
  let tblRegistersDate5 = '',
    tblRegistersDate5Hour = '',
    tblRegistersDate5Minute = '',
    tblRegistersDate5Seconds = '',
    tblRegistersDate5Day = '',
    tblRegistersDate5Month = '',
    tblRegistersDate5Year = '';
  let tblRegistersDate6 = '',
    tblRegistersDate6Hour = '',
    tblRegistersDate6Minute = '',
    tblRegistersDate6Seconds = '',
    tblRegistersDate6Day = '',
    tblRegistersDate6Month = '',
    tblRegistersDate6Year = '';
  let tblRegistersDate7 = '',
    tblRegistersDate7Hour = '',
    tblRegistersDate7Minute = '',
    tblRegistersDate7Seconds = '',
    tblRegistersDate7Day = '',
    tblRegistersDate7Month = '',
    tblRegistersDate7Year = '';
  let tblRegistersDate8 = '',
    tblRegistersDate8Hour = '',
    tblRegistersDate8Minute = '',
    tblRegistersDate8Seconds = '',
    tblRegistersDate8Day = '',
    tblRegistersDate8Month = '',
    tblRegistersDate8Year = '';
  let tblRegistersDate9 = '',
    tblRegistersDate9Hour = '',
    tblRegistersDate9Minute = '',
    tblRegistersDate9Seconds = '',
    tblRegistersDate9Day = '',
    tblRegistersDate9Month = '',
    tblRegistersDate9Year = '';
  let tblRegistersDate10 = '',
    tblRegistersDate10Hour = '',
    tblRegistersDate10Minute = '',
    tblRegistersDate10Seconds = '',
    tblRegistersDate10Day = '',
    tblRegistersDate10Month = '',
    tblRegistersDate10Year = '';

  let tblRegistersImageMain = '';
  let tblRegistersImageMainCaption = '';
  let tblRegistersImageLogo = ''; // eslint-disable-line
  let tblRegistersImageBanner = ''; // eslint-disable-line
  ...
  (async () => {
    ...
    try {
      tblRegistersID = await new Promise((resolve, reject) => {
        SyncSystemNS.FunctionsDB.counterUniversalUpdate_async(1).then((results) => {
      ...
      let formParseResults = await new Promise((resolve, reject) => {
        ...
        if (gSystemConfig.configUploadComponent === 1) {
          ...
          form.on('end', async function (fields, files) {
            ...
            /*
                        // let resultsFunctionsFiles = await SyncSystemNS.FunctionsFiles.filesUpload(tblRegistersID, 
            ...
            resultsFunctionsFiles = await new Promise((resolve, reject) => {
              // SyncSystemNS.FunctionsFiles.filesUploadMultiple(tblRegistersID, this.openedFiles, gSystemConfig.configDirectoryFilesUpload, '', formfileFieldsReference).then(function (results) {
              // eslint-disable-next-line
              SyncSystemNS.FunctionsFiles.filesUploadMultiple(tblRegistersID, 
                this.openedFiles, 
                gSystemConfig.configDirectoryFilesUpload, 
                '', 
                formfileFieldsReference).then((results) => {
                if (results === undefined) {
                  // Error.
                  if (gSystemConfig.configDebug === true) {
...
router.get('/' + gSystemConfig.configRouteBackend + '/' + gSystemConfig.configRouteBackendRegisters + '/' + gSystemConfig.configRouteBackendActionEdit + '/:idTbRegisters?', [SyncSystemNS.FunctionsAuthentication.authenticationVerification_middleware('user_backend')], (req, res, next) => {
  // working, with the async block
  ...
  let messageError = '';
  let messageAlert = '';
  let nRecords = ''; // eslint-disable-line
  // ----------------------
  ...
  cookiesData = req.cookies; // eslint-disable-line
...
router.put('/' + gSystemConfig.configRouteBackend + '/' + gSystemConfig.configRouteBackendRegisters + '/' + gSystemConfig.configRouteBackendActionEdit, [SyncSystemNS.FunctionsAuthentication.authenticationVerification_middleware('user_backend')], (req, res, next) => {
  // working, with the async block
  // Variables
  // ----------------------
  let tblRegistersID = '';
          ...
          form.on('end', async function (fields, files) {
            ...
            resultsFunctionsFiles = await new Promise((resolve, reject) => {
              ...
              SyncSystemNS.FunctionsFiles.filesUploadMultiple(tblRegistersID, 
                ...
                gSystemConfig.configDirectoryFilesUpload, 
                '', 
                formfileFieldsReference).then(function (results) {
                if (results === undefined) {
                  // Error.
                  if (gSystemConfig.configDebug === true) {
                    console.log(SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'statusMessage17e'));
