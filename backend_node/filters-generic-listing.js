                                    ...
                                    <tr class="ss-backend-table-bg-light">
                                                ...
                                                ${
                                                  gSystemConfig.configImagePopup == 4
                                                    ...
                                                    <script>
                                                        ...
                                                        let glightboxFiltersGenericImageMain = GLightbox(gLightboxBackendConfigOptions);
                                                    </script>
                                                `
                                                    : ``
                                                }
                                        ...
                                        <td id="formFiltersGeneric_elementActivation${filtersGenericRow.id}" style="text-align: center;" class="${filtersGenericRow.activation == 1 ? '' : 'ss-backend-table-bg-deactive'}">
                                            <a id="linkFiltersGenericActivation${filtersGenericRow.id}" class="ss-backend-links01" 
                                                ...
                                                ${filtersGenericRow.activation == '1' ? SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation1A') : SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation0A')} 
                                            </a>
                                        </td>
                                        ${
                                          gSystemConfig.enableFiltersGenericActivation1 == 1
                                            ...
                                            <td id="formFiltersGeneric_elementActivation1${filtersGenericRow.id}" style="text-align: center;" class="${filtersGenericRow.activation1 == 1 ? '' : 'ss-backend-table-bg-deactive'}">
                                                <a id="linkFiltersGenericActivation1${filtersGenericRow.id}" class="ss-backend-links01"
                                                    ...
                                                    ${filtersGenericRow.activation1 == '1' ? SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation1A') : SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation0A')} 
                                                </a>
                                            </td>
                                            `
                                            : ``
                                          ...
                                          gSystemConfig.enableFiltersGenericActivation2 == 1
                                            ...
                                            <td id="formFiltersGeneric_elementActivation2${filtersGenericRow.id}" style="text-align: center;" class="${filtersGenericRow.activation2 == 1 ? '' : 'ss-backend-table-bg-deactive'}">
                                                <a id="linkFiltersGenericActivation2${filtersGenericRow.id}" class="ss-backend-links01"
                                                    ...
                                                    ${filtersGenericRow.activation2 == '1' ? SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation1A') : SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation0A')} 
                                                </a>
                                            </td>
                                            `
                                            : ``
                                          ...
                                          gSystemConfig.enableFiltersGenericActivation3 == 1
                                            ...
                                            <td id="formFiltersGeneric_elementActivation3${filtersGenericRow.id}" style="text-align: center;" class="${filtersGenericRow.activation3 == 1 ? '' : 'ss-backend-table-bg-deactive'}">
                                                <a id="linkFiltersGenericActivation3${filtersGenericRow.id}" class="ss-backend-links01"
                                                    ...
                                                    ${filtersGenericRow.activation3 == '1' ? SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation1A') : SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation0A')} 
                                                </a>
                                            </td>
                                            `
                                            : ``
                                          ...
                                          gSystemConfig.enableFiltersGenericActivation4 == 1
                                            ...
                                            <td id="formFiltersGeneric_elementActivation4${filtersGenericRow.id}" style="text-align: center;" class="${filtersGenericRow.activation4 == 1 ? '' : 'ss-backend-table-bg-deactive'}">
                                                <a id="linkFiltersGenericActivation4${filtersGenericRow.id}" class="ss-backend-links01"
                                                    ...
                                                    ${filtersGenericRow.activation4 == '1' ? SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation1A') : SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation0A')} 
                                                </a>
                                            </td>
                                            `
                                            : ``
                                          ...
                                          gSystemConfig.enableFiltersGenericActivation5 == 1
                                            ...
                                            <td id="formFiltersGeneric_elementActivation5${filtersGenericRow.id}" style="text-align: center;" class="${filtersGenericRow.activation5 == 1 ? '' : 'ss-backend-table-bg-deactive'}">
                                                <a id="linkFiltersGenericActivation5${filtersGenericRow.id}" class="ss-backend-links01"
                                                    ...
                                                    ${filtersGenericRow.activation5 == '1' ? SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation1A') : SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageBackend.appLabels, 'backendItemActivation0A')} 
                                                </a>
                                            </td>
                                            `
                                            : ``
                ...
                <div style="position: relative; display: block; overflow: hidden;">
                    <script>
                        ...
                        document.addEventListener('DOMContentLoaded', function() {
                            inputDataReorder([${gSystemConfig.configFiltersGenericInputOrder
                              .map((arrayRow) => {
                                return `"${arrayRow}"`;
                              })
