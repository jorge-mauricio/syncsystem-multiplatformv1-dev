...
module.exports = class ObjectFormsFieldsListing
{
    //Construct.
    //**************************************************************************************
    constructor(objParameters = {})
    {
        ...
        */
        ...
        this.configSortOrder = (objParameters.hasOwnProperty("_configSortOrder")) ? objParameters._configSortOrder : gSystemConfig.configFormsFieldsSort;
        ...
        this.resultsFormsFieldsListing = "";
        //----------------------
    ...
    async build()
    {
        ...
        return new ObjectFormsFieldsListing();
    }
    //**************************************************************************************

    
    //Get forms fields listing according to search parameters.
    //**************************************************************************************
    ...
    //function categoriesListingGet(idParent = null, terminal = 0, returnType = 1)
    {
        ...
        try
        {
            ...
            this.resultsFormsFieldsListing = await FunctionsDB.genericTableGet02(gSystemConfig.configSystemDBTableFormsFields, 
