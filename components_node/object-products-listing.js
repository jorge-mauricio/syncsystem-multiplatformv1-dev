...
module.exports = class ObjectProductsListing
{
    //Construct.
    //**************************************************************************************
    constructor(objParameters = {})
    {
        ...
        */
        ...
        this.configSortOrder = (objParameters.hasOwnProperty("_configSortOrder")) ? objParameters._configSortOrder : gSystemConfig.configProductsSort;
    ...
    async build()
    {
        ...
        return new ObjectProductsListing();
    }
    //**************************************************************************************
    

    //Get products listing according to search parameters.
    //**************************************************************************************
    ...
    async recordsListingGet(terminal = 0, returnType = 1)
    {
        ...
        try
        {
            ...
            this.resultsProductsListing = await FunctionsDB.genericTableGet02(gSystemConfig.configSystemDBTableProducts, 
