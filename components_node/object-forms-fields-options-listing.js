...
module.exports = class ObjectFormsFieldsOptionsListing
{
    //Construct.
    //**************************************************************************************
    constructor(objParameters = {})
    {
        ...
        */
        ...
        this.configSortOrder = (objParameters.hasOwnProperty("_configSortOrder")) ? objParameters._configSortOrder : gSystemConfig.configFormsFieldsOptionsSort;
        ...
        this.resultsFormsFieldsOptionsListing = "";
        //----------------------
    ...
    async build()
    {
        ...
        return new ObjectFormsFieldsOptionsListing();
    }
    //**************************************************************************************
    ...
    //function categoriesListingGet(idParent = null, terminal = 0, returnType = 1)
    {
        ...
        try
        {
            ...
            this.resultsFormsFieldsOptionsListing = await FunctionsDB.genericTableGet02(gSystemConfig.configSystemDBTableFormsFieldsOptions, 
