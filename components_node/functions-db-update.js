...
module.exports = class FunctionsDBUpdate {
  ...
  arrSearchParameters) {
    ...
    const strSQLRecordsGenericUpdateParams = [];
  ...
  static async categoryUpdate_async(_tblCategoriesDataObject) {
    ...
    const arrIdsCategoriesFiltersGeneric1 = [];
    const arrIdsCategoriesFiltersGeneric2 = [];
    const arrIdsCategoriesFiltersGeneric3 = [];
    const arrIdsCategoriesFiltersGeneric4 = [];
    const arrIdsCategoriesFiltersGeneric5 = [];
    const arrIdsCategoriesFiltersGeneric6 = [];
    const arrIdsCategoriesFiltersGeneric7 = [];
    const arrIdsCategoriesFiltersGeneric8 = [];
    const arrIdsCategoriesFiltersGeneric9 = [];
    const arrIdsCategoriesFiltersGeneric10 = [];

    let objIdsCategoriesFiltersGenericBinding;

    let strSQLCategoriesUpdate = '';
    const strSQLCategoriesUpdateParams = {};
    ...
    if (!tblCategoriesDateEdit) {
      const tblCategoriesDateEdit_dateObj = new Date(FunctionsGeneric.timeZoneConverter());
    ...
    if (resultsSQLCategoriesUpdate.affectedRows > 0) {
      ...
      try {
        ...
        if (gSystemConfig.enableCategoriesFilterGeneric2 != 0) {
          resultsCategoriesFiltersGeneric2Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
        ...
        if (gSystemConfig.enableCategoriesFilterGeneric3 != 0) {
          resultsCategoriesFiltersGeneric3Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 103;
          });
        }
        if (gSystemConfig.enableCategoriesFilterGeneric4 != 0) {
          resultsCategoriesFiltersGeneric4Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 104;
          });
        }
        if (gSystemConfig.enableCategoriesFilterGeneric5 != 0) {
          resultsCategoriesFiltersGeneric5Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 105;
          });
        }
        if (gSystemConfig.enableCategoriesFilterGeneric6 != 0) {
          resultsCategoriesFiltersGeneric6Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 106;
          });
        }
        if (gSystemConfig.enableCategoriesFilterGeneric7 != 0) {
          resultsCategoriesFiltersGeneric7Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 107;
          });
        }
        if (gSystemConfig.enableCategoriesFilterGeneric8 != 0) {
          resultsCategoriesFiltersGeneric8Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 108;
          });
        }
        if (gSystemConfig.enableCategoriesFilterGeneric9 != 0) {
          resultsCategoriesFiltersGeneric9Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 109;
          });
        }
        if (gSystemConfig.enableCategoriesFilterGeneric10 != 0) {
          resultsCategoriesFiltersGeneric10Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
        ...
        if (gSystemConfig.enableCategoriesFilterGeneric1 != 0) {
          if (arrIdsCategoriesFiltersGeneric1) {
            for (let countArray = 0; countArray < resultsCategoriesFiltersGeneric1Listing.length; countArray++) {
              ...
              if (categoriesFiltersGenericCheck.length) {
                // check if array is empty
                if (arrIdsCategoriesFiltersGeneric1.includes(categoriesFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
        ...
        if (gSystemConfig.enableCategoriesFilterGeneric2 != 0) {
          if (arrIdsCategoriesFiltersGeneric2) {
            for (let countArray = 0; countArray < resultsCategoriesFiltersGeneric2Listing.length; countArray++) {
              ...
              if (categoriesFiltersGenericCheck.length) {
                // check if array is empty
                if (arrIdsCategoriesFiltersGeneric2.includes(categoriesFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                  // check if selected filters has registered bindings
                  // Update record with additional information or leave as it is.
                  // TODO: update.
                  flagCategoriesFiltersGenericInsert = false;
        ...
        if (gSystemConfig.enableCategoriesFilterGeneric3 != 0) {
          if (arrIdsCategoriesFiltersGeneric3) {
            for (let countArray = 0; countArray < resultsCategoriesFiltersGeneric3Listing.length; countArray++) {
              ...
              if (categoriesFiltersGenericCheck.length) {
                // check if array is empty
                if (arrIdsCategoriesFiltersGeneric3.includes(categoriesFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                  // check if selected filters has registered bindings
                  // Update record with additional information or leave as it is.
                  // TODO: update.
                  flagCategoriesFiltersGenericInsert = false;
        ...
        if (gSystemConfig.enableCategoriesFilterGeneric4 != 0) {
          if (arrIdsCategoriesFiltersGeneric4) {
            for (let countArray = 0; countArray < resultsCategoriesFiltersGeneric4Listing.length; countArray++) {
              ...
              if (categoriesFiltersGenericCheck.length) {
                // check if array is empty
                if (arrIdsCategoriesFiltersGeneric4.includes(categoriesFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                  // check if selected filters has registered bindings
                  // Update record with additional information or leave as it is.
                  // TODO: update.
                  flagCategoriesFiltersGenericInsert = false;
        ...
        if (gSystemConfig.enableCategoriesFilterGeneric5 != 0) {
          if (arrIdsCategoriesFiltersGeneric5) {
            for (let countArray = 0; countArray < resultsCategoriesFiltersGeneric5Listing.length; countArray++) {
              ...
              if (categoriesFiltersGenericCheck.length) {
                // check if array is empty
                if (arrIdsCategoriesFiltersGeneric5.includes(categoriesFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                  // check if selected filters has registered bindings
                  // Update record with additional information or leave as it is.
                  // TODO: update.
                  flagCategoriesFiltersGenericInsert = false;
        ...
        if (gSystemConfig.enableCategoriesFilterGeneric6 != 0) {
          if (arrIdsCategoriesFiltersGeneric6) {
            for (let countArray = 0; countArray < resultsCategoriesFiltersGeneric6Listing.length; countArray++) {
              ...
              if (categoriesFiltersGenericCheck.length) {
                // check if array is empty
                if (arrIdsCategoriesFiltersGeneric6.includes(categoriesFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                  // check if selected filters has registered bindings
                  // Update record with additional information or leave as it is.
                  // TODO: update.
                  flagCategoriesFiltersGenericInsert = false;
        ...
        if (gSystemConfig.enableCategoriesFilterGeneric7 != 0) {
          if (arrIdsCategoriesFiltersGeneric7) {
            for (let countArray = 0; countArray < resultsCategoriesFiltersGeneric7Listing.length; countArray++) {
              ...
              if (categoriesFiltersGenericCheck.length) {
                // check if array is empty
                if (arrIdsCategoriesFiltersGeneric7.includes(categoriesFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                  // check if selected filters has registered bindings
                  // Update record with additional information or leave as it is.
                  // TODO: update.
                  flagCategoriesFiltersGenericInsert = false;
        ...
        if (gSystemConfig.enableCategoriesFilterGeneric8 != 0) {
          if (arrIdsCategoriesFiltersGeneric8) {
            for (let countArray = 0; countArray < resultsCategoriesFiltersGeneric8Listing.length; countArray++) {
              ...
              if (categoriesFiltersGenericCheck.length) {
                // check if array is empty
                if (arrIdsCategoriesFiltersGeneric8.includes(categoriesFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                  // check if selected filters has registered bindings
                  // Update record with additional information or leave as it is.
                  // TODO: update.
                  flagCategoriesFiltersGenericInsert = false;
        ...
        if (gSystemConfig.enableCategoriesFilterGeneric9 != 0) {
          if (arrIdsCategoriesFiltersGeneric9) {
            for (let countArray = 0; countArray < resultsCategoriesFiltersGeneric9Listing.length; countArray++) {
              ...
              if (categoriesFiltersGenericCheck.length) {
                // check if array is empty
                if (arrIdsCategoriesFiltersGeneric9.includes(categoriesFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                  // check if selected filters has registered bindings
                  // Update record with additional information or leave as it is.
                  // TODO: update.
                  flagCategoriesFiltersGenericInsert = false;
        ...
        if (gSystemConfig.enableCategoriesFilterGeneric10 != 0) {
          if (arrIdsCategoriesFiltersGeneric10) {
            for (let countArray = 0; countArray < resultsCategoriesFiltersGeneric10Listing.length; countArray++) {
              ...
              if (categoriesFiltersGenericCheck.length) {
                // check if array is empty
                if (arrIdsCategoriesFiltersGeneric10.includes(categoriesFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                  // check if selected filters has registered bindings
                  // Update record with additional information or leave as it is.
                  // TODO: update.
                  flagCategoriesFiltersGenericInsert = false;
  ...
  static async contentUpdate_async(_tblContentDataObject) {
    ...
    const strSQLContentUpdateParams = {};
    ...
    if (!tblContentDateEdit) {
      const tblContentDateEdit_dateObj = new Date(FunctionsGeneric.timeZoneConverter());
  ...
  static async productsUpdate_async(_tblProductsDataObject)
  {
    ...
    const arrIdsProductsFiltersGeneric1 = [];
    const arrIdsProductsFiltersGeneric2 = [];
    const arrIdsProductsFiltersGeneric3 = [];
    const arrIdsProductsFiltersGeneric4 = [];
    const arrIdsProductsFiltersGeneric5 = [];
    const arrIdsProductsFiltersGeneric6 = [];
    const arrIdsProductsFiltersGeneric7 = [];
    const arrIdsProductsFiltersGeneric8 = [];
    const arrIdsProductsFiltersGeneric9 = [];
    const arrIdsProductsFiltersGeneric10 = [];
    const arrIdsProductsFiltersGeneric11 = [];
    const arrIdsProductsFiltersGeneric12 = [];
    const arrIdsProductsFiltersGeneric13 = [];
    const arrIdsProductsFiltersGeneric14 = [];
    const arrIdsProductsFiltersGeneric15 = [];
    const arrIdsProductsFiltersGeneric16 = [];
    const arrIdsProductsFiltersGeneric17 = [];
    const arrIdsProductsFiltersGeneric18 = [];
    const arrIdsProductsFiltersGeneric19 = [];
    const arrIdsProductsFiltersGeneric20 = [];
    const arrIdsProductsFiltersGeneric21 = [];
    const arrIdsProductsFiltersGeneric22 = [];
    const arrIdsProductsFiltersGeneric23 = [];
    const arrIdsProductsFiltersGeneric24 = [];
    const arrIdsProductsFiltersGeneric25 = [];
    const arrIdsProductsFiltersGeneric26 = [];
    const arrIdsProductsFiltersGeneric27 = [];
    const arrIdsProductsFiltersGeneric28 = [];
    const arrIdsProductsFiltersGeneric29 = [];
    const arrIdsProductsFiltersGeneric30 = [];

    let objIdsProductsFiltersGenericBinding;

    let strSQLProductsUpdate = '';
    const strSQLProductsUpdateParams = {};
    ...
    if (!tblProductsDateEdit) {
      const tblProductsDateEdit_dateObj = new Date(FunctionsGeneric.timeZoneConverter());
    ...
    if (resultsSQLProductsUpdate.affectedRows > 0) {
      ...
      try {
        ...
        if (gSystemConfig.enableProductsFilterGeneric2 != 0) {
          resultsProductsFiltersGeneric2Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 102;
          });
        }
        if (gSystemConfig.enableProductsFilterGeneric2 != 0) {
        ...
        if (gSystemConfig.enableProductsFilterGeneric3 != 0) {
          resultsProductsFiltersGeneric3Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 103;
          });
        }
        if (gSystemConfig.enableProductsFilterGeneric4 != 0) {
          resultsProductsFiltersGeneric4Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 104;
          });
        }
        if (gSystemConfig.enableProductsFilterGeneric5 != 0) {
          resultsProductsFiltersGeneric5Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 105;
          });
        }
        if (gSystemConfig.enableProductsFilterGeneric6 != 0) {
          resultsProductsFiltersGeneric6Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 106;
          });
        }
        if (gSystemConfig.enableProductsFilterGeneric7 != 0) {
          resultsProductsFiltersGeneric7Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 107;
          });
        }
        if (gSystemConfig.enableProductsFilterGeneric8 != 0) {
          resultsProductsFiltersGeneric8Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 108;
          });
        }
        if (gSystemConfig.enableProductsFilterGeneric9 != 0) {
          resultsProductsFiltersGeneric9Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 109;
          });
        }
        if (gSystemConfig.enableProductsFilterGeneric10 != 0) {
          resultsProductsFiltersGeneric10Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 110;
          });
        }
        if (gSystemConfig.enableProductsFilterGeneric11 != 0) {
          resultsProductsFiltersGeneric11Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 111;
          });
        }
        if (gSystemConfig.enableProductsFilterGeneric12 != 0) {
          resultsProductsFiltersGeneric12Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 112;
          });
        }
        if (gSystemConfig.enableProductsFilterGeneric13 != 0) {
          resultsProductsFiltersGeneric13Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 113;
          });
        }
        if (gSystemConfig.enableProductsFilterGeneric14 != 0) {
          resultsProductsFiltersGeneric14Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 114;
          });
        }
        if (gSystemConfig.enableProductsFilterGeneric15 != 0) {
          resultsProductsFiltersGeneric15Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 115;
          });
        }
        if (gSystemConfig.enableProductsFilterGeneric16 != 0) {
          resultsProductsFiltersGeneric16Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 116;
          });
        }
        if (gSystemConfig.enableProductsFilterGeneric17 != 0) {
          resultsProductsFiltersGeneric17Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 117;
          });
        }
        if (gSystemConfig.enableProductsFilterGeneric18 != 0) {
          resultsProductsFiltersGeneric18Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 118;
          });
        }
        if (gSystemConfig.enableProductsFilterGeneric19 != 0) {
          resultsProductsFiltersGeneric19Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 119;
          });
        }
        if (gSystemConfig.enableProductsFilterGeneric20 != 0) {
          resultsProductsFiltersGeneric20Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 120;
          });
        }
        if (gSystemConfig.enableProductsFilterGeneric21 != 0) {
          resultsProductsFiltersGeneric21Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 121;
          });
        }
        if (gSystemConfig.enableProductsFilterGeneric22 != 0) {
          resultsProductsFiltersGeneric22Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 122;
          });
        }
        if (gSystemConfig.enableProductsFilterGeneric23 != 0) {
          resultsProductsFiltersGeneric23Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 123;
          });
        }
        if (gSystemConfig.enableProductsFilterGeneric24 != 0) {
          resultsProductsFiltersGeneric24Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 124;
          });
        }
        if (gSystemConfig.enableProductsFilterGeneric25 != 0) {
          resultsProductsFiltersGeneric25Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 125;
          });
        }
        if (gSystemConfig.enableProductsFilterGeneric26 != 0) {
          resultsProductsFiltersGeneric26Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 126;
          });
        }
        if (gSystemConfig.enableProductsFilterGeneric27 != 0) {
          resultsProductsFiltersGeneric27Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 127;
          });
        }
        if (gSystemConfig.enableProductsFilterGeneric28 != 0) {
          resultsProductsFiltersGeneric28Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 128;
          });
        }
        if (gSystemConfig.enableProductsFilterGeneric29 != 0) {
          resultsProductsFiltersGeneric29Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 129;
          });
        }
        if (gSystemConfig.enableProductsFilterGeneric30 != 0) {
          resultsProductsFiltersGeneric30Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
      ...
      if (gSystemConfig.enableProductsFilterGeneric1 != 0) {
        if (arrIdsProductsFiltersGeneric1) {
          for (let countArray = 0; countArray < resultsProductsFiltersGeneric1Listing.length; countArray++) {
            ...
            productsFiltersGenericCheck = objIdsProductsFiltersGenericBinding.filter((obj) => {
            ...
            // Update or delete existing bindings.
            if (productsFiltersGenericCheck.length) {
              // check if array is empty
              // if(objIdsProductsFiltersGeneric1Binding.length) // check if array is empty
              if (arrIdsProductsFiltersGeneric1.includes(productsFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
      ...
      if (gSystemConfig.enableProductsFilterGeneric2 != 0) {
        if (arrIdsProductsFiltersGeneric2) {
          for (let countArray = 0; countArray < resultsProductsFiltersGeneric2Listing.length; countArray++) {
            ...
            if (productsFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsProductsFiltersGeneric2.includes(productsFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagProductsFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableProductsFilterGeneric3 != 0) {
        if (arrIdsProductsFiltersGeneric3) {
          for (let countArray = 0; countArray < resultsProductsFiltersGeneric3Listing.length; countArray++) {
            ...
            if (productsFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsProductsFiltersGeneric3.includes(productsFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagProductsFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableProductsFilterGeneric4 != 0) {
        if (arrIdsProductsFiltersGeneric4) {
          for (let countArray = 0; countArray < resultsProductsFiltersGeneric4Listing.length; countArray++) {
            ...
            if (productsFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsProductsFiltersGeneric4.includes(productsFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagProductsFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableProductsFilterGeneric5 != 0) {
        if (arrIdsProductsFiltersGeneric5) {
          for (let countArray = 0; countArray < resultsProductsFiltersGeneric5Listing.length; countArray++) {
            ...
            if (productsFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsProductsFiltersGeneric5.includes(productsFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagProductsFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableProductsFilterGeneric6 != 0) {
        if (arrIdsProductsFiltersGeneric6) {
          for (let countArray = 0; countArray < resultsProductsFiltersGeneric6Listing.length; countArray++) {
            ...
            if (productsFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsProductsFiltersGeneric6.includes(productsFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagProductsFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableProductsFilterGeneric7 != 0) {
        if (arrIdsProductsFiltersGeneric7) {
          for (let countArray = 0; countArray < resultsProductsFiltersGeneric7Listing.length; countArray++) {
            ...
            if (productsFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsProductsFiltersGeneric7.includes(productsFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagProductsFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableProductsFilterGeneric8 != 0) {
        if (arrIdsProductsFiltersGeneric8) {
          for (let countArray = 0; countArray < resultsProductsFiltersGeneric8Listing.length; countArray++) {
            ...
            if (productsFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsProductsFiltersGeneric8.includes(productsFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagProductsFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableProductsFilterGeneric9 != 0) {
        if (arrIdsProductsFiltersGeneric9) {
          for (let countArray = 0; countArray < resultsProductsFiltersGeneric9Listing.length; countArray++) {
            ...
            if (productsFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsProductsFiltersGeneric9.includes(productsFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagProductsFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableProductsFilterGeneric10 != 0) {
        if (arrIdsProductsFiltersGeneric10) {
          for (let countArray = 0; countArray < resultsProductsFiltersGeneric10Listing.length; countArray++) {
            ...
            if (productsFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsProductsFiltersGeneric10.includes(productsFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagProductsFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableProductsFilterGeneric11 != 0) {
        if (arrIdsProductsFiltersGeneric11) {
          for (let countArray = 0; countArray < resultsProductsFiltersGeneric11Listing.length; countArray++) {
            ...
            if (productsFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsProductsFiltersGeneric11.includes(productsFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagProductsFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableProductsFilterGeneric12 != 0) {
        if (arrIdsProductsFiltersGeneric12) {
          for (let countArray = 0; countArray < resultsProductsFiltersGeneric12Listing.length; countArray++) {
            ...
            if (productsFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsProductsFiltersGeneric12.includes(productsFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagProductsFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableProductsFilterGeneric13 != 0) {
        if (arrIdsProductsFiltersGeneric13) {
          for (let countArray = 0; countArray < resultsProductsFiltersGeneric13Listing.length; countArray++) {
            ...
            if (productsFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsProductsFiltersGeneric13.includes(productsFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagProductsFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableProductsFilterGeneric14 != 0) {
        if (arrIdsProductsFiltersGeneric14) {
          for (let countArray = 0; countArray < resultsProductsFiltersGeneric14Listing.length; countArray++) {
            ...
            if (productsFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsProductsFiltersGeneric14.includes(productsFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagProductsFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableProductsFilterGeneric15 != 0) {
        if (arrIdsProductsFiltersGeneric15) {
          for (let countArray = 0; countArray < resultsProductsFiltersGeneric15Listing.length; countArray++) {
            ...
            if (productsFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsProductsFiltersGeneric15.includes(productsFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagProductsFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableProductsFilterGeneric16 != 0) {
        if (arrIdsProductsFiltersGeneric16) {
          for (let countArray = 0; countArray < resultsProductsFiltersGeneric16Listing.length; countArray++) {
            ...
            if (productsFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsProductsFiltersGeneric16.includes(productsFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagProductsFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableProductsFilterGeneric17 != 0) {
        if (arrIdsProductsFiltersGeneric17) {
          for (let countArray = 0; countArray < resultsProductsFiltersGeneric17Listing.length; countArray++) {
            ...
            if (productsFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsProductsFiltersGeneric17.includes(productsFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagProductsFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableProductsFilterGeneric18 != 0) {
        if (arrIdsProductsFiltersGeneric18) {
          for (let countArray = 0; countArray < resultsProductsFiltersGeneric18Listing.length; countArray++) {
            ...
            if (productsFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsProductsFiltersGeneric18.includes(productsFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagProductsFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableProductsFilterGeneric19 != 0) {
        if (arrIdsProductsFiltersGeneric19) {
          for (let countArray = 0; countArray < resultsProductsFiltersGeneric19Listing.length; countArray++) {
            ...
            if (productsFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsProductsFiltersGeneric19.includes(productsFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagProductsFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableProductsFilterGeneric20 != 0) {
        if (arrIdsProductsFiltersGeneric20) {
          for (let countArray = 0; countArray < resultsProductsFiltersGeneric20Listing.length; countArray++) {
            ...
            if (productsFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsProductsFiltersGeneric20.includes(productsFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagProductsFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableProductsFilterGeneric21 != 0) {
        if (arrIdsProductsFiltersGeneric21) {
          for (let countArray = 0; countArray < resultsProductsFiltersGeneric21Listing.length; countArray++) {
            ...
            if (productsFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsProductsFiltersGeneric21.includes(productsFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagProductsFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableProductsFilterGeneric22 != 0) {
        if (arrIdsProductsFiltersGeneric22) {
          for (let countArray = 0; countArray < resultsProductsFiltersGeneric22Listing.length; countArray++) {
            ...
            if (productsFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsProductsFiltersGeneric22.includes(productsFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagProductsFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableProductsFilterGeneric23 != 0) {
        if (arrIdsProductsFiltersGeneric23) {
          for (let countArray = 0; countArray < resultsProductsFiltersGeneric23Listing.length; countArray++) {
            ...
            if (productsFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsProductsFiltersGeneric23.includes(productsFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagProductsFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableProductsFilterGeneric24 != 0) {
        if (arrIdsProductsFiltersGeneric24) {
          for (let countArray = 0; countArray < resultsProductsFiltersGeneric24Listing.length; countArray++) {
            ...
            if (productsFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsProductsFiltersGeneric24.includes(productsFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagProductsFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableProductsFilterGeneric25 != 0) {
        if (arrIdsProductsFiltersGeneric25) {
          for (let countArray = 0; countArray < resultsProductsFiltersGeneric25Listing.length; countArray++) {
            ...
            if (productsFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsProductsFiltersGeneric25.includes(productsFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagProductsFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableProductsFilterGeneric26 != 0) {
        if (arrIdsProductsFiltersGeneric26) {
          for (let countArray = 0; countArray < resultsProductsFiltersGeneric26Listing.length; countArray++) {
            ...
            if (productsFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsProductsFiltersGeneric26.includes(productsFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagProductsFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableProductsFilterGeneric27 != 0) {
        if (arrIdsProductsFiltersGeneric27) {
          for (let countArray = 0; countArray < resultsProductsFiltersGeneric27Listing.length; countArray++) {
            ...
            if (productsFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsProductsFiltersGeneric27.includes(productsFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagProductsFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableProductsFilterGeneric28 != 0) {
        if (arrIdsProductsFiltersGeneric28) {
          for (let countArray = 0; countArray < resultsProductsFiltersGeneric28Listing.length; countArray++) {
            ...
            if (productsFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsProductsFiltersGeneric28.includes(productsFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagProductsFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableProductsFilterGeneric29 != 0) {
        if (arrIdsProductsFiltersGeneric29) {
          for (let countArray = 0; countArray < resultsProductsFiltersGeneric29Listing.length; countArray++) {
            ...
            if (productsFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsProductsFiltersGeneric29.includes(productsFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagProductsFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableProductsFilterGeneric30 != 0) {
        if (arrIdsProductsFiltersGeneric30) {
          for (let countArray = 0; countArray < resultsProductsFiltersGeneric30Listing.length; countArray++) {
            ...
            if (productsFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsProductsFiltersGeneric30.includes(productsFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagProductsFiltersGenericInsert = false;
  ...
  static async publicationsUpdate_async(_tblPublicationsDataObject) {
    ...
    const arrIdsPublicationsFiltersGeneric1 = [];
    const arrIdsPublicationsFiltersGeneric2 = [];
    const arrIdsPublicationsFiltersGeneric3 = [];
    const arrIdsPublicationsFiltersGeneric4 = [];
    const arrIdsPublicationsFiltersGeneric5 = [];
    const arrIdsPublicationsFiltersGeneric6 = [];
    const arrIdsPublicationsFiltersGeneric7 = [];
    const arrIdsPublicationsFiltersGeneric8 = [];
    const arrIdsPublicationsFiltersGeneric9 = [];
    const arrIdsPublicationsFiltersGeneric10 = [];

    let objIdsPublicationsFiltersGenericBinding;

    let strSQLPublicationsUpdate = '';
    const strSQLPublicationsUpdateParams = {};
    ...
    if (resultsSQLPublicationsUpdate.affectedRows > 0) {
      ...
      try {
        ...
        if (gSystemConfig.enablePublicationsFilterGeneric2 != 0) {
          resultsPublicationsFiltersGeneric2Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 102;
          });
        }
        if (gSystemConfig.enablePublicationsFilterGeneric2 != 0) {
        ...
        if (gSystemConfig.enablePublicationsFilterGeneric3 != 0) {
          resultsPublicationsFiltersGeneric3Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 103;
          });
        }
        if (gSystemConfig.enablePublicationsFilterGeneric4 != 0) {
          resultsPublicationsFiltersGeneric4Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 104;
          });
        }
        if (gSystemConfig.enablePublicationsFilterGeneric5 != 0) {
          resultsPublicationsFiltersGeneric5Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 105;
          });
        }
        if (gSystemConfig.enablePublicationsFilterGeneric6 != 0) {
          resultsPublicationsFiltersGeneric6Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 106;
          });
        }
        if (gSystemConfig.enablePublicationsFilterGeneric7 != 0) {
          resultsPublicationsFiltersGeneric7Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 107;
          });
        }
        if (gSystemConfig.enablePublicationsFilterGeneric8 != 0) {
          resultsPublicationsFiltersGeneric8Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 108;
          });
        }
        if (gSystemConfig.enablePublicationsFilterGeneric9 != 0) {
          resultsPublicationsFiltersGeneric9Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 109;
          });
        }
        if (gSystemConfig.enablePublicationsFilterGeneric10 != 0) {
          resultsPublicationsFiltersGeneric10Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 110;
          });
        }
      ...
      if (gSystemConfig.enablePublicationsFilterGeneric1 != 0) {
        if (arrIdsPublicationsFiltersGeneric1) {
          for (let countArray = 0; countArray < resultsPublicationsFiltersGeneric1Listing.length; countArray++) {
            ...
            // Check records already selected.
            publicationsFiltersGenericCheck = objIdsPublicationsFiltersGenericBinding.filter((obj) => {
              return obj.id_filters_generic == resultsPublicationsFiltersGeneric1Listing[countArray].id.toString() && obj.id_filter_index == 101;
            });

            // Update or delete existing bindings.
            if (publicationsFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsPublicationsFiltersGeneric1.includes(publicationsFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
      ...
      if (gSystemConfig.enablePublicationsFilterGeneric2 != 0) {
        if (arrIdsPublicationsFiltersGeneric2) {
          for (let countArray = 0; countArray < resultsPublicationsFiltersGeneric2Listing.length; countArray++) {
            ...
            if (publicationsFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsPublicationsFiltersGeneric2.includes(publicationsFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagPublicationsFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enablePublicationsFilterGeneric3 != 0) {
        if (arrIdsPublicationsFiltersGeneric3) {
          for (let countArray = 0; countArray < resultsPublicationsFiltersGeneric3Listing.length; countArray++) {
            ...
            if (publicationsFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsPublicationsFiltersGeneric3.includes(publicationsFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagPublicationsFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enablePublicationsFilterGeneric4 != 0) {
        if (arrIdsPublicationsFiltersGeneric4) {
          for (let countArray = 0; countArray < resultsPublicationsFiltersGeneric4Listing.length; countArray++) {
            ...
            if (publicationsFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsPublicationsFiltersGeneric4.includes(publicationsFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagPublicationsFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enablePublicationsFilterGeneric5 != 0) {
        if (arrIdsPublicationsFiltersGeneric5) {
          for (let countArray = 0; countArray < resultsPublicationsFiltersGeneric5Listing.length; countArray++) {
            ...
            if (publicationsFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsPublicationsFiltersGeneric5.includes(publicationsFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagPublicationsFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enablePublicationsFilterGeneric6 != 0) {
        if (arrIdsPublicationsFiltersGeneric6) {
          for (let countArray = 0; countArray < resultsPublicationsFiltersGeneric6Listing.length; countArray++) {
            ...
            if (publicationsFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsPublicationsFiltersGeneric6.includes(publicationsFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagPublicationsFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enablePublicationsFilterGeneric7 != 0) {
        if (arrIdsPublicationsFiltersGeneric7) {
          for (let countArray = 0; countArray < resultsPublicationsFiltersGeneric7Listing.length; countArray++) {
            ...
            if (publicationsFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsPublicationsFiltersGeneric7.includes(publicationsFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagPublicationsFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enablePublicationsFilterGeneric8 != 0) {
        if (arrIdsPublicationsFiltersGeneric8) {
          for (let countArray = 0; countArray < resultsPublicationsFiltersGeneric8Listing.length; countArray++) {
            ...
            if (publicationsFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsPublicationsFiltersGeneric8.includes(publicationsFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagPublicationsFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enablePublicationsFilterGeneric9 != 0) {
        if (arrIdsPublicationsFiltersGeneric9) {
          for (let countArray = 0; countArray < resultsPublicationsFiltersGeneric9Listing.length; countArray++) {
            ...
            if (publicationsFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsPublicationsFiltersGeneric9.includes(publicationsFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagPublicationsFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enablePublicationsFilterGeneric10 != 0) {
        if (arrIdsPublicationsFiltersGeneric10) {
          for (let countArray = 0; countArray < resultsPublicationsFiltersGeneric10Listing.length; countArray++) {
            ...
            if (publicationsFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsPublicationsFiltersGeneric10.includes(publicationsFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagPublicationsFiltersGenericInsert = false;
  ...
  static async registersUpdate_async(_tblRegistersDataObject) {
    ...
    const arrIdsRegistersFiltersGeneric1 = [];
    const arrIdsRegistersFiltersGeneric2 = [];
    const arrIdsRegistersFiltersGeneric3 = [];
    const arrIdsRegistersFiltersGeneric4 = [];
    const arrIdsRegistersFiltersGeneric5 = [];
    const arrIdsRegistersFiltersGeneric6 = [];
    const arrIdsRegistersFiltersGeneric7 = [];
    const arrIdsRegistersFiltersGeneric8 = [];
    const arrIdsRegistersFiltersGeneric9 = [];
    const arrIdsRegistersFiltersGeneric10 = [];
    const arrIdsRegistersFiltersGeneric11 = [];
    const arrIdsRegistersFiltersGeneric12 = [];
    const arrIdsRegistersFiltersGeneric13 = [];
    const arrIdsRegistersFiltersGeneric14 = [];
    const arrIdsRegistersFiltersGeneric15 = [];
    const arrIdsRegistersFiltersGeneric16 = [];
    const arrIdsRegistersFiltersGeneric17 = [];
    const arrIdsRegistersFiltersGeneric18 = [];
    const arrIdsRegistersFiltersGeneric19 = [];
    const arrIdsRegistersFiltersGeneric20 = [];
    const arrIdsRegistersFiltersGeneric21 = [];
    const arrIdsRegistersFiltersGeneric22 = [];
    const arrIdsRegistersFiltersGeneric23 = [];
    const arrIdsRegistersFiltersGeneric24 = [];
    const arrIdsRegistersFiltersGeneric25 = [];
    const arrIdsRegistersFiltersGeneric26 = [];
    const arrIdsRegistersFiltersGeneric27 = [];
    const arrIdsRegistersFiltersGeneric28 = [];
    const arrIdsRegistersFiltersGeneric29 = [];
    const arrIdsRegistersFiltersGeneric30 = [];
    const arrIdsRegistersFiltersGeneric31 = [];
    const arrIdsRegistersFiltersGeneric32 = [];
    const arrIdsRegistersFiltersGeneric33 = [];
    const arrIdsRegistersFiltersGeneric34 = [];
    const arrIdsRegistersFiltersGeneric35 = [];
    const arrIdsRegistersFiltersGeneric36 = [];
    const arrIdsRegistersFiltersGeneric37 = [];
    const arrIdsRegistersFiltersGeneric38 = [];
    const arrIdsRegistersFiltersGeneric39 = [];
    const arrIdsRegistersFiltersGeneric40 = [];

    let objIdsRegistersFiltersGenericBinding;

    let strSQLRegistersUpdate = '';
    const strSQLRegistersUpdateParams = {};
    ...
    if (resultsSQLRegistersUpdate.affectedRows > 0) {
      ...
      try {
        ...
        if (gSystemConfig.enableRegistersFilterGeneric2 != 0) {
          resultsRegistersFiltersGeneric2Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 102;
          });
        }
        if (gSystemConfig.enableRegistersFilterGeneric2 != 0) {
        ...
        if (gSystemConfig.enableRegistersFilterGeneric3 != 0) {
          resultsRegistersFiltersGeneric3Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 103;
          });
        }
        if (gSystemConfig.enableRegistersFilterGeneric4 != 0) {
          resultsRegistersFiltersGeneric4Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 104;
          });
        }
        if (gSystemConfig.enableRegistersFilterGeneric5 != 0) {
          resultsRegistersFiltersGeneric5Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 105;
          });
        }
        if (gSystemConfig.enableRegistersFilterGeneric6 != 0) {
          resultsRegistersFiltersGeneric6Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 106;
          });
        }
        if (gSystemConfig.enableRegistersFilterGeneric7 != 0) {
          resultsRegistersFiltersGeneric7Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 107;
          });
        }
        if (gSystemConfig.enableRegistersFilterGeneric8 != 0) {
          resultsRegistersFiltersGeneric8Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 108;
          });
        }
        if (gSystemConfig.enableRegistersFilterGeneric9 != 0) {
          resultsRegistersFiltersGeneric9Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 109;
          });
        }
        if (gSystemConfig.enableRegistersFilterGeneric10 != 0) {
          resultsRegistersFiltersGeneric10Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 110;
          });
        }
        if (gSystemConfig.enableRegistersFilterGeneric11 != 0) {
          resultsRegistersFiltersGeneric11Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 111;
          });
        }
        if (gSystemConfig.enableRegistersFilterGeneric12 != 0) {
          resultsRegistersFiltersGeneric12Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 112;
          });
        }
        if (gSystemConfig.enableRegistersFilterGeneric13 != 0) {
          resultsRegistersFiltersGeneric13Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 113;
          });
        }
        if (gSystemConfig.enableRegistersFilterGeneric14 != 0) {
          resultsRegistersFiltersGeneric14Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 114;
          });
        }
        if (gSystemConfig.enableRegistersFilterGeneric15 != 0) {
          resultsRegistersFiltersGeneric15Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 115;
          });
        }
        if (gSystemConfig.enableRegistersFilterGeneric16 != 0) {
          resultsRegistersFiltersGeneric16Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 116;
          });
        }
        if (gSystemConfig.enableRegistersFilterGeneric17 != 0) {
          resultsRegistersFiltersGeneric17Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 117;
          });
        }
        if (gSystemConfig.enableRegistersFilterGeneric18 != 0) {
          resultsRegistersFiltersGeneric18Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 118;
          });
        }
        if (gSystemConfig.enableRegistersFilterGeneric19 != 0) {
          resultsRegistersFiltersGeneric19Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 119;
          });
        }
        if (gSystemConfig.enableRegistersFilterGeneric20 != 0) {
          resultsRegistersFiltersGeneric20Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 120;
          });
        }
        if (gSystemConfig.enableRegistersFilterGeneric21 != 0) {
          resultsRegistersFiltersGeneric21Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 121;
          });
        }
        if (gSystemConfig.enableRegistersFilterGeneric22 != 0) {
          resultsRegistersFiltersGeneric22Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 122;
          });
        }
        if (gSystemConfig.enableRegistersFilterGeneric23 != 0) {
          resultsRegistersFiltersGeneric23Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 123;
          });
        }
        if (gSystemConfig.enableRegistersFilterGeneric24 != 0) {
          resultsRegistersFiltersGeneric24Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 124;
          });
        }
        if (gSystemConfig.enableRegistersFilterGeneric25 != 0) {
          resultsRegistersFiltersGeneric25Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 125;
          });
        }
        if (gSystemConfig.enableRegistersFilterGeneric26 != 0) {
          resultsRegistersFiltersGeneric26Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 126;
          });
        }
        if (gSystemConfig.enableRegistersFilterGeneric27 != 0) {
          resultsRegistersFiltersGeneric27Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 127;
          });
        }
        if (gSystemConfig.enableRegistersFilterGeneric28 != 0) {
          resultsRegistersFiltersGeneric28Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 128;
          });
        }
        if (gSystemConfig.enableRegistersFilterGeneric29 != 0) {
          resultsRegistersFiltersGeneric29Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 129;
          });
        }
        if (gSystemConfig.enableRegistersFilterGeneric30 != 0) {
          resultsRegistersFiltersGeneric30Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 130;
          });
        }
        if (gSystemConfig.enableRegistersFilterGeneric31 != 0) {
          resultsRegistersFiltersGeneric31Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 131;
          });
        }
        if (gSystemConfig.enableRegistersFilterGeneric32 != 0) {
          resultsRegistersFiltersGeneric32Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 132;
          });
        }
        if (gSystemConfig.enableRegistersFilterGeneric33 != 0) {
          resultsRegistersFiltersGeneric33Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 133;
          });
        }
        if (gSystemConfig.enableRegistersFilterGeneric34 != 0) {
          resultsRegistersFiltersGeneric34Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 134;
          });
        }
        if (gSystemConfig.enableRegistersFilterGeneric35 != 0) {
          resultsRegistersFiltersGeneric35Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 135;
          });
        }
        if (gSystemConfig.enableRegistersFilterGeneric36 != 0) {
          resultsRegistersFiltersGeneric36Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 136;
          });
        }
        if (gSystemConfig.enableRegistersFilterGeneric37 != 0) {
          resultsRegistersFiltersGeneric37Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 137;
          });
        }
        if (gSystemConfig.enableRegistersFilterGeneric38 != 0) {
          resultsRegistersFiltersGeneric38Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 138;
          });
        }
        if (gSystemConfig.enableRegistersFilterGeneric39 != 0) {
          resultsRegistersFiltersGeneric39Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
            return obj.filter_index == 139;
          });
        }
        if (gSystemConfig.enableRegistersFilterGeneric40 != 0) {
          resultsRegistersFiltersGeneric40Listing = ofglRecords.resultsFiltersGenericListing.filter((obj) => {
      ...
      if (gSystemConfig.enableRegistersFilterGeneric1 != 0) {
        if (arrIdsRegistersFiltersGeneric1) {
          for (let countArray = 0; countArray < resultsRegistersFiltersGeneric1Listing.length; countArray++) {
            ...
            registersFiltersGenericCheck = objIdsRegistersFiltersGenericBinding.filter((obj) => {
            ...
            // Update or delete existing bindings.
            if (registersFiltersGenericCheck.length) {
              // check if array is empty
              // if(objIdsRegistersFiltersGeneric1Binding.length) // check if array is empty
              if (arrIdsRegistersFiltersGeneric1.includes(registersFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
      ...
      if (gSystemConfig.enableRegistersFilterGeneric2 != 0) {
        if (arrIdsRegistersFiltersGeneric2) {
          for (let countArray = 0; countArray < resultsRegistersFiltersGeneric2Listing.length; countArray++) {
            ...
            if (registersFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsRegistersFiltersGeneric2.includes(registersFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagRegistersFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableRegistersFilterGeneric3 != 0) {
        if (arrIdsRegistersFiltersGeneric3) {
          for (let countArray = 0; countArray < resultsRegistersFiltersGeneric3Listing.length; countArray++) {
            ...
            if (registersFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsRegistersFiltersGeneric3.includes(registersFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagRegistersFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableRegistersFilterGeneric4 != 0) {
        if (arrIdsRegistersFiltersGeneric4) {
          for (let countArray = 0; countArray < resultsRegistersFiltersGeneric4Listing.length; countArray++) {
            ...
            if (registersFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsRegistersFiltersGeneric4.includes(registersFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagRegistersFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableRegistersFilterGeneric5 != 0) {
        if (arrIdsRegistersFiltersGeneric5) {
          for (let countArray = 0; countArray < resultsRegistersFiltersGeneric5Listing.length; countArray++) {
            ...
            if (registersFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsRegistersFiltersGeneric5.includes(registersFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagRegistersFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableRegistersFilterGeneric6 != 0) {
        if (arrIdsRegistersFiltersGeneric6) {
          for (let countArray = 0; countArray < resultsRegistersFiltersGeneric6Listing.length; countArray++) {
            ...
            if (registersFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsRegistersFiltersGeneric6.includes(registersFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagRegistersFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableRegistersFilterGeneric7 != 0) {
        if (arrIdsRegistersFiltersGeneric7) {
          for (let countArray = 0; countArray < resultsRegistersFiltersGeneric7Listing.length; countArray++) {
            ...
            if (registersFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsRegistersFiltersGeneric7.includes(registersFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagRegistersFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableRegistersFilterGeneric8 != 0) {
        if (arrIdsRegistersFiltersGeneric8) {
          for (let countArray = 0; countArray < resultsRegistersFiltersGeneric8Listing.length; countArray++) {
            ...
            if (registersFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsRegistersFiltersGeneric8.includes(registersFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagRegistersFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableRegistersFilterGeneric9 != 0) {
        if (arrIdsRegistersFiltersGeneric9) {
          for (let countArray = 0; countArray < resultsRegistersFiltersGeneric9Listing.length; countArray++) {
            ...
            if (registersFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsRegistersFiltersGeneric9.includes(registersFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagRegistersFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableRegistersFilterGeneric10 != 0) {
        if (arrIdsRegistersFiltersGeneric10) {
          for (let countArray = 0; countArray < resultsRegistersFiltersGeneric10Listing.length; countArray++) {
            ...
            if (registersFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsRegistersFiltersGeneric10.includes(registersFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagRegistersFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableRegistersFilterGeneric11 != 0) {
        if (arrIdsRegistersFiltersGeneric11) {
          for (let countArray = 0; countArray < resultsRegistersFiltersGeneric11Listing.length; countArray++) {
            ...
            if (registersFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsRegistersFiltersGeneric11.includes(registersFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagRegistersFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableRegistersFilterGeneric12 != 0) {
        if (arrIdsRegistersFiltersGeneric12) {
          for (let countArray = 0; countArray < resultsRegistersFiltersGeneric12Listing.length; countArray++) {
            ...
            if (registersFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsRegistersFiltersGeneric12.includes(registersFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagRegistersFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableRegistersFilterGeneric13 != 0) {
        if (arrIdsRegistersFiltersGeneric13) {
          for (let countArray = 0; countArray < resultsRegistersFiltersGeneric13Listing.length; countArray++) {
            ...
            if (registersFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsRegistersFiltersGeneric13.includes(registersFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagRegistersFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableRegistersFilterGeneric14 != 0) {
        if (arrIdsRegistersFiltersGeneric14) {
          for (let countArray = 0; countArray < resultsRegistersFiltersGeneric14Listing.length; countArray++) {
            ...
            if (registersFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsRegistersFiltersGeneric14.includes(registersFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagRegistersFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableRegistersFilterGeneric15 != 0) {
        if (arrIdsRegistersFiltersGeneric15) {
          for (let countArray = 0; countArray < resultsRegistersFiltersGeneric15Listing.length; countArray++) {
            ...
            if (registersFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsRegistersFiltersGeneric15.includes(registersFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagRegistersFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableRegistersFilterGeneric16 != 0) {
        if (arrIdsRegistersFiltersGeneric16) {
          for (let countArray = 0; countArray < resultsRegistersFiltersGeneric16Listing.length; countArray++) {
            ...
            if (registersFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsRegistersFiltersGeneric16.includes(registersFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagRegistersFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableRegistersFilterGeneric17 != 0) {
        if (arrIdsRegistersFiltersGeneric17) {
          for (let countArray = 0; countArray < resultsRegistersFiltersGeneric17Listing.length; countArray++) {
            ...
            if (registersFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsRegistersFiltersGeneric17.includes(registersFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagRegistersFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableRegistersFilterGeneric18 != 0) {
        if (arrIdsRegistersFiltersGeneric18) {
          for (let countArray = 0; countArray < resultsRegistersFiltersGeneric18Listing.length; countArray++) {
            ...
            if (registersFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsRegistersFiltersGeneric18.includes(registersFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagRegistersFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableRegistersFilterGeneric19 != 0) {
        if (arrIdsRegistersFiltersGeneric19) {
          for (let countArray = 0; countArray < resultsRegistersFiltersGeneric19Listing.length; countArray++) {
            ...
            if (registersFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsRegistersFiltersGeneric19.includes(registersFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagRegistersFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableRegistersFilterGeneric20 != 0) {
        if (arrIdsRegistersFiltersGeneric20) {
          for (let countArray = 0; countArray < resultsRegistersFiltersGeneric20Listing.length; countArray++) {
            ...
            if (registersFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsRegistersFiltersGeneric20.includes(registersFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagRegistersFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableRegistersFilterGeneric21 != 0) {
        if (arrIdsRegistersFiltersGeneric21) {
          for (let countArray = 0; countArray < resultsRegistersFiltersGeneric21Listing.length; countArray++) {
            ...
            if (registersFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsRegistersFiltersGeneric21.includes(registersFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagRegistersFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableRegistersFilterGeneric22 != 0) {
        if (arrIdsRegistersFiltersGeneric22) {
          for (let countArray = 0; countArray < resultsRegistersFiltersGeneric22Listing.length; countArray++) {
            ...
            if (registersFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsRegistersFiltersGeneric22.includes(registersFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagRegistersFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableRegistersFilterGeneric23 != 0) {
        if (arrIdsRegistersFiltersGeneric23) {
          for (let countArray = 0; countArray < resultsRegistersFiltersGeneric23Listing.length; countArray++) {
            ...
            if (registersFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsRegistersFiltersGeneric23.includes(registersFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagRegistersFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableRegistersFilterGeneric24 != 0) {
        if (arrIdsRegistersFiltersGeneric24) {
          for (let countArray = 0; countArray < resultsRegistersFiltersGeneric24Listing.length; countArray++) {
            ...
            if (registersFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsRegistersFiltersGeneric24.includes(registersFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagRegistersFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableRegistersFilterGeneric25 != 0) {
        if (arrIdsRegistersFiltersGeneric25) {
          for (let countArray = 0; countArray < resultsRegistersFiltersGeneric25Listing.length; countArray++) {
            ...
            if (registersFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsRegistersFiltersGeneric25.includes(registersFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagRegistersFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableRegistersFilterGeneric26 != 0) {
        if (arrIdsRegistersFiltersGeneric26) {
          for (let countArray = 0; countArray < resultsRegistersFiltersGeneric26Listing.length; countArray++) {
            ...
            if (registersFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsRegistersFiltersGeneric26.includes(registersFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagRegistersFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableRegistersFilterGeneric27 != 0) {
        if (arrIdsRegistersFiltersGeneric27) {
          for (let countArray = 0; countArray < resultsRegistersFiltersGeneric27Listing.length; countArray++) {
            ...
            if (registersFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsRegistersFiltersGeneric27.includes(registersFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagRegistersFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableRegistersFilterGeneric28 != 0) {
        if (arrIdsRegistersFiltersGeneric28) {
          for (let countArray = 0; countArray < resultsRegistersFiltersGeneric28Listing.length; countArray++) {
            ...
            if (registersFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsRegistersFiltersGeneric28.includes(registersFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagRegistersFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableRegistersFilterGeneric29 != 0) {
        if (arrIdsRegistersFiltersGeneric29) {
          for (let countArray = 0; countArray < resultsRegistersFiltersGeneric29Listing.length; countArray++) {
            ...
            if (registersFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsRegistersFiltersGeneric29.includes(registersFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagRegistersFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableRegistersFilterGeneric30 != 0) {
        if (arrIdsRegistersFiltersGeneric30) {
          for (let countArray = 0; countArray < resultsRegistersFiltersGeneric30Listing.length; countArray++) {
            ...
            if (registersFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsRegistersFiltersGeneric30.includes(registersFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagRegistersFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableRegistersFilterGeneric31 != 0) {
        if (arrIdsRegistersFiltersGeneric31) {
          for (let countArray = 0; countArray < resultsRegistersFiltersGeneric31Listing.length; countArray++) {
            ...
            if (registersFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsRegistersFiltersGeneric31.includes(registersFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagRegistersFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableRegistersFilterGeneric32 != 0) {
        if (arrIdsRegistersFiltersGeneric32) {
          for (let countArray = 0; countArray < resultsRegistersFiltersGeneric32Listing.length; countArray++) {
            ...
            if (registersFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsRegistersFiltersGeneric32.includes(registersFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagRegistersFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableRegistersFilterGeneric33 != 0) {
        if (arrIdsRegistersFiltersGeneric33) {
          for (let countArray = 0; countArray < resultsRegistersFiltersGeneric33Listing.length; countArray++) {
            ...
            if (registersFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsRegistersFiltersGeneric33.includes(registersFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagRegistersFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableRegistersFilterGeneric34 != 0) {
        if (arrIdsRegistersFiltersGeneric34) {
          for (let countArray = 0; countArray < resultsRegistersFiltersGeneric34Listing.length; countArray++) {
            ...
            if (registersFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsRegistersFiltersGeneric34.includes(registersFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagRegistersFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableRegistersFilterGeneric35 != 0) {
        if (arrIdsRegistersFiltersGeneric35) {
          for (let countArray = 0; countArray < resultsRegistersFiltersGeneric35Listing.length; countArray++) {
            ...
            if (registersFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsRegistersFiltersGeneric35.includes(registersFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagRegistersFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableRegistersFilterGeneric36 != 0) {
        if (arrIdsRegistersFiltersGeneric36) {
          for (let countArray = 0; countArray < resultsRegistersFiltersGeneric36Listing.length; countArray++) {
            ...
            if (registersFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsRegistersFiltersGeneric36.includes(registersFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagRegistersFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableRegistersFilterGeneric37 != 0) {
        if (arrIdsRegistersFiltersGeneric37) {
          for (let countArray = 0; countArray < resultsRegistersFiltersGeneric37Listing.length; countArray++) {
            ...
            if (registersFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsRegistersFiltersGeneric37.includes(registersFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagRegistersFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableRegistersFilterGeneric38 != 0) {
        if (arrIdsRegistersFiltersGeneric38) {
          for (let countArray = 0; countArray < resultsRegistersFiltersGeneric38Listing.length; countArray++) {
            ...
            if (registersFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsRegistersFiltersGeneric38.includes(registersFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagRegistersFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableRegistersFilterGeneric39 != 0) {
        if (arrIdsRegistersFiltersGeneric39) {
          for (let countArray = 0; countArray < resultsRegistersFiltersGeneric39Listing.length; countArray++) {
            ...
            if (registersFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsRegistersFiltersGeneric39.includes(registersFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagRegistersFiltersGenericInsert = false;
      ...
      if (gSystemConfig.enableRegistersFilterGeneric40 != 0) {
        if (arrIdsRegistersFiltersGeneric40) {
          for (let countArray = 0; countArray < resultsRegistersFiltersGeneric40Listing.length; countArray++) {
            ...
            if (registersFiltersGenericCheck.length) {
              // check if array is empty
              if (arrIdsRegistersFiltersGeneric40.includes(registersFiltersGenericCheck[0].id_filters_generic.toString()) == true) {
                // check if selected filters has registered bindings
                // Update record with additional information or leave as it is.
                // TODO: update.
                flagRegistersFiltersGenericInsert = false;
  ...
  static async quizzesUpdate_async(_tblQuizzesDataObject) {
    ...
    const strSQLQuizzesUpdateParams = {};
  ...
  static async quizzesOptionsUpdate_async(_tblQuizzesOptionsDataObject) {
    ...
    const strSQLQuizzesOptionsUpdateParams = {};
  ...
  static async formsUpdate_async(_tblFormsDataObject) {
    ...
    */
    ...
    if (!tblFormsDateEdit) {
      const tblFormsDateEdit_dateObj = new Date(FunctionsGeneric.timeZoneConverter());
  ...
  static async formsFieldsUpdate_async(_tblFormsFieldsDataObject) {
    ...
    const strSQLFormsFieldsUpdateParams = {};
  ...
  static async formsFieldsOptionsUpdate_async(_tblFormsFieldsOptionsDataObject) {
    ...
    const strSQLFormsFieldsOptionsUpdateParams = {};
  ...
  static async filtersGenericUpdate_async(_tblFiltersGenericDataObject) {
    ...
    const strSQLFiltersGenericUpdateParams = {};
    ...
    if (!tblFiltersGenericDateEdit) {
      const tblFiltersGenericDateEdit_dateObj = new Date(FunctionsGeneric.timeZoneConverter());
