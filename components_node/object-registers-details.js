  ...
  async recordDetailsGet(terminal = 0, returnType = 1) {
    ...
    try {
      ...
      if (this.tblRegistersDate2) {
        ...
        this.tblRegistersDate2_print = FunctionsGeneric.dateRead01(this.tblRegistersDate2, gSystemConfig.configBackendDateFormat, 0, gSystemConfig.configRegistersDate2Type);
      }
      ...
      if (this.tblRegistersDate3) {
        ...
        this.tblRegistersDate3_print = FunctionsGeneric.dateRead01(this.tblRegistersDate3, gSystemConfig.configBackendDateFormat, 0, gSystemConfig.configRegistersDate3Type);
      }
      ...
      if (this.tblRegistersDate4) {
        ...
        this.tblRegistersDate4_print = FunctionsGeneric.dateRead01(this.tblRegistersDate4, gSystemConfig.configBackendDateFormat, 0, gSystemConfig.configRegistersDate4Type);
      }
      ...
      if (this.tblRegistersDate5) {
        ...
        this.tblRegistersDate5_print = FunctionsGeneric.dateRead01(this.tblRegistersDate5, gSystemConfig.configBackendDateFormat, 0, gSystemConfig.configRegistersDate5Type);
      }
      ...
      if (this.tblRegistersDate6) {
        ...
        this.tblRegistersDate6_print = FunctionsGeneric.dateRead01(this.tblRegistersDate6, gSystemConfig.configBackendDateFormat, 0, gSystemConfig.configRegistersDate6Type);
      }
      ...
      if (this.tblRegistersDate7) {
        ...
        this.tblRegistersDate7_print = FunctionsGeneric.dateRead01(this.tblRegistersDate7, gSystemConfig.configBackendDateFormat, 0, gSystemConfig.configRegistersDate7Type);
      }
      ...
      if (this.tblRegistersDate8) {
        ...
        this.tblRegistersDate8_print = FunctionsGeneric.dateRead01(this.tblRegistersDate8, gSystemConfig.configBackendDateFormat, 0, gSystemConfig.configRegistersDate8Type);
      }
      ...
      if (this.tblRegistersDate9) {
        ...
        this.tblRegistersDate9_print = FunctionsGeneric.dateRead01(this.tblRegistersDate9, gSystemConfig.configBackendDateFormat, 0, gSystemConfig.configRegistersDate9Type);
      }
      ...
      if (this.tblRegistersDate10) {
        ...
        this.tblRegistersDate10_print = FunctionsGeneric.dateRead01(this.tblRegistersDate10, gSystemConfig.configBackendDateFormat, 0, gSystemConfig.configRegistersDate10Type);
      }
