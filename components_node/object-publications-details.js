...
module.exports = class ObjectPublicationsDetails {
  ...
  async recordDetailsGet(terminal = 0, returnType = 1) {
    ...
    try {
      this.resultsPublicationsDetails = await FunctionsDB.genericTableGet02(
        gSystemConfig.configSystemDBTablePublications, 
      ...
      this.objIdsPublicationsFiltersGenericBinding = await FunctionsDB.genericTableGet02(
      ...
      if (this.tblPublicationsDateStart) {
        ...
        this.tblPublicationsDateStart_print = FunctionsGeneric.dateRead01(this.tblPublicationsDateStart, gSystemConfig.configBackendDateFormat, 0, gSystemConfig.configPublicationsDateStartType);
      }
      ...
      if (this.tblPublicationsDateEnd) {
        ...
        this.tblPublicationsDateEnd_print = FunctionsGeneric.dateRead01(this.tblPublicationsDateEnd, gSystemConfig.configBackendDateFormat, 0, gSystemConfig.configPublicationsDateEndType);
      }
      ...
      if (this.tblPublicationsDate1) {
        ...
        this.tblPublicationsDate1_print = FunctionsGeneric.dateRead01(this.tblPublicationsDate1, gSystemConfig.configBackendDateFormat, 0, gSystemConfig.configPublicationsDate1Type);
      }
      ...
      if (this.tblPublicationsDate2) {
        ...
        this.tblPublicationsDate2_print = FunctionsGeneric.dateRead01(this.tblPublicationsDate2, gSystemConfig.configBackendDateFormat, 0, gSystemConfig.configPublicationsDate2Type);
      }
      ...
      if (this.tblPublicationsDate3) {
        ...
        this.tblPublicationsDate3_print = FunctionsGeneric.dateRead01(this.tblPublicationsDate3, gSystemConfig.configBackendDateFormat, 0, gSystemConfig.configPublicationsDate3Type);
      }
      ...
      if (this.tblPublicationsDate4) {
        ...
        this.tblPublicationsDate4_print = FunctionsGeneric.dateRead01(this.tblPublicationsDate4, gSystemConfig.configBackendDateFormat, 0, gSystemConfig.configPublicationsDate4Type);
      }
      ...
      if (this.tblPublicationsDate5) {
        ...
        this.tblPublicationsDate5_print = FunctionsGeneric.dateRead01(this.tblPublicationsDate5, gSystemConfig.configBackendDateFormat, 0, gSystemConfig.configPublicationsDate5Type);
      }
