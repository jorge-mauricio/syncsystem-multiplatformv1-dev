...
module.exports = class ObjectFilesDetails {
  ...
  async recordDetailsGet(terminal = 0, returnType = 1) {
    ...
    /**/
    try {
      this.resultsFileDetails = await FunctionsDB.genericTableGet02(
        gSystemConfig.configSystemDBTableFiles, 
      ...
      if (this.tblFilesDate2) {
        ...
        this.tblFilesDate2_print = FunctionsGeneric.dateRead01(this.tblFilesDate2, gSystemConfig.configBackendDateFormat, 0, gSystemConfig.configFilesDate1Type);
      }
      ...
      if (this.tblFilesDate3) {
        ...
        this.tblFilesDate3_print = FunctionsGeneric.dateRead01(this.tblFilesDate3, gSystemConfig.configBackendDateFormat, 0, gSystemConfig.configFilesDate1Type);
      }
      ...
      if (this.tblFilesDate4) {
        ...
        this.tblFilesDate4_print = FunctionsGeneric.dateRead01(this.tblFilesDate4, gSystemConfig.configBackendDateFormat, 0, gSystemConfig.configFilesDate1Type);
      }
      ...
      if (this.tblFilesDate5) {
        ...
        this.tblFilesDate5_print = FunctionsGeneric.dateRead01(this.tblFilesDate5, gSystemConfig.configBackendDateFormat, 0, gSystemConfig.configFilesDate1Type);
      }
