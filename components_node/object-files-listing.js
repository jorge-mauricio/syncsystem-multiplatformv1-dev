...
module.exports = class ObjectFilesListing
{
    //Construct.
    //**************************************************************************************
    ...
    //function categoriesListingGet(idParent = null, terminal = 0, returnType = 1)
    {
        ...
        try
        {
            ...
            this.resultsFilesListing = await FunctionsDB.genericTableGet02(gSystemConfig.configSystemDBTableFiles, 
