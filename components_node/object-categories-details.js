  ...
  // function categoriesListingGet(idParent = null, terminal = 0, returnType = 1)
  {
    ...
    try {
      ...
      if (this.tblCategoriesDate2) {
        ...
        this.tblCategoriesDate2_print = FunctionsGeneric.dateRead01(this.tblCategoriesDate2, gSystemConfig.configBackendDateFormat, 0, gSystemConfig.configCategoriesDate2Type);
      }
      ...
      if (this.tblCategoriesDate3) {
        ...
        this.tblCategoriesDate3_print = FunctionsGeneric.dateRead01(this.tblCategoriesDate3, gSystemConfig.configBackendDateFormat, 0, gSystemConfig.configCategoriesDate3Type);
      }
      ...
      if (this.tblCategoriesDate4) {
        ...
        this.tblCategoriesDate4_print = FunctionsGeneric.dateRead01(this.tblCategoriesDate4, gSystemConfig.configBackendDateFormat, 0, gSystemConfig.configCategoriesDate4Type);
      }
      ...
      if (this.tblCategoriesDate5) {
        ...
        this.tblCategoriesDate5_print = FunctionsGeneric.dateRead01(this.tblCategoriesDate5, gSystemConfig.configBackendDateFormat, 0, gSystemConfig.configCategoriesDate5Type);
      }
