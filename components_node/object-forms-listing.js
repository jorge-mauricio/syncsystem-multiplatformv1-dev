...
module.exports = class ObjectFormsListing
{
    //Construct.
    //**************************************************************************************
    constructor(objParameters = {})
    {
        ...
        */
        ...
        this.configSortOrder = (objParameters.hasOwnProperty("_configSortOrder")) ? objParameters._configSortOrder : gSystemConfig.configFormsSort;
    ...
    async build()
    {
        ...
        return new ObjectFormsListing();
    }
    //**************************************************************************************


    //Get forms listing according to search parameters.
    //**************************************************************************************
    ...
    //function categoriesListingGet(idParent = null, terminal = 0, returnType = 1)
    {
        ...
        try
        {
            ...
            this.resultsFormsListing = await FunctionsDB.genericTableGet02(gSystemConfig.configSystemDBTableForms, 
