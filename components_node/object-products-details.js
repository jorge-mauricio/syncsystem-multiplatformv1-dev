  ...
  async recordDetailsGet(terminal = 0, returnType = 1) {
    ...
    try {
      this.resultsProductsDetails = await FunctionsDB.genericTableGet02(
        gSystemConfig.configSystemDBTableProducts, 
      ...
      if (this.tblProductsDate2) {
        ...
        this.tblProductsDate2_print = FunctionsGeneric.dateRead01(this.tblProductsDate2, gSystemConfig.configBackendDateFormat, 0, gSystemConfig.configProductsDate2Type);
      }
      ...
      if (this.tblProductsDate3) {
        ...
        this.tblProductsDate3_print = FunctionsGeneric.dateRead01(this.tblProductsDate3, gSystemConfig.configBackendDateFormat, 0, gSystemConfig.configProductsDate3Type);
      }
      ...
      if (this.tblProductsDate4) {
        ...
        this.tblProductsDate4_print = FunctionsGeneric.dateRead01(this.tblProductsDate4, gSystemConfig.configBackendDateFormat, 0, gSystemConfig.configProductsDate4Type);
      }
      ...
      if (this.tblProductsDate5) {
        ...
        this.tblProductsDate5_print = FunctionsGeneric.dateRead01(this.tblProductsDate5, gSystemConfig.configBackendDateFormat, 0, gSystemConfig.configProductsDate5Type);
      }
