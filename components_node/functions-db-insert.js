...
// const { dbSystemCon } = require('../config-application-db.js'); // DB System - simple connection.
...
module.exports = class FunctionsDBInsert {
   ...
   */
  static counterInsert(_tblCounterID, _tblCounterCounterGlobal, _tblCounterDescription) {
    // Variables.
    // ----------------------
    let strReturn = false;
    ...
    const strSQLCounterInsertParams = {};
    ...
    return new Promise((resolve, reject) => {
      ...
      dbSystemConPool.getConnection((dbSystemPoolError, dbSystemConPoolGetConnection) => {
        if (dbSystemPoolError) {
          ...
          dbSystemConPoolGetConnection.query(strSQLCounterInsert, strSQLCounterInsertParams, (dbSystemError, resultsSQLCounterInsert) => {
  ...
  static async categoriesInsert_async(_tblCategoriesDataObject) {
    ...
    const strSQLCategoriesInsertParams = {};
    ...
    if (tblCategoriesID === '' || tblCategoriesID === null || tblCategoriesID === undefined) {
      tblCategoriesID = await new Promise((resolve, reject) => {
        FunctionsDB.counterUniversalUpdate_async(1).then((results) => {
    ...
    */
    ...
    if (!tblCategoriesDateCreation) {
      const tblCategoriesDateCreation_dateObj = new Date(FunctionsGeneric.timeZoneConverter());
  ...
  static async filesInsert_async(_tblFilesDataObject) {
    ...
    if (!tblFilesDateCreation) {
      const tblFilesDateCreation_dateObj = new Date(FunctionsGeneric.timeZoneConverter());
  ...
  static async contentInsert_async(_tblContentDataObject) {
    ...
    const strSQLContentInsertParams = {};
    ...
    if (!tblContentDateCreation) {
      const tblContentDateCreation_dateObj = new Date(FunctionsGeneric.timeZoneConverter());
  ...
  static async productsInsert_async(_tblProductsDataObject) {
    ...
    const strSQLProductsInsertParams = {};
    ...
    if (!tblProductsDateCreation) {
      const tblProductsDateCreation_dateObj = new Date(FunctionsGeneric.timeZoneConverter());
  ...
  static async publicationsInsert_async(_tblPublicationsDataObject) {
    ...
    const strSQLPublicationsInsertParams = {};
    ...
    if (!tblPublicationsDateCreation) {
      const tblPublicationsDateCreation_dateObj = new Date(FunctionsGeneric.timeZoneConverter());
  ...
  static async registersInsert_async(_tblRegistersDataObject) {
    ...
    const strSQLRegistersInsertParams = {};
    ...
    if (!tblRegistersDateCreation) {
      const tblRegistersDateCreation_dateObj = new Date(FunctionsGeneric.timeZoneConverter());
  ...
  static async quizzesInsert_async(_tblQuizzesDataObject) {
    ...
    const strSQLQuizzesInsertParams = {};
    ...
    if (!tblQuizzesDateCreation) {
      const tblQuizzesDateCreation_dateObj = new Date(FunctionsGeneric.timeZoneConverter());
  ...
  static async quizzesOptionsInsert_async(_tblQuizzesOptionsDataObject) {
    ...
    const strSQLQuizzesOptionsInsertParams = {};
    ...
    if (!tblQuizzesOptionsDateCreation) {
      const tblQuizzesOptionsDateCreation_dateObj = new Date(FunctionsGeneric.timeZoneConverter());
  ...
  static async quizzesLogInsert_async(_tblQuizzesLogDataObject) {
    ...
    const strSQLQuizzesLogInsertParams = {};
    ...
    if (!tblQuizzesLogDateCreation) {
      const tblQuizzesLogDateCreation_dateObj = new Date(FunctionsGeneric.timeZoneConverter());
  ...
  static async formsInsert_async(_tblFormsDataObject) {
    ...
    if (!tblFormsDateCreation) {
      const tblFormsDateCreation_dateObj = new Date(FunctionsGeneric.timeZoneConverter());
  ...
  static async formsFieldsInsert_async(_tblFormsFieldsDataObject) {
    ...
    const strSQLFormsFieldsInsertParams = {};
    ...
    if (!tblFormsFieldsDateCreation) {
      const tblFormsFieldsDateCreation_dateObj = new Date(FunctionsGeneric.timeZoneConverter());
  ...
  static async formsFieldsOptionsInsert_async(_tblFormsFieldsOptionsDataObject) {
    ...
    const strSQLFormsFieldsOptionsInsertParams = {};
    ...
    if (!tblFormsFieldsOptionsDateCreation) {
      const tblFormsFieldsOptionsDateCreation_dateObj = new Date(FunctionsGeneric.timeZoneConverter());
  ...
  static async filtersGenericInsert_async(_tblFiltersGenericDataObject) {
    ...
    const strSQLFiltersGenericInsertParams = {};
    ...
    if (!tblFiltersGenericDateCreation) {
      const tblFiltersGenericDateCreation_dateObj = new Date(FunctionsGeneric.timeZoneConverter());
  ...
  static async filtersGenericBindingInsert_async(_tblFiltersGenericBindingDataObject, returnMethod = 1) {
    ...
    // ----------------------
    let strReturn = false;
    let objReturn = {}; // eslint-disable-line
    ...
    const strSQLFiltersGenericBindingInsertParams = {};
    ...
    if (!tblFiltersGenericBindingDateCreation) {
      const tblFiltersGenericBindingDateCreation_dateObj = new Date(FunctionsGeneric.timeZoneConverter());
    ...
    if (!tblFiltersGenericBindingDateEdit) {
      const tblFiltersGenericBindingDateEdit_dateObj = new Date(FunctionsGeneric.timeZoneConverter());
  ...
  static async usersInsert_async(_tblUsersDataObject) {
    ...
    if (!tblUsersDateCreation) {
      const tblUsersDateCreation_dateObj = new Date(FunctionsGeneric.timeZoneConverter());
