    ...
    return (
      <React.Fragment>
        <section className="ss-frontend-layout-section-content01">
          {/* Categories records. */}
          <FrontendCategoriesDetailsRecord objCategoriesDetails={this.state.objCategoriesDetails} configLayoutType={2}></FrontendCategoriesDetailsRecord>

          {/* Files - images - records. */}
          {gSystemConfig.enableCategoriesImages === 1 ? <FrontendFilesImages idParentFiles={this._idTbCategories} configLayoutType={1} configFilesNRecords={''} configFilesSort={''} configFilesZoom={0}></FrontendFilesImages> : ``}

          {/* Files - records. */}
          {gSystemConfig.enableCategoriesFiles === 1 ? <FrontendFiles idParentFiles={this._idTbCategories} configLayoutType={1} configFilesNRecords={''} configFilesSort={''}></FrontendFiles> : ``}
