...
class FrontendProducts extends Component {
  ...
  async build() {
    ...
    let apiURLProductsListing = '';
    let apiProductsListingResponse;
    // ----------------------
  ...
  render() {
    ...
    return (
      <React.Fragment>
        {/* Products records. */}
        <FrontendProductsListingRecord arrProductsListing={this.state.arrProductsListing} configLayoutType={configLayoutType}></FrontendProductsListingRecord>
      </React.Fragment>
    );
    // ----------------------
  }
