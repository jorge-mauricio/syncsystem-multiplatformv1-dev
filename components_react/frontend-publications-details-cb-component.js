...
class FrontendPublicationsDetails extends Component {
  ...
  async build() {
    ...
    let apiURLPublicationsDetails = '';
    let apiPublicationsDetailsResponse;
    // ----------------------
    ...
    return (
      <React.Fragment>
        <section className="ss-frontend-layout-section-content01">
          ...
          <FrontendPublicationsDetailsRecord objPublicationsDetails={this.state.objPublicationsDetails} configLayoutType={2}></FrontendPublicationsDetailsRecord>

          {/* Files - images - records.*/}
          {gSystemConfig.enablePublicationsImages == 1 ? <FrontendFilesImages idParentFiles={this._idTbPublications} configLayoutType={1} configFilesNRecords={''} configFilesSort={''} configFilesZoom={0}></FrontendFilesImages> : ``}

          {/* Files - records.*/}
          {gSystemConfig.enablePublicationsFiles == 1 ? <FrontendFiles idParentFiles={this._idTbPublications} configLayoutType={1} configFilesNRecords={''} configFilesSort={''}></FrontendFiles> : ``}
