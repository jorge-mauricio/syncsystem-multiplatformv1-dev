        ...
        <Switch>
          ...
          <Route
            ...
            render={(props) => (
              <React.Fragment>
                ...
                {this._masterPageFrontendSelect === 'layout-frontend-iframe' ? <LayoutFrontendIframe cphBody={<FrontendHome {...props} />} {...props}></LayoutFrontendIframe> : <LayoutFrontendMain cphBody={<FrontendHome {...props} />} {...props}></LayoutFrontendMain>}
              </React.Fragment>
            )}
          />
          {/* // ---------------------- */}
          ...
          <Route
            ...
            render={(props) => (
              <React.Fragment>
                {/* Layout select. */}
                {this._masterPageFrontendSelect === 'layout-frontend-iframe' ? <LayoutFrontendIframe cphBody={<FrontendLogin {...props} />} {...props}></LayoutFrontendIframe> : <LayoutFrontendMain cphBody={<FrontendLogin {...props} />} {...props}></LayoutFrontendMain>}
              </React.Fragment>
            )}
          />
          {/* // ---------------------- */}
          ...
          <Route
            ...
            render={(props) => (
              <React.Fragment>
                {/* Layout select. */}
                {this._masterPageFrontendSelect === 'layout-frontend-iframe' ? <LayoutFrontendIframe cphBody={<FrontendLogoff {...props} />} {...props}></LayoutFrontendIframe> : <LayoutFrontendMain cphBody={<FrontendLogoff {...props} />} {...props}></LayoutFrontendMain>}
              </React.Fragment>
            )}
          />
          {/* // ---------------------- */}
            ...
            render={(props) => (
              <React.Fragment>
                ...
                {this._masterPageFrontendSelect === 'layout-frontend-iframe' ? (
                  <LayoutFrontendIframe cphBody={<FrontendCategoriesListing {...props} />} {...props}>
                    {/* setTitleCurrent={this.setTitleCurrent} */
                    /* passing function as prop - not in use */}
                  </LayoutFrontendIframe>
                ) : (
                  <LayoutFrontendMain cphBody={<FrontendCategoriesListing {...props} />} {...props}>
                    {/* setTitleCurrent={this.setTitleCurrent} */
                    /* passing function as prop - not in use */}
                  </LayoutFrontendMain>
                )}
          ...
          <Route
            ...
            render={(props) => (
              <React.Fragment>
                {/* Layout select. */}
                {this._masterPageFrontendSelect === 'layout-frontend-iframe' ? <LayoutFrontendIframe cphBody={<FrontendCategoriesDetails {...props} />} {...props}></LayoutFrontendIframe> : <LayoutFrontendMain cphBody={<FrontendCategoriesDetails {...props} />} {...props}></LayoutFrontendMain>}
              </React.Fragment>
            )}
          />
          {/* // ---------------------- */}
          ...
          <Route
            ...
            render={(props) => (
              <React.Fragment>
                ...
                {/* new URLSearchParams(props.location.search).get("masterPageSelect") == "layout-frontend-iframe" ?*/}
                {this._masterPageFrontendSelect === 'layout-frontend-iframe' ? (
                  <LayoutFrontendIframe cphBody={<FrontendContentListing {...props} />} {...props}>
                    {/* setTitleCurrent={this.setTitleCurrent} */
                    /* passing function as prop - not in use */}
                  </LayoutFrontendIframe>
                ) : (
                  <LayoutFrontendMain cphBody={<FrontendContentListing {...props} />} {...props}>
                    {/* setTitleCurrent={this.setTitleCurrent} */
                    /* passing function as prop - not in use */}
                  </LayoutFrontendMain>
                )}
          ...
          <Route
            ...
            render={(props) => (
              <React.Fragment>
                {/* Layout select. */}
                {this._masterPageFrontendSelect === 'layout-frontend-iframe' ? <LayoutFrontendIframe cphBody={<FrontendFormsSend {...props} />} {...props}></LayoutFrontendIframe> : <LayoutFrontendMain cphBody={<FrontendFormsSend {...props} />} {...props}></LayoutFrontendMain>}
              </React.Fragment>
            )}
          />
          {/* // ---------------------- */}
          ...
          <Route
            ...
            render={(props) => (
              <React.Fragment>
                ...
                {/* new URLSearchParams(props.location.search).get("masterPageSelect") == "layout-frontend-iframe" ?*/}
                {this._masterPageFrontendSelect === 'layout-frontend-iframe' ? (
                  <LayoutFrontendIframe cphBody={<FrontendProductsListing {...props} />} {...props}>
                    {/* setTitleCurrent={this.setTitleCurrent} */
                    /* passing function as prop - not in use */}
                  </LayoutFrontendIframe>
                ) : (
                  <LayoutFrontendMain cphBody={<FrontendProductsListing {...props} />} {...props}>
                    {/* setTitleCurrent={this.setTitleCurrent} */
                    /* passing function as prop - not in use */}
                  </LayoutFrontendMain>
                )}
          ...
          <Route
            ...
            render={(props) => (
              <React.Fragment>
                {/* Layout select. */}
                {this._masterPageFrontendSelect === 'layout-frontend-iframe' ? <LayoutFrontendIframe cphBody={<FrontendProductsDetails {...props} />} {...props}></LayoutFrontendIframe> : <LayoutFrontendMain cphBody={<FrontendProductsDetails {...props} />} {...props}></LayoutFrontendMain>}
              </React.Fragment>
            )}
          />
          {/* // ---------------------- */}
          ...
          <Route
            ...
            render={(props) => (
              <React.Fragment>
                ...
                {/* new URLSearchParams(props.location.search).get("masterPageSelect") == "layout-frontend-iframe" ?*/}
                {this._masterPageFrontendSelect === 'layout-frontend-iframe' ? (
                  <LayoutFrontendIframe cphBody={<FrontendPublicationsListing {...props} />} {...props}>
                    {/* setTitleCurrent={this.setTitleCurrent} */
                    /* passing function as prop - not in use */}
                  </LayoutFrontendIframe>
                ) : (
                  <LayoutFrontendMain cphBody={<FrontendPublicationsListing {...props} />} {...props}>
                    {/* setTitleCurrent={this.setTitleCurrent} */
                    /* passing function as prop - not in use */}
                  </LayoutFrontendMain>
                )}
          ...
          <Route
            ...
            render={(props) => (
              <React.Fragment>
                {/* Layout select. */}
                {this._masterPageFrontendSelect === 'layout-frontend-iframe' ? <LayoutFrontendIframe cphBody={<FrontendPublicationsDetails {...props} />} {...props}></LayoutFrontendIframe> : <LayoutFrontendMain cphBody={<FrontendPublicationsDetails {...props} />} {...props}></LayoutFrontendMain>}
              </React.Fragment>
            )}
          />
          {/* // ---------------------- */}
          ...
          <Route
            ...
            render={(props) => (
              <React.Fragment>
                ...
                {/* new URLSearchParams(props.location.search).get("masterPageSelect") == "layout-frontend-iframe" ?*/}
                {this._masterPageFrontendSelect === 'layout-frontend-iframe' ? (
                  <LayoutFrontendIframe cphBody={<FrontendQuizzesListing {...props} />} {...props}>
                    {/* setTitleCurrent={this.setTitleCurrent} */
                    /* passing function as prop - not in use */}
                  </LayoutFrontendIframe>
                ) : (
                  <LayoutFrontendMain cphBody={<FrontendQuizzesListing {...props} />} {...props}>
                    {/* setTitleCurrent={this.setTitleCurrent} */
                    /* passing function as prop - not in use */}
                  </LayoutFrontendMain>
                )}
          ...
          <Route
            ...
            render={(props) => (
              <React.Fragment>
                {/* Layout select. */}
                {this._masterPageFrontendSelect === 'layout-frontend-iframe' ? <LayoutFrontendIframe cphBody={<FrontendDashboard {...props} />} {...props}></LayoutFrontendIframe> : <LayoutFrontendMain cphBody={<FrontendDashboard {...props} />} {...props}></LayoutFrontendMain>}
              </React.Fragment>
            )}
          />
          {/* // ---------------------- */}
