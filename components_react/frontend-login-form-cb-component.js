...
class FrontendLoginForm extends Component {
  ...
  render() {
    ...
    let configLoginOrigin;
    let configLoginReturnURL;
    let configLoginIDReturnURL;
    // ----------------------
    ...
    if (configLayoutType === 1) {
      ...
      return (
        <div style={{ position: 'relative', display: 'block', overflow: 'hidden' }}>
          ...
          >
            <input type="hidden" id={'form' + configLayoutType + '_loginOrigin'} name={'loginOrigin'} value={configLoginOrigin} />
            <input type="hidden" id={'form' + configLayoutType + '_loginReturnURL'} name={'loginReturnURL'} value={configLoginReturnURL} />
            <input type="hidden" id={'form' + configLayoutType + '_loginIDReturnURL'} name={'loginIDReturnURL'} value={configLoginIDReturnURL} />

            <fieldset className="ss-frontend-login-container">
              <legend className="ss-frontend-login-subheading-title ss-frontend-login-subheading-title-layout">{SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageFrontend.appLabels, 'frontendLoginTitleTable')}</legend>
              ...
              <div className="ss-frontend-login-row01">
                ...
                <div className="ss-frontend-login-row-field01">
                  <input type="text" id={'form' + configLayoutType + '_email'} name={'email'} required={true} className="ss-frontend-login-field-user" onChange={this.handleLoginFormFieldsChange} value={this.state.email} />
                </div>
              </div>
              ...
              <div className="ss-frontend-login-row01">
                ...
                <div className="ss-frontend-login-row-field01">
                  <input type="password" id={'form' + configLayoutType + '_password'} name={'password'} required={true} className="ss-frontend-login-field-password" onChange={this.handleLoginFormFieldsChange} value={this.state.password} />
                </div>
              </div>

              <div className="ss-frontend-login-row01" style={{ textAlign: 'center', marginTop: '0px' }}>
                <button className="ss-frontend-btn-base ss-frontend-btn-action">{SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageFrontend.appLabels, 'backendButtonLogin')}</button>
              </div>
            </fieldset>
          </form>
        </div>
