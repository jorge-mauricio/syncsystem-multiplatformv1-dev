...
class FrontendDashboard extends Component {
  ...
  render() {
    ...
    const objRegistersDetails = this.objRegistersDetails;
    // ----------------------
    ...
    return (
      <section className="ss-frontend-layout-section-content01 ss-frontend-dashboard-text01">
        <strong>{SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageFrontend.appLabels, 'frontendDashboardWelcome')}</strong>
        {SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageFrontend.appLabels, 'frontendDashboardLoginMessage01')}:{objRegistersDetails.tblRegistersNameFull}
      </section>
    );
  }
  // **************************************************************************************
