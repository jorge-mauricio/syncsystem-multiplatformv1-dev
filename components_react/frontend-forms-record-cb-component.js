    ...
    if (configLayoutType === 2) {
      ...
      return (
        <div style={{ position: 'relative', display: 'block', overflow: 'hidden' }}>
          <form
            id={'form' + objFormsDetails.tblFormsID}
          ...
          >
            <input type="hidden" id={'form' + objFormsDetails.tblFormsID + '_idTbForms'} name={'idTbForms'} value={objFormsDetails.tblFormsID} />
            <input type="hidden" id={'form' + objFormsDetails.tblFormsID + '_returnURL'} name={'returnURL'} value={gSystemConfig.configRouteFrontendForms + '/' + gSystemConfig.configRouteFrontendActionSend} />

            <fieldset className="ss-frontend-forms-container">
              <legend className="ss-frontend-forms-title01">{objFormsDetails.tblFormsFormTitle}</legend>
                ...
                return (
                  <React.Fragment>
                    ...
                    {formsFieldsRow.field_type == 1 ? (
                      <div key={formsFieldsRowKey} className="ss-frontend-forms-row01">
                        <label for={'form' + objFormsDetails.tblFormsID + '_' + formsFieldsRow.field_name_formatted} className="ss-frontend-forms-row-label01 ss-frontend-forms-label01">
                          {formsFieldsRow.required == 1 ? <span>{SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageFrontend.appLabels, 'frontendFormsRequiredFieldsSymbol')}</span> : ``}

                          {SyncSystemNS.FunctionsGeneric.contentMaskRead(formsFieldsRow.field_name, 'db')}
                        </label>
                        <div className="ss-frontend-forms-row-field01">
                          <input type="text" id={'form' + objFormsDetails.tblFormsID + '_' + formsFieldsRow.field_name_formatted} name={formsFieldsRow.field_name_formatted} required={formsFieldsRow.required == 1 ? true : false} className="ss-frontend-forms-field-text01" style={formsFieldsRow.field_size == 0 ? { width: '100%;' } : { width: formsFieldsRow.field_size + 'px' }} />

                          {gSystemConfig.enableFormsFieldsInstructions == 1 && formsFieldsRow.field_instructions != '' ? <div className="ss-frontend-forms-instructions01">{HTMLReactParser(SyncSystemNS.FunctionsGeneric.contentMaskRead(formsFieldsRow.field_instructions, 'db'))}</div> : ``}
                        </div>
                      </div>
                    ) : (
                      ``
                    ...
                    {formsFieldsRow.field_type == 2 ? (
                      <div key={formsFieldsRowKey} className="ss-frontend-forms-row01">
                        ...
                        <div className="ss-frontend-forms-row-field01" style={{ verticalAlign: 'top' }}>
                          <textarea id={'form' + objFormsDetails.tblFormsID + '_' + formsFieldsRow.field_name_formatted} name={formsFieldsRow.field_name_formatted} required={formsFieldsRow.required == 1 ? true : false} className="ss-frontend-forms-field-text-area01" style={formsFieldsRow.field_size == 0 ? { width: '100%;' } : { width: formsFieldsRow.field_size + 'px' }} />
                      ...
                      <div key={formsFieldsRowKey} className="ss-frontend-forms-row01">
                        ...
                        <div className="ss-frontend-forms-row-field01" style={{ verticalAlign: 'top' }}>
                          ...
                          {/* Loop.
                                                        ...
                                                        */}
                          {arrFormsFieldsOptionsListing
                            .filter((objFormsFieldsOptions) => {
                            ...
                            .map((formsFieldsOptionsRow) => {
                              return (
                                <label for={'form' + objFormsDetails.tblFormsID + '_' + 'formField' + formsFieldsRow.id + '_' + formsFieldsOptionsRow.option_name_formatted} className="ss-frontend-forms-field-checkbox-label">
                                  <input type="checkbox" id={'form' + objFormsDetails.tblFormsID + '_' + 'formField' + formsFieldsRow.id + '_' + formsFieldsOptionsRow.option_name_formatted} name={formsFieldsRow.field_name_formatted + '[]'} value={SyncSystemNS.FunctionsGeneric.contentMaskRead(formsFieldsOptionsRow.option_name, 'db')} className="ss-frontend-forms-field-checkbox" />
                            ...
                            .map((formsFieldsOptionsRow) => {
                              return (
                                <label for={'form' + objFormsDetails.tblFormsID + '_formField' + formsFieldsRow.id + '_' + formsFieldsOptionsRow.option_name_formatted} className="ss-frontend-forms-field-checkbox-label">
                                  <input type="radio" id={'form' + objFormsDetails.tblFormsID + '_formField' + formsFieldsRow.id + '_' + formsFieldsOptionsRow.option_name_formatted} radioGroup={formsFieldsRow.field_name_formatted} name={formsFieldsRow.field_name_formatted} value={SyncSystemNS.FunctionsGeneric.contentMaskRead(formsFieldsOptionsRow.option_name, 'db')} required={formsFieldsRow.required == 1 ? true : false} className="ss-frontend-forms-field-checkbox" />
                                  {SyncSystemNS.FunctionsGeneric.contentMaskRead(formsFieldsOptionsRow.option_name, 'db')}
                                </label>
                              );
                            })}
                    ...
                    {formsFieldsRow.field_type == 5 ? (
                      <div key={formsFieldsRowKey} className="ss-frontend-forms-row01">
                        ...
                        <div className="ss-frontend-forms-row-field01">
                          <select id={'form' + objFormsDetails.tblFormsID + '_' + formsFieldsRow.field_name_formatted} name={formsFieldsRow.field_name_formatted} required={formsFieldsRow.required == 1 ? true : false} className="ss-frontend-forms-field-dropdown01" style={formsFieldsRow.field_size == 0 ? { width: '100%;' } : { width: formsFieldsRow.field_size + 'px' }}>
                            ...
                            {arrFormsFieldsOptionsListing
                              ...
                              .map((formsFieldsOptionsRow) => {
                                return <option value={SyncSystemNS.FunctionsGeneric.contentMaskRead(formsFieldsOptionsRow.option_name, 'db')}>{SyncSystemNS.FunctionsGeneric.contentMaskRead(formsFieldsOptionsRow.option_name, 'db')}</option>;
                              })}
                          </select>
                    ...
                    {formsFieldsRow.field_type == 8 ? (
                      <div key={formsFieldsRowKey} className="ss-frontend-forms-row01 ss-frontend-forms-subheading-title">
                        {HTMLReactParser(SyncSystemNS.FunctionsGeneric.contentMaskRead(formsFieldsRow.field_name, 'db'))}
                      </div>
                    ) : (
                      ``
              ...
              <div className="ss-frontend-forms-row01" style={{ textAlign: 'center', marginTop: '0px' }}>
                <button className="ss-frontend-btn-base ss-frontend-btn-action">{SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageFrontend.appLabels, 'backendButtonSend')}</button>
              </div>
            </fieldset>
          </form>
        </div>
      ...
      return (
        <div className="container-fluid ss-frontend-forms-text01">
          ...
          >
            ...
            <fieldset>
              <legend className="row ss-frontend-forms-title01">{objFormsDetails.tblFormsFormTitle}</legend>
              ...
              {arrFormsFieldsListing.map((formsFieldsRow, formsFieldsRowKey) => {
                return (
                  <React.Fragment>
                    {/* Text Field. */}
                    {formsFieldsRow.field_type == 1 ? (
                      <div key={formsFieldsRowKey} className="form-group">
                        <label for={'form' + objFormsDetails.tblFormsID + '_' + formsFieldsRow.field_name_formatted} className="control-label col-sm-2">
                          {formsFieldsRow.required == 1 ? <span>{SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageFrontend.appLabels, 'frontendFormsRequiredFieldsSymbol')}</span> : ``}

                          {SyncSystemNS.FunctionsGeneric.contentMaskRead(formsFieldsRow.field_name, 'db')}
                        </label>
                        <div className="col-sm-10">
                          <input type="text" id={'form' + objFormsDetails.tblFormsID + '_' + formsFieldsRow.field_name_formatted} name={formsFieldsRow.field_name_formatted} required={formsFieldsRow.required == 1 ? true : false} className="form-control" style={formsFieldsRow.field_size == 0 ? { width: '100%;' } : { width: formsFieldsRow.field_size + 'px' }} />
                    ...
                    {formsFieldsRow.field_type == 2 ? (
                      <div key={formsFieldsRowKey} className="form-group">
                        ...
                        <div className="col-sm-10">
                          <textarea id={'form' + objFormsDetails.tblFormsID + '_' + formsFieldsRow.field_name_formatted} name={formsFieldsRow.field_name_formatted} required={formsFieldsRow.required == 1 ? true : false} className="form-control" style={formsFieldsRow.field_size == 0 ? { width: '100%;' } : { width: formsFieldsRow.field_size + 'px' }} />
                            ...
                            .map((formsFieldsOptionsRow) => {
                              return (
                                <div class="form-check">
                                  <label for={'form' + objFormsDetails.tblFormsID + '_formField' + formsFieldsRow.id + '_' + formsFieldsOptionsRow.option_name_formatted} className="form-check-label">
                                    <input type="checkbox" id={'form' + objFormsDetails.tblFormsID + '_formField' + formsFieldsRow.id + '_' + formsFieldsOptionsRow.option_name_formatted} name={formsFieldsRow.field_name_formatted + '[]'} value={SyncSystemNS.FunctionsGeneric.contentMaskRead(formsFieldsOptionsRow.option_name, 'db')} className="form-check-input" />
                                    {SyncSystemNS.FunctionsGeneric.contentMaskRead(formsFieldsOptionsRow.option_name, 'db')}
                                  </label>
                                </div>
                              );
                          ...
                          {arrFormsFieldsOptionsListing
                            ...
                            .map((formsFieldsOptionsRow) => {
                              return (
                                <div class="form-check">
                                  <label for={'form' + objFormsDetails.tblFormsID + '_formField' + formsFieldsRow.id + '_' + formsFieldsOptionsRow.option_name_formatted} className="form-check-label">
                                    <input type="radio" id={'form' + objFormsDetails.tblFormsID + '_formField' + formsFieldsRow.id + '_' + formsFieldsOptionsRow.option_name_formatted} radioGroup={formsFieldsRow.field_name_formatted} name={formsFieldsRow.field_name_formatted} value={SyncSystemNS.FunctionsGeneric.contentMaskRead(formsFieldsOptionsRow.option_name, 'db')} required={formsFieldsRow.required == 1 ? true : false} className="form-check-input" />
                                    {SyncSystemNS.FunctionsGeneric.contentMaskRead(formsFieldsOptionsRow.option_name, 'db')}
                                  </label>
                                </div>
                              );
                    ...
                    {formsFieldsRow.field_type == 5 ? (
                      <div key={formsFieldsRowKey} className="form-group">
                        ...
                        <div className="col-sm-10">
                          <select id={'form' + objFormsDetails.tblFormsID + '_' + formsFieldsRow.field_name_formatted} name={formsFieldsRow.field_name_formatted} required={formsFieldsRow.required == 1 ? true : false} className="form-control" style={formsFieldsRow.field_size == 0 ? { width: '100%;' } : { width: formsFieldsRow.field_size + 'px' }}>
                            <option value="" selected></option>
                    ...
                    {/* Text Description. */}
                    {formsFieldsRow.field_type == 7 ? (
                      <div key={formsFieldsRowKey} className="row">
                        {HTMLReactParser(SyncSystemNS.FunctionsGeneric.contentMaskRead(formsFieldsRow.field_name, 'db'))}
                      </div>
                    ) : (
                      ``
                    ...
                    {/* Subheader. */}
                    {formsFieldsRow.field_type == 8 ? (
                      <div key={formsFieldsRowKey} className="row ss-frontend-forms-subheading-title">
                        {HTMLReactParser(SyncSystemNS.FunctionsGeneric.contentMaskRead(formsFieldsRow.field_name, 'db'))}
                      </div>
                    ) : (
                      ``
