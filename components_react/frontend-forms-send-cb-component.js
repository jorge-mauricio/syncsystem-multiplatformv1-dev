      ...
      <React.Fragment>
        ...
        {this.configLayoutType === 1 ? (
          <section className="ss-frontend-layout-section-content01">
            {this._messageSuccess != '' ? <div className="ss-frontend-success">{HTMLReactParser(SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageFrontend.appLabels, this._messageSuccess))}</div> : ``}
            {this._messageError != '' ? <div className="ss-frontend-error">{HTMLReactParser(SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageFrontend.appLabels, this._messageError))}</div> : ``}
            {this._messageAlert != '' ? <div className="ss-frontend-alert">{HTMLReactParser(SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageFrontend.appLabels, this._messageAlert))}</div> : ``}
        ...
        {this.configLayoutType === 11 ? (
          <section className="container">
            <div className="alert alert-success" role="alert" style={{ textAlign: 'center' }}>
              {gSystemConfig.enableFormsMessageSuccess === 1 ? HTMLReactParser(this.objFormsDetails.tblFormsMessageSuccess) : HTMLReactParser(SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageFrontend.appLabels, 'frontendFormsMessageSendSuccess'))}
            </div>
          </section>
        ) : (
          ``
