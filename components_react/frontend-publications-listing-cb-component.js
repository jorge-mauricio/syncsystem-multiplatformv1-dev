              ...
              {gSystemConfig.enablePublicationsFrontendPagination === 1 ? (
                <div style={{ position: 'relative', display: 'block', overflow: 'hidden', textAlign: 'center', margin: '20px 0px 0px 0px' }}>
                  <div style={{ position: 'relative', display: 'block', overflow: 'hidden' }}>
                    {/* First page. */}
                    {this._pageNumber == 1 ? (
                      <a className="ss-frontend-publications-listing-link01" href={'/' + gSystemConfig.configRouteFrontendPublications + '/' + this._idParentPublications + '?pageNumber=1' + this.queryDefault} title={SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageFrontend.appLabels, 'backendPagingFirst')}>
                    ...
                    {/* Previous page. */}
                    {this._pageNumber == 1 ? (
                      <a className="ss-frontend-publications-listing-link01" href={'/' + gSystemConfig.configRouteFrontendPublications + '/' + this._idParentPublications + '?pageNumber=1' + this.queryDefault} title={SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageFrontend.appLabels, 'backendPagingPrevious')}>
                        {SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageFrontend.appLabels, 'backendPagingPrevious')}
                      </a>
                    ) : (
                      <a className="ss-frontend-publications-listing-link01" href={'/' + gSystemConfig.configRouteFrontendPublications + '/' + this._idParentPublications + '?pageNumber=' + (parseInt(this._pageNumber) - parseInt(1)) + this.queryDefault} title={SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageFrontend.appLabels, 'backendPagingPrevious')}>
                        {SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageFrontend.appLabels, 'backendPagingPrevious')}
                      </a>
                    )}
                    ...
                    {this._pageNumber == this._pagingTotal ? (
                      <a className="ss-frontend-publications-listing-link01" href={'/' + gSystemConfig.configRouteFrontendPublications + '/' + this._idParentPublications + '?pageNumber=' + this._pagingTotal + this.queryDefault} title={SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageFrontend.appLabels, 'backendPagingNext')}>
                    ...
                    {/* Last page. */}
                    {this._pageNumber == this._pagingTotal ? (
                      <a className="ss-frontend-publications-listing-link01" href={'/' + gSystemConfig.configRouteFrontendPublications + '/' + this._idParentPublications + '?pageNumber=' + this._pagingTotal + this.queryDefault} title={SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageFrontend.appLabels, 'backendPagingLast')}>
                    ...
                    <div style={{ position: 'relative', display: 'block', overflow: 'hidden' }}>
                      ...
                      {Array.from(Array(this._pagingTotal), (item, index) => {
                        ...
                        return this._pageNumber == pageNumberOutput ? (
                          <span className="ss-frontend-publications-pagination">{pageNumberOutput}</span>
                        ) : (
                          <a className="ss-frontend-publications-pagination-link" href={'/' + gSystemConfig.configRouteFrontendPublications + '/' + this._idParentPublications + '?pageNumber=' + pageNumberOutput + this.queryDefault} title={SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageFrontend.appLabels, 'backendPagingPageCounter01') + ' ' + pageNumberOutput}>
                            {pageNumberOutput}
                          </a>
                        );
                      })}
                      ...
                      <ul className="pagination">
                        ...
                        {this._pageNumber == 1 ? (
                          <li className="page-item disabled">
                            <a className="page-link" href={'/' + gSystemConfig.configRouteFrontendPublications + '/' + this._idParentPublications + '?pageNumber=1' + this.queryDefault} title={SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageFrontend.appLabels, 'backendPagingFirst')}>
                              {SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageFrontend.appLabels, 'backendPagingFirst')}
                            </a>
                          </li>
                        ) : (
                        ...
                        {this._pageNumber == 1 ? (
                          <li className="page-item disabled">
                            <a className="page-link" href={'/' + gSystemConfig.configRouteFrontendPublications + '/' + this._idParentPublications + '?pageNumber=1' + this.queryDefault} title={SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageFrontend.appLabels, 'backendPagingPrevious')}>
                              {SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageFrontend.appLabels, 'backendPagingPrevious')}
                            </a>
                          </li>
                        ) : (
                          <li className="page-item">
                            <a className="page-link" href={'/' + gSystemConfig.configRouteFrontendPublications + '/' + this._idParentPublications + '?pageNumber=' + (parseInt(this._pageNumber) - parseInt(1)) + this.queryDefault} title={SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageFrontend.appLabels, 'backendPagingPrevious')}>
                              {SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageFrontend.appLabels, 'backendPagingPrevious')}
                            </a>
                          </li>
                        )}
                            ...
                            {Array.from(Array(this._pagingTotal), (item, index) => {
                              ...
                              return this._pageNumber == pageNumberOutput ? (
                                <li className="page-item active">
                                  <a className="page-link" href={'/' + gSystemConfig.configRouteFrontendPublications + '/' + this._idParentPublications + '?pageNumber=' + pageNumberOutput + this.queryDefault} title={SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageFrontend.appLabels, 'backendPagingPageCounter01') + ' ' + pageNumberOutput}>
                                    {pageNumberOutput}
                                  </a>
                                </li>
                              ) : (
                        ...
                        {this._pageNumber == this._pagingTotal ? (
                          <li className="page-item disabled">
                            <a className="page-link" href={'/' + gSystemConfig.configRouteFrontendPublications + '/' + this._idParentPublications + '?pageNumber=' + this._pagingTotal + this.queryDefault} title={SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageFrontend.appLabels, 'backendPagingNext')}>
                              {SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageFrontend.appLabels, 'backendPagingNext')}
                            </a>
                          </li>
                        ) : (
                          <li className="page-item">
                            <a className="page-link" href={'/' + gSystemConfig.configRouteFrontendPublications + '/' + this._idParentPublications + '?pageNumber=' + (parseInt(this._pageNumber) + parseInt(1)) + this.queryDefault} title={SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageFrontend.appLabels, 'backendPagingNext')}>
                              {SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageFrontend.appLabels, 'backendPagingNext')}
                            </a>
                          </li>
                        )}
                        ...
                        {this._pageNumber == this._pagingTotal ? (
                          <li className="page-item disabled">
                            <a className="page-link" href={'/' + gSystemConfig.configRouteFrontendPublications + '/' + this._idParentPublications + '?pageNumber=' + this._pagingTotal} title={SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageFrontend.appLabels, 'backendPagingLast')}>
                              {SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageFrontend.appLabels, 'backendPagingLast')}
                            </a>
                          </li>
                        ) : (
