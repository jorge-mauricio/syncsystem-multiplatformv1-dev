  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        {/* Products records. */}
        <FrontendProductsDetailsRecord objProductsDetails={this.state.objProductsDetails} configLayoutType={2}></FrontendProductsDetailsRecord>

        {/* Files - images - records. */}
        {gSystemConfig.enableProductsImages === 1 ? <FrontendFilesImages idParentFiles={this._idTbProducts} configLayoutType={1} configFilesNRecords={''} configFilesSort={''} configFilesZoom={0}></FrontendFilesImages> : ``}

        {/* Files - records. */}
        {gSystemConfig.enableProductsFiles === 1 ? <FrontendFiles idParentFiles={this._idTbProducts} configLayoutType={1} configFilesNRecords={''} configFilesSort={''}></FrontendFiles> : ``}
