...
class FrontendProductsListing extends Component {
  ...
  async build() {
    ...
    try {
      ...
      // apiURLProductsListing = gSystemConfig.configAPIURL + "/" + gSystemConfig.configRouteAPI + "/" + gSystemConfig.configRouteAPIProducts + "/" + this._idParentProducts + "/?apiKey=" + SyncSystemNS.FunctionsCrypto.encryptValue(SyncSystemNS.FunctionsGeneric.contentMaskWrite(gSystemConfig.configAPIKeySystem, "env"), 2);
      ...
      this.metaURLCurrent = gSystemConfig.configURLFrontendReact + '/' + gSystemConfig.configRouteFrontendProducts + '/' + this._idParentProducts + '/';
      if (this._pageNumber) {
    ...
    return (
      <React.Fragment>
        <section className="ss-frontend-layout-section-content01">
          {/* Products records. */}
          <FrontendProductsListingRecord arrProductsListing={this.state.arrProductsListing} configLayoutType={33}></FrontendProductsListingRecord>
              ...
              {gSystemConfig.enableProductsFrontendPagination === 1 ? (
                <div style={{ position: 'relative', display: 'block', overflow: 'hidden', textAlign: 'center', margin: '20px 0px 0px 0px' }}>
                  <div style={{ position: 'relative', display: 'block', overflow: 'hidden' }}>
                    {/* First page. */}
                    {this._pageNumber == 1 ? (
                      <a className="ss-frontend-products-listing-link01" href={'/' + gSystemConfig.configRouteFrontendProducts + '/' + this._idParentProducts + '?pageNumber=1' + this.queryDefault} title={SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageFrontend.appLabels, 'backendPagingFirst')}>
                    ...
                    {/* Previous page. */}
                    {this._pageNumber == 1 ? (
                      <a className="ss-frontend-products-listing-link01" href={'/' + gSystemConfig.configRouteFrontendProducts + '/' + this._idParentProducts + '?pageNumber=1' + this.queryDefault} title={SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageFrontend.appLabels, 'backendPagingPrevious')}>
                        {SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageFrontend.appLabels, 'backendPagingPrevious')}
                      </a>
                    ) : (
                      <a className="ss-frontend-products-listing-link01" href={'/' + gSystemConfig.configRouteFrontendProducts + '/' + this._idParentProducts + '?pageNumber=' + (parseInt(this._pageNumber) - parseInt(1)) + this.queryDefault} title={SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageFrontend.appLabels, 'backendPagingPrevious')}>
                        {SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageFrontend.appLabels, 'backendPagingPrevious')}
                      </a>
                    )}
                    ...
                    {this._pageNumber == this._pagingTotal ? (
                      <a className="ss-frontend-products-listing-link01" href={'/' + gSystemConfig.configRouteFrontendProducts + '/' + this._idParentProducts + '?pageNumber=' + this._pagingTotal + this.queryDefault} title={SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageFrontend.appLabels, 'backendPagingNext')}>
                        {SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageFrontend.appLabels, 'backendPagingNext')}
                      </a>
                    ) : (
                      <a className="ss-frontend-products-listing-link01" href={'/' + gSystemConfig.configRouteFrontendProducts + '/' + this._idParentProducts + '?pageNumber=' + (parseInt(this._pageNumber) + parseInt(1)) + this.queryDefault} title={SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageFrontend.appLabels, 'backendPagingNext')}>
                        {SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageFrontend.appLabels, 'backendPagingNext')}
                      </a>
                    )}
                    ...
                    {/* Last page. */}
                    {this._pageNumber == this._pagingTotal ? (
                      <a className="ss-frontend-products-listing-link01" href={'/' + gSystemConfig.configRouteFrontendProducts + '/' + this._idParentProducts + '?pageNumber=' + this._pagingTotal + this.queryDefault} title={SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageFrontend.appLabels, 'backendPagingLast')}>
                  ...
                  {gSystemConfig.enableProductsFrontendPaginationNumbering === 1 ? (
                    <div style={{ position: 'relative', display: 'block', overflow: 'hidden' }}>
                      ...
                      {Array.from(Array(this._pagingTotal), (item, index) => {
                        ...
                        return this._pageNumber == pageNumberOutput ? (
                          <span className="ss-frontend-products-pagination">{pageNumberOutput}</span>
                        ) : (
                          <a className="ss-frontend-products-pagination-link" href={'/' + gSystemConfig.configRouteFrontendProducts + '/' + this._idParentProducts + '?pageNumber=' + pageNumberOutput + this.queryDefault} title={SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageFrontend.appLabels, 'backendPagingPageCounter01') + ' ' + pageNumberOutput}>
                            {pageNumberOutput}
                          </a>
                        );
                      })}
                  ...
                  <div className="container">
                    ...
                    <nav aria-label={SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageFrontend.appLabels, 'backendPagingPageLabel')}>
                      <ul className="pagination">
                        {' '}
                        {/* justify-content-center (centered) | justify-content-end (aligned right*/}
                        {/* First page. */}
                        {this._pageNumber == 1 ? (
                          <li className="page-item disabled">
                            <a className="page-link" href={'/' + gSystemConfig.configRouteFrontendProducts + '/' + this._idParentProducts + '?pageNumber=1' + this.queryDefault} title={SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageFrontend.appLabels, 'backendPagingFirst')}>
                              {SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageFrontend.appLabels, 'backendPagingFirst')}
                            </a>
                          </li>
                        ) : (
                        ...
                        {this._pageNumber == 1 ? (
                          <li className="page-item disabled">
                            <a className="page-link" href={'/' + gSystemConfig.configRouteFrontendProducts + '/' + this._idParentProducts + '?pageNumber=1' + this.queryDefault} title={SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageFrontend.appLabels, 'backendPagingPrevious')}>
                              {SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageFrontend.appLabels, 'backendPagingPrevious')}
                            </a>
                          </li>
                        ) : (
                          <li className="page-item">
                            <a className="page-link" href={'/' + gSystemConfig.configRouteFrontendProducts + '/' + this._idParentProducts + '?pageNumber=' + (parseInt(this._pageNumber) - parseInt(1)) + this.queryDefault} title={SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageFrontend.appLabels, 'backendPagingPrevious')}>
                              {SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageFrontend.appLabels, 'backendPagingPrevious')}
                            </a>
                          </li>
                        )}
                            ...
                            {Array.from(Array(this._pagingTotal), (item, index) => {
                              ...
                              return this._pageNumber == pageNumberOutput ? (
                                <li className="page-item active">
                                  <a className="page-link" href={'/' + gSystemConfig.configRouteFrontendProducts + '/' + this._idParentProducts + '?pageNumber=' + pageNumberOutput + this.queryDefault} title={SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageFrontend.appLabels, 'backendPagingPageCounter01') + ' ' + pageNumberOutput}>
                                    {pageNumberOutput}
                                  </a>
                                </li>
                              ) : (
                        ...
                        {this._pageNumber == this._pagingTotal ? (
                          <li className="page-item disabled">
                            <a className="page-link" href={'/' + gSystemConfig.configRouteFrontendProducts + '/' + this._idParentProducts + '?pageNumber=' + this._pagingTotal + this.queryDefault} title={SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageFrontend.appLabels, 'backendPagingNext')}>
                              {SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageFrontend.appLabels, 'backendPagingNext')}
                            </a>
                          </li>
                        ) : (
                          <li className="page-item">
                            <a className="page-link" href={'/' + gSystemConfig.configRouteFrontendProducts + '/' + this._idParentProducts + '?pageNumber=' + (parseInt(this._pageNumber) + parseInt(1)) + this.queryDefault} title={SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageFrontend.appLabels, 'backendPagingNext')}>
                              {SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageFrontend.appLabels, 'backendPagingNext')}
                            </a>
                          </li>
                        )}
                        ...
                        {this._pageNumber == this._pagingTotal ? (
                          <li className="page-item disabled">
                            <a className="page-link" href={'/' + gSystemConfig.configRouteFrontendProducts + '/' + this._idParentProducts + '?pageNumber=' + this._pagingTotal} title={SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageFrontend.appLabels, 'backendPagingLast')}>
                              {SyncSystemNS.FunctionsGeneric.appLabelsGet(gSystemConfig.configLanguageFrontend.appLabels, 'backendPagingLast')}
                            </a>
                          </li>
                        ) : (
