                    ...
                    {filesRow.file != '' ? (
                      <React.Fragment>
                        ...
                        {filesRow.file_config === 3 ? (
                          <a download href={gSystemConfig.configFrontendReactURLImages + gSystemConfig.configDirectoryFilesSD + '/' + filesRow.file} target="_blank" title={filesRow.caption != '' ? SyncSystemNS.FunctionsGeneric.contentMaskRead(filesRow.caption, 'db') : filesRow.file} className="ss-frontend-files-link01">
                            {filesRow.caption != '' ? SyncSystemNS.FunctionsGeneric.contentMaskRead(filesRow.caption, 'db') : filesRow.file}
                          </a>
                        ) : (
                          ``
                        )}
                        ...
                        {filesRow.file_config === 4 ? (
                          <a href={gSystemConfig.configFrontendReactURLImages + gSystemConfig.configDirectoryFilesSD + '/' + filesRow.file} target="_blank" title={filesRow.caption != '' ? SyncSystemNS.FunctionsGeneric.contentMaskRead(filesRow.caption, 'db') : filesRow.file} className="ss-frontend-files-link01">
                            {filesRow.caption != '' ? SyncSystemNS.FunctionsGeneric.contentMaskRead(filesRow.caption, 'db') : filesRow.file}
                          </a>
                        ) : (
                          ``
