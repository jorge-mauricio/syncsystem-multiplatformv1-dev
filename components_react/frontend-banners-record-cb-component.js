...
class FrontendBannersRecord extends Component {
  ...
  render() {
    ...
    let configDisplay;
    let arrBannersListing;
    // ----------------------

    // Define values.
    // ----------------------
    configLayoutType = this.configLayoutType; // eslint-disable-line
    configDisplay = this.configDisplay; // eslint-disable-line
    arrBannersListing = this.arrBannersListing; // eslint-disable-line
